var pageComponent =
webpackJsonppageComponent([14,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dBhff", function() { return dBhff; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace dBhff.
 * @public
 */

goog.module('dBhff.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1239 = function() {
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Preset pagination styles helps divide up large blocks of content on your site or app. Use class ');
          ie_open('code');
            itext('ellipsis');
          ie_close('code');
          itext(' or ');
          ie_open('code');
            itext('dropdown');
          ie_close('code');
          itext(' on a pagination list item to separate pagination controls from page numbers.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'pagination');
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('pagination-bar');
          ie_close('code');
          itext('\'s preset styles to give your users more control over the content being displayed on the page.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('a', null, null,
            ...
            ie_open('svg', null, null,
              ...
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#caret-double-l');
            ie_close('svg');
          ie_close('a');
          ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          itext('Showing 1 to 20 of 203 entries.');
        ie_close('div');
        ie_open('ul', null, null,
            'class', 'pagination');
          ie_open('li', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('pagination-lg');
          ie_close('code');
          itext(' to any pagination component to make it smaller or larger. It can be added to the parent container, such as ');
          ie_open('code');
            itext('pagination-bar');
          ie_close('code');
          itext(', to size all the pagination components that reside within.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('h5');
        itext('Small');
      ie_close('h5');
      ie_open('div', null, null,
          'class', 'pagination-bar pagination-sm');
        ie_open('div', null, null,
            'class', 'dropdown pagination-items-per-page');
          ie_open('a', null, null,
              'class', 'dropdown-toggle',
        ...
        ie_close('ul');
      ie_close('div');
      $templateAlias2({code: '<div class="pagination-bar pagination-sm">\n    <div class="dropdown pagination-items-per-page">\n        <a class="dropdown-toggle" data-toggle="dropdown" href="#1">\n            10 entries\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-caret-double-l">\n                <use xlink:href="/vendor/lexicon/icons.svg#caret-double-l" />\n            </svg>\n        </a>\n        <div class="dropdown-menu dropdown-menu-top">\n            <a class="dropdown-item" href="#1">5</a>\n            <a class="dropdown-item" href="#1">10</a>\n            <a class="dropdown-item" href="#1">20</a>\n            <a class="dropdown-item" href="#1">30</a>\n            <a class="dropdown-item" href="#1">50</a>\n        </div>\n    </div>\n    <div class="pagination-results">Showing 1 to 20 of 203 entries.</div>\n    <ul class="pagination">\n        <li class="disabled page-item">\n            <a class="page-link" href="#1">\n                <svg aria-hidden="true" class="lexicon-icon lexicon-icon-angle-left">\n                    <use xlink:href="/vendor/lexicon/icons.svg#angle-left" />\n                </svg>\n                <span class="sr-only">Previous</span>\n            </a>\n        </li>\n        <li class="active page-item"><a class="page-link" href="#1">1</a></li>\n        <li class="page-item"><a class="page-link" href="#1">2</a></li>\n        <li class="dropdown page-item">\n            <a class="dropdown-toggle page-link" data-toggle="dropdown" href="#1">...</a>\n            <div class="dropdown-menu dropdown-menu-top-center">\n                <div class="inline-scroller">\n                    <a class="dropdown-item" href="#1">3</a>\n                    <a class="dropdown-item" href="#1">4</a>\n                    <a class="dropdown-item" href="#1">5</a>\n                    <a class="dropdown-item" href="#1">6</a>\n                    <a class="dropdown-item" href="#1">7</a>\n                    <a class="dropdown-item" href="#1">8</a>\n                    <a class="dropdown-item" href="#1">9</a>\n                    <a class="dropdown-item" href="#1">10</a>\n                    <a class="dropdown-item" href="#1">11</a>\n                    <a class="dropdown-item" href="#1">12</a>\n                    <a class="dropdown-item" href="#1">13</a>\n                    <a class="dropdown-item" href="#1">14</a>\n                    <a class="dropdown-item" href="#1">15</a>\n                </div>\n            </div>\n        </li>\n        <li class="page-item"><a class="page-link" href="#1">16</a></li>\n        <li class="page-item">\n            <a class="page-link" href="#1">\n                <svg aria-hidden="true" class="lexicon-icon lexicon-icon-angle-right">\n                    <use xlink:href="/vendor/lexicon/icons.svg#angle-right" />\n                </svg>\n                <span class="sr-only">Next</span>\n            </a>\n        </li>\n    </ul>\n</div>', mode: 'xml'}, null, opt_ijData);
      ie_open('h5');
        itext('Default');
      ie_close('h5');
      ie_open('div', null, null,
      ...
      ie_close('h5');
      ie_open('div', null, null,
          'class', 'pagination-bar pagination-lg');
        ie_open('div', null, null,
            'class', 'dropdown pagination-items-per-page');
          ie_open('a', null, null,
              'class', 'dropdown-toggle',
        ...
        ie_close('ul');
      ie_close('div');
      $templateAlias2({code: '<div class="pagination-bar pagination-lg">\n    <div class="dropdown pagination-items-per-page">\n        <a class="dropdown-toggle" data-toggle="dropdown" href="#1">\n            10 entries\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-caret-double-l">\n                <use xlink:href="/vendor/lexicon/icons.svg#caret-double-l" />\n            </svg>\n        </a>\n        <div class="dropdown-menu dropdown-menu-top">\n            <a class="dropdown-item" href="#1">5</a>\n            <a class="dropdown-item" href="#1">10</a>\n            <a class="dropdown-item" href="#1">20</a>\n            <a class="dropdown-item" href="#1">30</a>\n            <a class="dropdown-item" href="#1">50</a>\n        </div>\n    </div>\n    <div class="pagination-results">Showing 1 to 20 of 203 entries.</div>\n    <ul class="pagination">\n        <li class="disabled page-item">\n            <a class="page-link" href="#1">\n                <svg aria-hidden="true" class="lexicon-icon lexicon-icon-angle-left">\n                    <use xlink:href="/vendor/lexicon/icons.svg#angle-left" />\n                </svg>\n                <span class="sr-only">Previous</span>\n            </a>\n        </li>\n        <li class="active page-item"><a class="page-link" href="#1">1</a></li>\n        <li class="page-item"><a class="page-link" href="#1">2</a></li>\n        <li class="dropdown page-item">\n            <a class="dropdown-toggle page-link" data-toggle="dropdown" href="#1">...</a>\n            <div class="dropdown-menu dropdown-menu-top-center">\n                <div class="inline-scroller">\n                    <a class="dropdown-item" href="#1">3</a>\n                    <a class="dropdown-item" href="#1">4</a>\n                    <a class="dropdown-item" href="#1">5</a>\n                    <a class="dropdown-item" href="#1">6</a>\n                    <a class="dropdown-item" href="#1">7</a>\n                    <a class="dropdown-item" href="#1">8</a>\n                    <a class="dropdown-item" href="#1">9</a>\n                    <a class="dropdown-item" href="#1">10</a>\n                    <a class="dropdown-item" href="#1">11</a>\n                    <a class="dropdown-item" href="#1">12</a>\n                    <a class="dropdown-item" href="#1">13</a>\n                    <a class="dropdown-item" href="#1">14</a>\n                    <a class="dropdown-item" href="#1">15</a>\n                </div>\n            </div>\n        </li>\n        <li class="page-item"><a class="page-link" href="#1">16</a></li>\n        <li class="page-item">\n            <a class="page-link" href="#1">\n                <svg aria-hidden="true" class="lexicon-icon lexicon-icon-angle-right">\n                    <use xlink:href="/vendor/lexicon/icons.svg#angle-right" />\n                </svg>\n                <span class="sr-only">Next</span>\n            </a>\n        </li>\n    </ul>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1239}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'dBhff.render';
}
...
class dBhff extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(dBhff, templates);
...
var _paginationSoy = __webpack_require__(120);
...
var dBhff = function (_Component) {
  _inherits(dBhff, _Component);

  function dBhff() {
    _classCallCheck(this, dBhff);

    return _possibleConstructorReturn(this, (dBhff.__proto__ || Object.getPrototypeOf(dBhff)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dBhff, _paginationSoy2.default);

exports.default = dBhff;
