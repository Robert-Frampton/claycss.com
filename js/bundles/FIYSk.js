var pageComponent =
webpackJsonppageComponent([29,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FIYSk", function() { return FIYSk; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from icons-lexicon.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace FIYSk.
 * @public
 */

goog.module('FIYSk.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param815 = function() {
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        itext('Lexicon icons do not use the same format as Font Awesome or Bootstrap\'s Glyphicons.');
      ie_close('div');
      ie_open('blockquote');
        ie_open('p');
          itext('We use SVG elements that link to an SVG sprite, like so:');
        ie_close('p');
      ie_close('blockquote');
      $templateAlias2({code: '<svg class="lexicon-icon">\n    <use xlink:href="path/to/icons.svg#add-column" />\n</svg>', mode: 'xml'}, null, opt_ijData);
      ie_open('blockquote');
        ie_open('p');
          itext('Note that the ID after the # symbol is the ID of the icon to use, so if you wanted to use plus icon, you would do change the ');
          ie_open('code');
            itext('href');
          ie_close('code');
          itext(' to ');
          ie_open('code');
            itext('path/to/icons.svg#plus');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('a', null, null,
            'href', '#lexicon-icon-explanation');
          itext('Why do we use SVG?');
        ie_close('a');
      ie_close('p');
      ie_open('ul', null, null,
          'class', 'lexicon-icon-list list-unstyled');
        var iconList829 = opt_data.page.icons;
        var iconListLen829 = iconList829.length;
        for (var iconIndex829 = 0; iconIndex829 < iconListLen829; iconIndex829++) {
          var iconData829 = iconList829[iconIndex829];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + iconData829);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + iconData829);
            ie_close('svg');
            ie_open('span');
              var dyn8 = iconData829;
              if (typeof dyn8 == 'function') dyn8(); else if (dyn8 != null) itext(dyn8);
            ie_close('span');
          ie_close('li');
        }
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Or, to paraphrase Winston Churchill, "Using flags is the worst system for indicating language, except for all others". :)');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('To use the flags below, follow the same process as above, but the name of the icon is the locale and country code indicated in parenthesis (e.g. to use the Japanese icon, you would use ');
          ie_open('code');
            itext('ja-jp');
          ie_close('code');
          itext(')');
      ...
      ie_open('ul', null, null,
          'class', 'lexicon-icon-list list-unstyled');
        var flagList841 = opt_data.page.flags;
        var flagListLen841 = flagList841.length;
        for (var flagIndex841 = 0; flagIndex841 < flagListLen841; flagIndex841++) {
          var flagData841 = flagList841[flagIndex841];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + flagData841);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + flagData841);
            ie_close('svg');
            ie_open('span');
              var dyn9 = opt_data.page.flagData[flagData841];
              if (typeof dyn9 == 'function') dyn9(); else if (dyn9 != null) itext(dyn9);
              itext(' (');
              var dyn10 = flagData841;
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'svg-icons-as-background-images');
      ie_open('h3');
        itext('SVG Icons as Background Images');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('We have created a Sass function to turn Lexicon SVG icon\'s into data uri schemes, which enables you to include them as a background-image on an HTML element. The Sass function ');
          ie_open('code');
            itext('lx-icon(icon-name, color)');
          ie_close('code');
          itext(' takes the name of a Lexicon SVG Icon and color takes a color. The Sass rule set ');
          ie_open('code');
            itext('.site-add-cell { background-image: lx-icon(add-cell, #5AF); background-size: contain; display: inline-block; height: 20px; width: 20px; }');
          ie_close('code');
          itext(' will place the SVG icon add-cell as a background-image on any element with class site-add-cell.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
            'class', 'clay-site-add-cell clay-site-svg-bg');
          itext('add-cell');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-add-column clay-site-svg-bg');
          itext('add-column');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-add-row clay-site-svg-bg');
          itext('add-row');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-adjust clay-site-svg-bg');
          itext('adjust');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-align-center clay-site-svg-bg');
          itext('align-center');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-asterisk clay-site-svg-bg');
          itext('asterisk');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-svg-bg clay-site-times-circle');
          itext('times-circle');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-svg-bg clay-site-workflow');
          itext('workflow');
        ie_close('span');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('You can turn your custom SVG into a data uri using the Sass function ');
          ie_open('code');
            itext('svg-url($svg)');
          ie_close('code');
          itext(' where ');
          ie_open('code');
            itext('$svg');
          ie_close('code');
          itext(' is the code for your inline SVG. The function returns ');
          ie_open('code');
            itext('url(your_svg_as_data_uri)');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-info');
        itext('When using `svg-url()`, wrap your inline SVG code with single quotes if your SVG\'s attributes are delimited with double quotes.');
      ie_close('div');
      ie_open('p');
        ie_open('span', null, null,
            'class', 'clay-site-linux-tux clay-site-svg-bg');
          itext('Linux Tux');
        ie_close('span');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'why-do-we-use-svg');
      ie_open('h3');
        itext('Why do we use SVG?');
      ie_close('h3');
      ie_open('p', null, null,
          'id', 'lexicon-icon-explanation');
      ...
      ie_open('div', null, null,
        ...
        ie_close('svg');
        ie_open('svg', null, null,
            'class', 'lexicon-icon lexicon-icon-logout');
          ie_void('use', null, null,
              'xlink:href', '/vendor/lexicon/icons.svg#logout');
        ie_close('svg');
        ie_open('svg', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param815}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'FIYSk.render';
}
...
class FIYSk extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(FIYSk, templates);
...
var _iconsLexiconSoy = __webpack_require__(105);

var _iconsLexiconSoy2 = _interopRequireDefault(_iconsLexiconSoy);
...
var FIYSk = function (_Component) {
  _inherits(FIYSk, _Component);

  function FIYSk() {
    _classCallCheck(this, FIYSk);

    return _possibleConstructorReturn(this, (FIYSk.__proto__ || Object.getPrototypeOf(FIYSk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FIYSk, _iconsLexiconSoy2.default);

exports.default = FIYSk;
