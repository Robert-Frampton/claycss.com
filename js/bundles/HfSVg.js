var pageComponent =
webpackJsonppageComponent([39,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HfSVg", function() { return HfSVg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace HfSVg.
 * @public
 */

goog.module('HfSVg.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param350 = function() {
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('A navigation aid for your site, provide a quick way to jump back to previously viewed pages or sections.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('Use ');
          ie_open('code');
            itext('<span class="breadcrumb-text-truncate"></span>');
          ie_close('code');
          itext(' inside breadcrumb links to truncate text based on a max-width.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('Breadcrumb will use ');
        ie_open('code');
          itext('$breadcrumb-divider-svg-icon');
        ie_close('code');
        itext(' by default, set ');
        ie_open('code');
          itext('$breadcrumb-divider-svg-icon: none;');
        ie_close('code');
        itext(' if you wish to use the UTF-8 charset or third-party icon font.');
      ie_close('div');
      ie_open('ol', null, null,
        ...
        ie_open('li', null, null,
          ...
          ie_open('a', null, null,
            ...
            ie_open('span', null, null,
                'class', 'breadcrumb-text-truncate');
              itext('Breadcrumbs and Paginations');
            ie_close('span');
          ie_close('a');
        ie_close('li');
        ie_open('li', null, null,
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'HfSVg.render';
}
...
class HfSVg extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(HfSVg, templates);
...
var _breadcrumbsSoy = __webpack_require__(95);

var _breadcrumbsSoy2 = _interopRequireDefault(_breadcrumbsSoy);
...
var HfSVg = function (_Component) {
  _inherits(HfSVg, _Component);

  function HfSVg() {
    _classCallCheck(this, HfSVg);

    return _possibleConstructorReturn(this, (HfSVg.__proto__ || Object.getPrototypeOf(HfSVg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HfSVg, _breadcrumbsSoy2.default);

exports.default = HfSVg;
