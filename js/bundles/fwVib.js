var pageComponent =
webpackJsonppageComponent([9,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('label', null, null,
                ...
                var attributes__soy79 = function() {
                  if (opt_data.atlas) {
                    iattr('checked', '');
                  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fwVib", function() { return fwVib; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace fwVib.
 * @public
 */

goog.module('fwVib.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1389 = function() {
    ie_open('div', null, null,
        'class', 'row row-spacing');
      ie_open('div', null, null,
          'class', 'col-md-12');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('A jQuery plugin that creates a slideout navigation on the right or left, for the sidebar css component see ');
            ie_open('a', null, null,
                'href', '../sidebar');
              itext('Sidebar');
            ie_close('a');
    ...
    ie_close('div');
    ie_open('div', null, null,
        'class', 'row row-spacing sidenav-demo-container');
      ie_open('div', null, null,
          'class', 'col-md-12');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('To create a sidenav relative to other elements inside your page, you must follow the markup structure shown above and pass the sidenav-container element to the plugin with the ');
            ie_open('code');
              itext('href');
            ie_close('code');
            itext(' attribute or the ');
            ie_open('code');
              itext('data-target');
            ie_close('code');
            itext(' attribute on the toggler. The ');
            ie_open('code');
              itext('container');
            ie_close('code');
            itext(' option also allows you to pass the container via javascript if ');
            ie_open('code');
              itext('href');
            ie_close('code');
            itext(' or ');
            ie_open('code');
              itext('data-target');
            ie_close('code');
            itext(' can\'t be used. The options above are optional.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('div', null, null,
            'class', 'alert alert-info');
          itext('Avoid the flash of unstyled content when using the Javascript api by adding the class ');
          ie_open('span', null, null,
              'class', 'text-danger');
            itext('sidenav-js-fouc');
          ie_close('span');
          itext(' to the ');
          ie_open('span', null, null,
              'class', 'text-danger');
            itext('sidenav-container');
          ie_close('span');
          itext('.');
        ie_close('div');
        ie_open('button', null, null,
            'class', 'active btn btn-default open sidenav-toggler',
            'data-target', '#mySidenavContainerId',
            'style', 'margin-bottom:5px;');
          itext('Sidenav Toggler');
        ie_close('button');
        ie_open('div', null, null,
            'class', 'open sidenav-container sidenav-js-fouc',
            'id', 'mySidenavContainerId');
          ie_open('div', null, null,
              'class', 'sidenav-menu-slider',
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                  'class', 'col-md-12');
                ie_open('a', null, null,
                    'class', 'pull-right sidenav-close',
                    'href', '#1');
                  itext('X');
                ie_close('a');
                ie_open('p');
                  itext('... Your Side Nav Content ...');
                ie_close('p');
              ie_close('div');
            ie_close('div');
          ie_close('div');
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'col-md-12');
              itext('... Your Main Content ...');
            ie_close('div');
          ie_close('div');
        ie_close('div');
        $templateAlias2({code: '<button class="btn btn-default sidenav-toggler" data-target="#mySidenavContainerId">\n    Sidenav Toggler\n</button>\n\n<div class="sidenav-container" id="mySidenavContainerId">\n    <div class="sidenav-menu-slider">\n        <div class="sidenav-menu">\n            <div class="col-md-12">... Your Side Nav Content ...</div>\n        </div>\n    </div>\n\n    <div class="sidenav-content">\n        <div class="col-md-12">... Your Main Content ...</div>\n    </div>\n</div>\n\n<script>\n    $(\'.sidenav-toggler\').sideNavigation();\n<\/script>', mode: 'xml'}, null, opt_ijData);
      ie_close('div');
    ie_close('div');
    ie_open('div', null, null,
        'class', 'row row-spacing sidenav-demo-container');
      ie_open('div', null, null,
          'class', 'col-md-12');
        ie_open('button', null, null,
            'class', 'active btn btn-default open sidenav-toggler1',
            'style', 'margin-bottom:5px;');
          itext('Sidenav Toggler 1');
        ie_close('button');
        ie_open('div', null, null,
            'class', 'open sidenav-container sidenav-js-fouc',
            'id', 'mySidenavContainerId1');
          ie_open('div', null, null,
              'class', 'sidenav-menu-slider',
              'style', 'background:#FFF;');
            ie_open('div', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
          'class', 'col-md-12');
        ie_open('h3');
          itext('Side Navigation Data API');
        ie_close('h3');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('The Side Navigation data api was added for situations where there is limited control over the markup structure. The only markup needed is a toggler and a panel to hide and show. These items can be included anywhere on the page.');
          ie_close('p');
          ie_open('p');
            itext('The minimum amount of attributes required is ');
            ie_open('code');
              itext('data-toggle="sidenav"');
            ie_close('code');
            itext(' and ');
            ie_open('code');
              itext('href="#target"');
            ...
            itext(' or ');
            ie_open('code');
              itext('data-target="#target"');
            ie_close('code');
            itext('. This will open and close a fixed position sidenav provided the markup below. The width of the ');
            ie_open('code');
              itext('sidenav-slider');
            ie_close('code');
            itext(', ');
            ie_open('code');
              itext('sidenav-menu');
            ie_close('code');
            itext(', and position of the sidenav must be set through css. When using ');
            ie_open('code');
              itext('fixed-push');
            ie_close('code');
            itext(', padding must also be set via css on open to push the content over.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('div', null, null,
            'class', 'side-navigation-data-api-buttons');
          ie_open('a', null, null,
          ...
          ie_open('a', null, null,
              ...
              'data-toggle', 'sidenav',
              'href', '#simpleSidenav');
            itext('Another Simple Sidenav Toggler');
          ie_close('a');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'sidenav-fixed sidenav-menu-slider',
            'id', 'simpleSidenav');
          ie_open('div', null, null,
              'class', 'sidebar sidebar-default sidenav-menu');
            ie_open('div', null, null,
                'class', 'sidebar-header');
              ie_open('ul', null, null,
                ...
                ie_open('li');
                  ie_open('a', null, null,
                    ...
                    ie_open('svg', null, null,
                        'aria-hidden', 'true',
                        'class', 'icon-monospaced lexicon-icon');
                      ie_void('use', null, null,
                          'xlink:href', '/vendor/lexicon/icons.svg#times');
                    ie_close('svg');
                  ie_close('a');
                ie_close('li');
              ie_close('ul');
              ie_open('a', null, null,
                  ...
                  'href', '#1');
                ie_open('svg', null, null,
                    'class', 'icon-monospaced lexicon-icon sticker sticker-default sticker-static');
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#staging');
                ie_close('svg');
                ie_open('span');
                  itext('Simple Sidenav');
                ie_close('span');
              ie_close('a');
            ie_close('div');
            ie_void('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                  'class', 'nameplate');
                ie_open('div', null, null,
                    'class', 'nameplate-field');
                  ie_open('div', null, null,
                      'class', 'user-icon user-icon-warning');
                    itext(':D');
                  ie_close('div');
                ie_close('div');
                ie_open('div', null, null,
                    'class', 'nameplate-content');
                  itext('Joe Bloggs');
                  ie_open('br');
                  ie_close('br');
                  itext('Subheading');
        ...
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('The data api allows for fixed-push style sidenavs with the attributes ');
            ie_open('code');
              itext('data-content');
            ie_close('code');
            itext(', ');
            ...
            itext(', and ');
            ie_open('code');
              itext('data-type-mobile');
            ie_close('code');
            itext('. ');
            ie_open('code');
              itext('Data-content');
            ie_close('code');
            itext(' is the id of the content to be pushed over when the nav is open. ');
            ie_open('code');
              itext('Data-type');
            ie_close('code');
            itext(' and ');
            ie_open('code');
              itext('data-type-mobile');
            ie_close('code');
            itext(' give the option to specify the style of sidenav in desktop and mobile, respectively. The values can be ');
            ie_open('code');
              itext('fixed');
            ie_close('code');
            itext(' or ');
            ie_open('code');
              itext('fixed-push');
            ie_close('code');
            itext(' and defaults to fixed.');
          ie_close('p');
          ie_open('p');
            itext('The open class name can be customized through the attribute ');
            ie_open('code');
              itext('data-open-class');
            ie_close('code');
            itext(' and will be added to toggler and content on open. ');
          ie_close('p');
        ie_close('blockquote');
        ie_open('div', null, null,
            'class', 'side-navigation-data-api-buttons');
          ie_open('a', null, null,
              ...
              'data-toggle', 'sidenav',
              'href', '#simpleSidenav2');
            itext('Simple Sidenav 2 Toggler');
          ie_close('a');
          ie_open('a', null, null,
              'class', 'btn btn-default',
              'data-content', 'body',
              ...
              'data-type-mobile', 'fixed-push',
              'href', '#simpleSidenav2');
            itext('Another Simple Sidenav 2 Toggler');
          ie_close('a');
          ie_open('a', null, null,
              'class', 'btn btn-default',
              'href', '#1',
              'id', 'showSimpleSidenav2');
            itext('Show Simple Sidenav 2');
          ie_close('a');
          ie_open('a', null, null,
              'class', 'btn btn-default',
              'href', '#1',
              'id', 'hideSimpleSidenav2');
            itext('Hide Simple Sidenav 2');
          ie_close('a');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'sidenav-fixed sidenav-menu-slider',
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('a', null, null,
                  ...
                  'href', '#1');
                ie_open('svg', null, null,
                    'class', 'icon-monospaced lexicon-icon sticker sticker-danger sticker-static');
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#home');
                ie_close('svg');
                ie_open('span');
                  itext('Simple Sidenav 2');
                ie_close('span');
              ie_close('a');
            ie_close('div');
            ie_void('div', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
          'class', 'col-md-12');
        ie_open('h3');
          itext('Lazy Loading Side Navigation Content');
        ie_close('h3');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('You can load content into the sidebar of the Side Navigation in one of two ways. At the very minimum, the only two things you need are a URL and that the sidebar has a child element with the ');
            ie_open('code');
              itext('sidebar-body');
            ie_close('code');
            itext(' class. Data fetched from the URL will be appended to the ');
            ie_open('code');
              itext('sidebar-body');
            ie_close('code');
            itext(' element.');
        ...
        ie_open('blockquote', null, null,
          ...
          ie_open('p');
            ...
            ie_open('code');
              itext('data-url');
            ie_close('code');
            itext(' on the toggle to load content into ');
            ie_open('code');
              itext('.sidenav-body');
            ie_close('code');
            itext(' when the side navigation is opened.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('div');
          ie_open('a', null, null,
              ...
              'data-toggle', 'sidenav',
              'data-type', 'fixed-push',
              'data-url', 'ROOTPATH/partials/alerts',
              'href', '#simpleSidenav3');
            itext('Simple Sidenav 3 Toggler');
          ie_close('a');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'sidenav-fixed sidenav-menu-slider',
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('a', null, null,
                  ...
                  'href', '#1');
                ie_open('svg', null, null,
                    'class', 'icon-monospaced lexicon-icon sticker sticker-static sticker-warning');
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#home');
                ie_close('svg');
                ie_open('span');
                  itext('Simple Sidenav 3');
                ie_close('span');
              ie_close('a');
            ie_close('div');
            ie_void('div', null, null,
        ...
        ie_close('div');
        ie_open('h4');
          itext('Using the Options API');
        ie_close('h4');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          itext('When configuring your sidenav, you can specify the url using either a string or a configuration object that will be passed to ');
          ie_open('code');
            itext('$.ajax');
          ie_close('code');
          itext(' (though make sure the config object contains the url property).');
        ie_close('blockquote');
        $templateAlias2({code: '<div class="sidenav-container">\n    <a class="btn btn-default sidenav-toggler" href="">\n        <span class="glyphicon glyphicon-align-justify"></span> Toggle\n    </a>\n\n    <div class="sidenav-menu-slider">\n        <div class="sidenav-menu">\n            <div class="sidebar-body">\n                Dynamic Content will be appended here...\n            </div>\n        </div>\n    </div>\n\n    <div class="sidenav-content">\n        <div class="col-md-12">... Your Main Content ...</div>\n    </div>\n</div>\n\n<script>\n    $(\'.sidenav-toggler\').sideNavigation({\n        ...\n        // url can be either a string\n        url: \'/foo.html\',\n\n        // or it can be an ajax config object\n        url: {\n            url: \'/foo.html\',\n            type: \'POST\',\n            success: function(response) {\n                // runs before the content is appended\n            },\n            // ...etc...\n        },\n        ...\n    });\n<\/script>', mode: 'xml'}, null, opt_ijData);
        ie_open('h4');
          itext('Lazy Loading Events and State');
        ie_close('h4');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('When using the ');
            ie_open('code');
              itext('url');
            ie_close('code');
            itext(' or ');
            ie_open('code');
              itext('data-url');
            ie_close('code');
            itext(' options, the plugin will fire an event when the content is loaded ');
            ie_open('code');
              itext('urlLoaded.lexicon.sidenav');
            ie_close('code');
            itext('.');
          ie_close('p');
          ie_open('p');
            itext('Also, while the content is being loaded, an element ');
            ie_open('code');
              itext('.sidebar-loading');
            ie_close('code');
            itext(' containing a loading animation will be added to the ');
            ie_open('code');
              itext('.sidebar-body');
            ie_close('code');
            itext(' element. The ');
            ie_open('code');
              itext('.sidebar-loading');
            ie_close('code');
            itext(' element will be removed when the content is done loading.');
          ie_close('p');
          ie_open('p');
            itext('The loading animation defaults to ');
            ie_open('a', null, null,
                'href', 'ROOTPATH/content/loaders/#dotted-spinner');
              itext('dotted spinner');
            ie_close('a');
            itext(' but can be customized through ');
            ie_open('code');
              itext('loadingIndicatorTPL');
            ie_close('code');
            itext(' in the options API or ');
            ie_open('code');
              itext('data-loading-indicator-tpl');
            ie_close('code');
            itext(' in the data API.');
          ie_close('p');
          ie_open('p');
            itext('If using the options API, the class will be added to the ');
            ie_open('code');
              itext('.sidenav-menu');
            ie_close('code');
            itext(' element.');
    ...
    ie_close('div');
    ie_open('div', null, null,
        'class', 'row row-spacing side-navigation-events');
      ie_open('div', null, null,
          'class', 'col-md-12');
        ie_open('h3');
          itext('Events');
        ...
        ie_open('p');
          ie_open('code');
            itext('openStart.lexicon.sidenav');
          ie_close('code');
        ie_close('p');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Fires when the side navigation begins to open.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          ie_open('code');
            itext('open.lexicon.sidenav');
          ie_close('code');
        ie_close('p');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Fires when the side navigation is fully opened.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          ie_open('code');
            itext('closedStart.lexicon.sidenav');
          ie_close('code');
        ie_close('p');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Fires when the side navigation begins to close.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          ie_open('code');
            itext('closed.lexicon.sidenav');
          ie_close('code');
        ie_close('p');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Fires when the side navigation is fully closed.');
          ie_close('p');
        ie_close('blockquote');
        $templateAlias2({code: '// Listen directly on the side navigation element\n\n$(SIDENAV).on(\'closed.lexicon.sidenav\', function(event) {\n    var sidenav = $(event.target);\n    var toggler = event.toggler;\n});\n\n// Listen for it on the document (will not work with event.stopPropagation())\n\n$(document).on(\'closed.lexicon.sidenav\', function(event) {\n    var sidenav = $(event.target);\n    var toggler = event.toggler;\n});', mode: 'xml'}, null, opt_ijData);
      ie_close('div');
    ie_close('div');
    ie_open('div', null, null,
        'class', 'row row-spacing side-navigation-methods');
      ie_open('div', null, null,
          'class', 'col-md-12');
        ie_open('h3');
          itext('Methods');
        ...
        ie_open('h4');
          ie_open('code');
            itext('.sideNavigation(\'toggle\')');
          ie_close('code');
        ie_close('h4');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Manually toggles the sidenav. ');
            ie_open('b');
              itext('Be aware that this method will return to the caller before the sidenav has been shown or hidden.');
            ie_close('b');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          $templateAlias2({code: '$(\'#myTogglerId\').sideNavigation(\'toggle\')', mode: 'xml'}, null, opt_ijData);
        ie_close('p');
        ie_open('h4');
          ie_open('code');
            itext('.sideNavigation(\'show\')');
          ie_close('code');
        ie_close('h4');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Manually shows the sidenav. ');
            ie_open('b');
              itext('Be aware that this method will return to the caller before the sidenav has been shown.');
            ie_close('b');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          $templateAlias2({code: '$(\'#myTogglerId\').sideNavigation(\'show\')', mode: 'xml'}, null, opt_ijData);
        ie_close('p');
        ie_open('h4');
          ie_open('code');
            itext('.sideNavigation(\'hide\')');
          ie_close('code');
        ie_close('h4');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Manually toggles the sidenav. ');
            ie_open('b');
              itext('Be aware that this method will return to the caller before the sidenav has been hidden.');
            ie_close('b');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          $templateAlias2({code: '$(\'#myTogglerId\').sideNavigation(\'hide\')', mode: 'xml'}, null, opt_ijData);
        ie_close('p');
        ie_open('h4');
          ie_open('code');
            itext('.sideNavigation(\'destroy\')');
          ie_close('code');
        ie_close('h4');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Destroys the Side Navigation instance for the items in the jQuery collection, and removes any attached event handlers and any associated data added by the plugin.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          $templateAlias2({code: '$(\'#myTogglerId\').sideNavigation(\'destroy\')', mode: 'xml'}, null, opt_ijData);
        ie_close('p');
        ie_open('h4');
          ie_open('code');
            itext('.sideNavigation(\'instance\')');
          ie_close('code');
        ie_close('h4');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Returns the Side Navigation instance for the first item in the jQuery collection (similar to how any other jQuery getter method works). If the plugin hasn\'t been initialized, it will return null.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          $templateAlias2({code: '$(\'#myTogglerId\').sideNavigation(\'instance\')', mode: 'xml'}, null, opt_ijData);
        ie_close('p');
        ie_open('h4');
          ie_open('code');
            itext('.sideNavigation(\'visible\')');
          ie_close('code');
        ie_close('h4');
        ie_open('blockquote', null, null,
            'class', 'blockquote-sm blockquote-success');
          ie_open('p');
            itext('Returns the visible state of the sidenav.');
          ie_close('p');
          ie_open('p');
            itext('If the sidenav is in the middle of transitioning, this will report what the visible state ');
            ie_open('b');
              itext('will be after');
            ie_close('b');
            itext(' the transition is finished. This allows you to call it in any state and accurately get the state of the sidenav.');
          ie_close('p');
        ie_close('blockquote');
        ie_open('p');
          $templateAlias2({code: '$(\'#myTogglerId\').sideNavigation(\'show\').sideNavigation(\'visible\'); // returns true\n\n$(\'#myTogglerId\').sideNavigation(\'hide\').sideNavigation(\'visible\'); // returns false', mode: 'xml'}, null, opt_ijData);
        ie_close('p');
      ie_close('div');
    ie_close('div');
    itext('\n\t');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1389}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'fwVib.render';
}
...
class fwVib extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(fwVib, templates);
...
var _sidenavSoy = __webpack_require__(125);

var _sidenavSoy2 = _interopRequireDefault(_sidenavSoy);
...
var fwVib = function (_Component) {
  _inherits(fwVib, _Component);

  function fwVib() {
    _classCallCheck(this, fwVib);

    return _possibleConstructorReturn(this, (fwVib.__proto__ || Object.getPrototypeOf(fwVib)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fwVib, _sidenavSoy2.default);

exports.default = fwVib;
