var pageComponent =
webpackJsonppageComponent([20,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FcimM", function() { return FcimM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace FcimM.
 * @public
 */

goog.module('FcimM.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param838 = function() {
    ie_open('article', null, null,
        'id', 'list-group-item-flex');
      ie_open('h3');
        itext('List Group Item Flex');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Align content inside ');
          ie_open('code');
            itext('.list-group-item');
          ie_close('code');
          itext(' with flexbox with ');
          ie_open('code');
            itext('.list-group-item-flex');
          ie_close('code');
          itext('.');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Use a combination of ');
          ie_open('code');
            itext('.flex-col');
          ie_close('code');
          itext(' and ');
          ie_open('code');
            itext('.flex-col.flex-col-expand');
          ie_close('code');
          itext(' to control the size of each cell.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('Add the class ');
          ie_open('code');
            itext('show-dropdown-action-on-active');
          ie_close('code');
          itext(' to display ');
          ie_open('code');
            itext('dropdown-menu');
          ie_close('code');
          itext('\'s on active in List Groups.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('Direct descendants of ');
        ie_open('code');
          itext('flex-col');
        ie_close('code');
        itext(' become block level elements by default, see ');
        ie_open('a', null, null,
            'href', 'https://www.w3.org/TR/css-flexbox-1/#flex-items');
          itext('https://www.w3.org/TR/css-flexbox-1/#flex-items');
        ie_close('a');
        itext('. If you want to display content using ');
        ie_open('code');
          itext('floats');
        ie_close('code');
        itext(', ');
        ...
        ie_open('code');
          itext('inline-block');
        ie_close('code');
        itext(' wrap the content with a block level element such as a div.');
      ie_close('div');
      ie_open('ul', null, null,
          'class', 'list-group show-dropdown-action-on-active');
        ie_open('li', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('h4', null, null,
              ...
              ie_open('a', null, null,
                  'href', '#1');
                itext('Account Example One');
              ie_close('a');
            ie_close('h4');
            ie_open('p', null, null,
                'class', 'list-group-subtitle text-truncate');
              itext('Second Level Text');
            ie_close('p');
            ie_open('div');
              ie_open('span', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'list-group list-group-bordered show-dropdown-action-on-active');
        ie_open('li', null, null,
            'class', 'list-group-item list-group-item-flex');
          ie_open('div', null, null,
              'class', 'flex-col');
          ...
          ie_open('div', null, null,
              'class', 'flex-col flex-col-expand');
            ie_open('h4', null, null,
                'class', 'list-group-title truncate-text');
              ie_open('a', null, null,
                  'href', '#1');
                itext('Account Example One');
              ie_close('a');
            ie_close('h4');
            ie_open('p', null, null,
                'class', 'list-group-subtitle truncate-text');
              itext('Second Level Text');
            ie_close('p');
            ie_open('div');
              ie_open('span', null, null,
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'list-group-unstyled');
      ie_open('h3');
        itext('List Group Unstyled');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use ');
          ...
          ie_open('code');
            itext('.list-group');
          ie_close('code');
          itext(' to remove default styles.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'list-group list-group-unstyled');
        ie_open('li', null, null,
            'class', 'list-group-header');
          ie_open('h3', null, null,
              'class', 'list-group-header-title');
        ...
        ie_open('li', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'h5');
              itext('Larry Bird the best power forward in Celtic\'s history.');
            ie_close('div');
            ie_open('div', null, null,
                'class', 'h6');
              ie_open('a', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                  'aria-labelledby', '',
                  'class', 'dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  ie_open('svg', null, null,
        ...
        ie_open('li', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'h5');
              itext('Karl Malone the best power forward in Jazz history.');
            ie_close('div');
            ie_open('div', null, null,
                'class', 'h6');
              ie_open('a', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('a', null, null,
                'class', 'list-group-item list-group-item-action',
                'href', '#1');
              itext('List Item Action Normal');
            ie_close('a');
            ie_open('a', null, null,
                'class', 'list-group-item list-group-item-action list-group-item-success',
                'href', '#1');
              itext('List Item Action Success');
            ie_close('a');
            ie_open('a', null, null,
                'class', 'list-group-item list-group-item-action list-group-item-info',
                'href', '#1');
              itext('List Item Action Info');
            ie_close('a');
            ie_open('a', null, null,
                'class', 'list-group-item list-group-item-action list-group-item-warning',
                'href', '#1');
              itext('List Item Action Warning');
            ie_close('a');
            ie_open('a', null, null,
                'class', 'list-group-item list-group-item-action list-group-item-danger',
                'href', '#1');
              itext('List Item Action Danger');
            ie_close('a');
            ie_open('a', null, null,
                'class', 'list-group-item list-group-item-action list-group-item-light',
                'href', '#1');
              itext('List Item Action Light');
            ie_close('a');
            ie_open('a', null, null,
                'class', 'list-group-item list-group-item-action list-group-item-dark',
                'href', '#1');
              itext('List Item Action Dark');
            ie_close('a');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param838}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'FcimM.render';
}
...
class FcimM extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(FcimM, templates);
...
var _list_groupsSoy = __webpack_require__(107);

var _list_groupsSoy2 = _interopRequireDefault(_list_groupsSoy);
...
var FcimM = function (_Component) {
  _inherits(FcimM, _Component);

  function FcimM() {
    _classCallCheck(this, FcimM);

    return _possibleConstructorReturn(this, (FcimM.__proto__ || Object.getPrototypeOf(FcimM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FcimM, _list_groupsSoy2.default);

exports.default = FcimM;
