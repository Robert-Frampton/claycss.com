var pageComponent =
webpackJsonppageComponent([25,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QGTJv", function() { return QGTJv; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from form_elements.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace QGTJv.
 * @public
 */

goog.module('QGTJv.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param601 = function() {
    ie_open('article', null, null,
        'id', 'basic-form-elements');
      ie_open('h3');
        itext('Basic Form Elements');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Add class ');
          ie_open('code');
            itext('focus');
          ie_close('code');
          itext(' on the label to change the color of the label.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label');
            itext('Default text input');
            ie_open('span', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'regularSelectElement');
            itext('Regular Select Element');
          ie_close('label');
        ...
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'multipleSelectOptionsSelectElement');
            itext('Select Element with Multiple Select Options');
          ie_close('label');
          ie_open('select', null, null,
              'class', 'form-control',
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_close('input');
      ie_close('div');
      $templateAlias2({code: '<label class="sr-only" for="inputFile">FILE UPLOAD</label>\n<input id="inputFile" type="file">', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'disabled-inputs');
      ie_open('h3');
        itext('Disabled Inputs');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Add class ');
          ie_open('code');
            itext('disabled');
          ie_close('code');
          itext(' on the label to match the opacity to disabled input.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
          ...
          ie_open('input', null, null,
              ...
              'placeholder', 'Placeholder',
              'type', 'text',
              'value', 'Plunger pot, extra siphon latte');
          ie_close('input');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'form-group');
        ...
        ie_open('div', null, null,
          ...
          ie_open('textarea', null, null,
              ...
              'id', 'disabledTextarea',
              'placeholder', 'Placeholder');
            itext('Plunger pot, extra siphon latte');
          ie_close('textarea');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'class', 'disabled',
              'for', 'disabledSelectElement');
            itext('Select Element');
          ie_close('label');
          ie_open('select', null, null,
              'class', 'form-control',
              'disabled', '',
              'id', 'disabledSelectElement');
            ie_open('option');
              itext('Sample 1');
            ie_close('option');
            ie_open('option');
        ...
        ie_open('div', null, null,
          ...
          ie_open('label', null, null,
              'class', 'disabled',
              'for', 'disabledSelectElementMulti');
            itext('Select Element with Multiple Select Options');
          ie_close('label');
          ie_open('select', null, null,
              'class', 'form-control',
              'disabled', '',
              'id', 'disabledSelectElementMulti',
              'multiple', '');
            ie_open('option');
              itext('Sample 1');
            ie_close('option');
        ...
        ie_open('form');
          ie_open('fieldset', null, null,
            ...
            ie_open('div', null, null,
                'class', 'form-group');
              ie_open('label');
                itext('Use fieldset to group related elements in a form and ReallySuperInsanelyJustIncrediblyLongAndTotallyNotPossibleWordButWeAreReallyTryingToCoverAllOurBasesHereJustInCaseSomeoneIsNutsAsPerUsual');
                ie_open('input', null, null,
                    'class', 'form-control',
                    'type', 'text',
                    'value', 'Plunger pot, extra siphon latte');
            ...
            ie_open('div', null, null,
                'class', 'form-group');
              ie_open('label', null, null,
                  'for', 'disabledFieldsetTextInput2');
                itext('Disabled Input');
              ie_close('label');
              ie_open('input', null, null,
                  'class', 'form-control',
                  'id', 'disabledFieldsetTextInput2',
                  'type', 'text',
                  'value', 'Plunger pot, extra siphon latte');
              ie_close('input');
            ie_close('div');
            ie_open('div', null, null,
                'class', 'form-group');
              ie_open('label', null, null,
                  'for', 'disabledFieldsetSelectElement');
                itext('Disabled Select Element');
              ie_close('label');
              ie_open('select', null, null,
                  'class', 'form-control',
                  'id', 'disabledFieldsetSelectElement');
                ie_open('option');
                  itext('Sample 1');
                ie_close('option');
                ie_open('option');
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'readonlyTextInput');
            itext('Text Input (Read Only)');
          ie_close('label');
          ie_open('input', null, null,
              'class', 'form-control',
              ...
              'readonly', '',
              'type', 'text',
              'value', 'Con panna aroma, pumpkin spice to go, wings, aromatic single shot, aged single shot to go extraction java.');
          ie_close('input');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'readonlyTextarea');
            itext('Textarea (Read Only)');
          ie_close('label');
          ie_open('textarea', null, null,
              'class', 'form-control',
              'id', 'readonlyTextarea',
              'placeholder', 'Placeholder',
              'readonly', '');
            itext('Plunger pot, extra siphon latte, as americano aromatic roast cultivar cup cup frappuccino. To go, strong, half and half foam single origin, cultivar affogato black grounds shop ut plunger pot. Con panna aroma, pumpkin spice to go, wings, aromatic single shot, aged single shot to go extraction java. Percolator americano at cultivar grinder est java percolator plunger pot shop con panna.');
          ie_close('textarea');
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<label for="readonlyTextInput">Text Input (Read Only)</label>\n<input class="form-control" id="readonlyTextInput" placeholder="Placeholder" readonly type="text" value="Con panna aroma, pumpkin spice to go, wings, aromatic single shot, aged single shot to go extraction java.">\n\n<label for="readonlyTextarea">Textarea (Read Only)</label>\n<textarea class="form-control" id="readonlyTextarea" placeholder="Placeholder" readonly>Plunger pot, extra siphon latte, as americano aromatic roast cultivar cup cup frappuccino. To go, strong, half and half foam single origin, cultivar affogato black grounds shop ut plunger pot. Con panna aroma, pumpkin spice to go, wings, aromatic single shot, aged single shot to go extraction java. Percolator americano at cultivar grinder est java percolator plunger pot shop con panna.</textarea>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'form-element-sizes');
      ie_open('h3');
        itext('Form Element Sizes');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div class="form-inline">\n    <label for="formInlineInput">Form Inline</label>\n    <input class="form-control" id="formInlineInput" type="text">\n    <button class="btn btn-primary" type="submit">Submit</button>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'form-inline-autofit');
      ie_open('h3');
        itext('Form Inline Autofit');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Equally spaced form inputs. To set a fixed width use ');
          ie_open('code');
            itext('flex-grow: 0; flex-basis: 200px;');
          ie_close('code');
          itext(' on ');
          ie_open('code');
            itext('.form-inline-group');
          ie_close('code');
          itext(' or any direct descendant of ');
          ie_open('code');
            itext('.form-inline-autofit');
          ie_close('code');
          itext('.');
      ...
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
            'class', 'form-group form-inline form-inline-autofit');
          ie_open('div', null, null,
              'class', 'form-inline-group');
            ie_open('label', null, null,
                'for', 'formInlineAutofitTextInput1');
              itext('Form Inline Autofit');
            ie_close('label');
            ie_open('input', null, null,
                'class', 'form-control',
          ...
          ie_open('div', null, null,
              'class', 'form-inline-group');
            ie_open('label', null, null,
                'for', 'formInlineAutofitSelectElement1');
              itext('Select Element');
            ie_close('label');
            ie_open('select', null, null,
                'class', 'form-control',
        ...
        ie_close('div');
        ie_open('div', null, null,
            'class', 'align-items-end form-group form-inline form-inline-autofit');
          ie_open('div', null, null,
              'class', 'form-inline-group');
            ie_open('label', null, null,
                'for', 'formInlineAutofitTextInput2');
              itext('First Name');
            ie_close('label');
            ie_open('input', null, null,
                'class', 'form-control',
      ...
      ie_open('div', null, null,
        ...
        ie_open('form', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group form-inline form-inline-autofit');
            ie_open('label', null, null,
                'for', 'formInlineAutofitCustomAddress1');
              itext('Address 1');
            ie_close('label');
            ie_open('input', null, null,
                'class', 'form-control',
          ...
          ie_open('div', null, null,
              'class', 'form-group form-inline form-inline-autofit');
            ie_open('label', null, null,
                'for', 'formInlineAutofitCustomAddress2');
              itext('Address 2');
            ie_close('label');
            ie_open('input', null, null,
                'class', 'form-control',
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'QGTJv.render';
}
...
class QGTJv extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(QGTJv, templates);
...
var _form_elementsSoy = __webpack_require__(102);

var _form_elementsSoy2 = _interopRequireDefault(_form_elementsSoy);
...
var QGTJv = function (_Component) {
  _inherits(QGTJv, _Component);

  function QGTJv() {
    _classCallCheck(this, QGTJv);

    return _possibleConstructorReturn(this, (QGTJv.__proto__ || Object.getPrototypeOf(QGTJv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QGTJv, _form_elementsSoy2.default);

exports.default = QGTJv;
