var pageComponent =
webpackJsonppageComponent([16,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TnSvb", function() { return TnSvb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from navbars.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace TnSvb.
 * @public
 */

goog.module('TnSvb.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1196 = function() {
    ie_open('article', null, null,
        'id', 'navbar-expand-md');
      ie_open('h3');
        itext('Navbar Expand Md');
      ie_close('h3');
      ie_open('p');
        ie_open('nav', null, null,
          ...
          ie_open('a', null, null,
            ...
            ie_open('span', null, null,
              ...
              itext('Brand ReallySuperInsanelyJustIncrediblyLongAndTotallyNotPossibleWordButWeAreReallyTryingToCoverAllOurBasesHereJustInCaseSomeoneIsNutsAsPerUsual');
            ie_close('span');
          ie_close('a');
          ie_open('button', null, null,
              'aria-expanded', 'false',
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                  ...
                  ie_open('span', null, null,
                      'class', 'navbar-text-truncate');
                    itext('ActiveReallySuperInsanelyJustIncrediblyLongAndTotallyNotPossibleWordButWeAreReallyTryingToCoverAllOurBasesHereJustInCaseSomeoneIsNutsAsPerUsual');
                  ie_close('span');
                ie_close('a');
              ie_close('li');
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                  ...
                  ie_open('span', null, null,
                      'class', 'navbar-text-truncate');
                    itext('Dropdown ReallySuperInsanelyJustIncrediblyLongAndTotallyNotPossibleWordButWeAreReallyTryingToCoverAllOurBasesHereJustInCaseSomeoneIsNutsAsPerUsual');
                  ie_close('span');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('a', null, null,
                      'class', 'dropdown-item',
                      'href', '#1');
                    itext('One more separated link');
                  ie_close('a');
                ie_close('div');
              ie_close('li');
            ie_close('ul');
            ie_open('div', null, null,
                'class', 'navbar-form navbar-form-autofit');
              ie_open('form');
                ie_open('div', null, null,
                    'class', 'form-inline');
      ...
      ie_open('p');
        ie_open('nav', null, null,
          ...
          ie_open('button', null, null,
              'aria-expanded', 'false',
              'class', 'collapsed navbar-toggler',
              'data-target', '#navbar-collapse-0b',
              'data-toggle', 'collapse',
              'type', 'button');
            ie_open('svg', null, null,
                'aria-hidden', 'true',
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('.navbar-form');
          ie_close('code');
          itext(' should be wrapped around your form. It adds the proper spacing between your form and other navbar components e.g. ');
          ie_open('code');
            itext('.navbar-nav');
          ie_close('code');
          itext('.');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('The class ');
          ie_open('code');
            itext('.navbar-form-autofit');
          ie_close('code');
          itext(' should be added to ');
          ie_open('code');
            itext('.navbar-form');
          ie_close('code');
          itext(' to make the form expand to fill the remaining space.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('nav', null, null,
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                  ...
                  ie_open('span', null, null,
                      'class', 'navbar-text-truncate');
                    itext('DropdownReallySuperInsanelyJustIncrediblyLongAndTotallyNotPossibleWordButWeAreReallyTryingToCoverAllOurBasesHereJustInCaseSomeoneIsNutsAsPerUsual');
                  ie_close('span');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
                      'class', 'lexicon-icon lexicon-icon-caret-bottom');
            ...
            ie_open('div', null, null,
              ...
              ie_open('form');
                ie_open('div', null, null,
                  ...
                  ie_close('input');
                  ie_open('div', null, null,
                      'class', 'dropdown-wide input-group-btn');
                    ie_open('button', null, null,
                        'aria-expanded', 'false',
                        'aria-haspopup', 'true',
                        'class', 'btn btn-secondary',
                      ...
                      ie_open('svg', null, null,
                        ...
                        ie_void('use', null, null,
                            'xlink:href', '/vendor/lexicon/icons.svg#angle-down');
                      ie_close('svg');
                    ie_close('button');
                    ie_open('div', null, null,
                        'class', 'dropdown-menu');
                    ...
                    ie_open('button', null, null,
                      ...
                      ie_open('svg', null, null,
                        ...
                        ie_void('use', null, null,
                            'xlink:href', '/vendor/lexicon/icons.svg#search');
                      ie_close('svg');
                    ie_close('button');
                  ie_close('div');
                ie_close('div');
      ...
      ie_open('p');
        ie_open('nav', null, null,
          ...
          ie_open('button', null, null,
              ...
              'aria-label', 'Toggle navigation',
              'class', 'collapsed navbar-toggler',
              'data-target', '#navbar-collapse-2b',
              'data-toggle', 'collapse',
              'type', 'button');
            ie_open('svg', null, null,
                'aria-hidden', 'true',
      ...
      ie_open('p');
        ie_open('nav', null, null,
          ...
          ie_open('button', null, null,
              ...
              'aria-label', 'Toggle navigation',
              'class', 'collapsed navbar-toggler',
              'data-target', '#navbar-collapse-2c',
              'data-toggle', 'collapse',
              'type', 'button');
            ie_open('svg', null, null,
                'aria-hidden', 'true',
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'alternate-navbar-toggler-style');
      ie_open('h3');
        itext('Alternate Navbar Toggler Style');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('In mobile screen sizes, style the navbar toggler like a navbar navigation item with ');
          ie_open('code');
            itext('navbar-toggler-link');
          ie_close('code');
          itext('. Also use this pattern when you want the search bar to be easily accessible in both mobile and desktop.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'navbar navbar-expand-md navbar-underline');
          ie_open('button', null, null,
              'aria-label', 'Toggle navigation',
              'class', 'collapsed navbar-toggler navbar-toggler-link',
              'data-target', '#navbar-collapse-d-001',
              'data-toggle', 'collapse',
              'type', 'button');
            ie_open('span', null, null,
                'class', 'navbar-text-truncate');
              itext('Message Boards');
            ie_close('span');
            ie_open('svg', null, null,
                'aria-hidden', 'true',
                'class', 'lexicon-icon lexicon-icon-caret-bottom');
      ...
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'navbar navbar-expand-md navbar-light navbar-underline');
          ie_open('button', null, null,
              'aria-label', 'Toggle navigation',
              'class', 'collapsed navbar-toggler navbar-toggler-link',
              'data-target', '#navbar-collapse-001',
              'data-toggle', 'collapse',
              'type', 'button');
            ie_open('span', null, null,
                'class', 'navbar-text-truncate');
      ...
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'navbar navbar-collapse-absolute navbar-dark navbar-expand-md navbar-underline');
          ie_open('button', null, null,
              'aria-label', 'Toggle navigation',
              'class', 'collapsed navbar-toggler navbar-toggler-link',
              'data-target', '#navbar-collapse-001a',
              'data-toggle', 'collapse',
              'type', 'button');
            ie_open('span', null, null,
                'class', 'navbar-text-truncate');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('.navbar');
          ie_close('code');
          itext(' to preserve desktop navbar styles in mobile. It\'s useful when there are only one or two links in the navbar; where collapsing doesn\'t make sense.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('nav', null, null,
          ...
          ie_open('ul', null, null,
            ...
            ie_open('li', null, null,
              ...
              ie_open('a', null, null,
                ...
                ie_open('span', null, null,
                    'class', 'navbar-text-truncate');
                  itext('ReallySuperInsanelyJustIncrediblyLongAndTotallyNotPossibleWordButWeAreReallyTryingToCoverAllOurBasesHereJustInCaseSomeoneIsNutsAsPerUsual');
                ie_close('span');
              ie_close('a');
            ie_close('li');
            ie_open('li', null, null,
      ...
      ie_open('p');
        ...
        ie_close('nav');
      ie_close('p');
      $templateAlias2({code: '<nav class="navbar navbar-expand navbar-light">\n    <ul class="navbar-nav">\n        <li class="nav-item">\n            <a class="active nav-link" href="#1">\n                <span class="navbar-text-truncate">Message Boards</span>\n            </a>\n        </li>\n        <li class="dropdown nav-item">\n            <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle nav-link" data-toggle="dropdown" href="#1">\n                <span class="navbar-text-truncate">Blogs</span>\n                <svg aria-hidden="true" class="lexicon-icon lexicon-icon-caret-bottom">\n                    <use xlink:href="/vendor/lexicon/icons.svg#caret-bottom" />\n                </svg>\n            </a>\n            <div aria-labelledby="dropdownMenu" class="dropdown-menu">\n                <div class="dropdown-header" role="presentation">Dropdown Header</div>\n                <a class="dropdown-item" href="#1">Actions</a>\n                <a class="dropdown-item" href="#1">Edit</a>\n                <a class="dropdown-item" href="#1">View</a>\n                <a class="dropdown-item" href="#1">Permissions</a>\n                <a class="disabled dropdown-item" href="#1" role="menuitem">Disabled</a>\n                <div class="dropdown-divider" role="presentation"></div>\n                <a class="dropdown-item" href="#1" role="menuitem">Scope</a>\n            </div>\n        </li>\n    </ul>\n</nav>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'navbar-breakpoint-d-#');
      ie_open('h3');
        itext('Navbar-breakpoint-d-#');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-breakpoint-d-#');
          ie_close('code');
          itext(' block, inline-block, flex, none is a helper class to show content at it\'s expand breakpoint e.g. for ');
          ie_open('code');
            itext('.navbar-expand-md');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('navbar-breakpoint-d-block');
          ie_close('code');
          itext(' will ');
          ie_open('code');
            itext('display: block !important;');
          ie_close('code');
          itext(' at screen widths greater than 767px.');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'navbar-breakpoint-down-d-#');
      ie_open('h3');
        itext('Navbar-breakpoint-down-d-#');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-breakpoint-down-d-#');
          ie_close('code');
          itext(' block, inline-block, flex, none is a helper class to hide content at it\'s expand breakpoint e.g. for ');
          ie_open('code');
            itext('.navbar-expand-md');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('navbar-breakpoint-down-d-none');
          ie_close('code');
          itext(' will ');
          ie_open('code');
            itext('display: none;');
          ie_close('code');
          itext(' at screen widths less than or equal to 767px.');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-toggler');
          ie_close('code');
          itext(' is the button that opens and closes the navbar in mobile, must be used with the [http://getbootstrap.com/javascript/#collapse](collapse plugin).');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'navbar-toggler-link');
      ie_open('h3');
        itext('Navbar Toggler Link');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-toggler-link');
          ie_close('code');
          itext(' styles the navbar-toggler like a navbar link.');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-collapse');
          ie_close('code');
          itext(' is the container for all content that should be collapsed into a collapsible menu in mobile.');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'navbar-collapse-absolute');
      ie_open('h3');
        itext('Navbar Collapse Absolute');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Add ');
          ...
          ie_open('code');
            itext('navbar');
          ie_close('code');
          itext(' to turn navbar-collapse from a relative positioned menu into an absolutely positioned collapsible menu.');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
    ie_open('input', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1196}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'TnSvb.render';
}
...
class TnSvb extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(TnSvb, templates);
...
var _navbarsSoy = __webpack_require__(118);

var _navbarsSoy2 = _interopRequireDefault(_navbarsSoy);
...
var TnSvb = function (_Component) {
  _inherits(TnSvb, _Component);

  function TnSvb() {
    _classCallCheck(this, TnSvb);

    return _possibleConstructorReturn(this, (TnSvb.__proto__ || Object.getPrototypeOf(TnSvb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TnSvb, _navbarsSoy2.default);

exports.default = TnSvb;
