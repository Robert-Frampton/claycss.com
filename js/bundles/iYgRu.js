var pageComponent =
webpackJsonppageComponent([21,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "iYgRu", function() { return iYgRu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from images_aspect_ratio.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace iYgRu.
 * @public
 */

goog.module('iYgRu.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param799 = function() {
    ie_open('article', null, null,
        'id', 'image-aspect-ratios');
      ie_open('h3');
        itext('Image Aspect Ratios');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Sometimes you can\'t control the size of an image, constrain your images with aspect-ratios. The base class ');
          ie_open('code');
            itext('aspect-ratio');
          ie_close('code');
          itext(' maintains a 1 to 1 ratio relative to its container\'s width.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('Use ');
          ie_open('code');
            itext('aspect-ratio-3-to-2');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('aspect-ratio-4-to-3');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('aspect-ratio-8-to-5');
          ie_close('code');
          itext(', or ');
          ie_open('code');
            itext('aspect-ratio-16-to-9');
          ie_close('code');
          itext(' to maintain the specific ratio relative to its container or create your own by setting ');
          ie_open('code');
            itext('padding-bottom');
          ie_close('code');
          itext(' to the ratio you want e.g. 2 to 1 ');
          ie_open('code');
            itext('.aspect-ratio-2-to-1 { padding-bottom: 50% }');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'aspect-ratio-item-fluid');
      ie_open('h3');
        itext('Aspect Ratio Item Fluid');
      ie_close('h3');
      ie_open('h5');
        itext('Original Image');
      ie_close('h5');
      ie_open('p');
        ie_open('img', null, null,
            'alt', 'thumbnail',
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-3-to-2');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-fluid',
                'src', '/images/thumbnail_hot_air_ballon.jpg');
        ...
        ie_open('div', null, null,
          ...
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-4-to-3');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-fluid',
                'src', '/images/thumbnail_hot_air_ballon.jpg');
        ...
        ie_open('div', null, null,
          ...
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-8-to-5');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-fluid',
                'src', '/images/thumbnail_hot_air_ballon.jpg');
        ...
        ie_open('div', null, null,
          ...
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-fluid',
                'src', '/images/thumbnail_hot_air_ballon.jpg');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'aspect-ratio-item-vertical-fluid');
      ie_open('h3');
        itext('Aspect Ratio Item Vertical Fluid');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-vertical-fluid',
                'src', '/images/thumbnail_hot_air_ballon.jpg');
            ie_close('img');
          ie_close('div');
        ie_close('div');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'aspect-ratio-item');
      ie_open('h3');
        itext('Aspect Ratio Item');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use ');
          ie_open('code');
            itext('aspect-ratio-item');
          ie_close('code');
          itext(' if you want to keep the content\'s original size and crop the visible area.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', ' aspect-ratio-item aspect-ratio-item-center aspect-ratio-item-middle',
                'src', '/images/thumbnail_hot_air_ballon.jpg');
            ie_close('img');
          ie_close('div');
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div class="aspect-ratio aspect-ratio-16-to-9">\n    <img alt="thumbnail" class=" aspect-ratio-item aspect-ratio-item-center aspect-ratio-item-middle" src="/images/thumbnail_hot_air_ballon.jpg">\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'aspect-ratio-item-helper-classes');
      ie_open('h3');
        itext('Aspect Ratio Item Helper Classes');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-item-center-middle');
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
        ...
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-item-top-center');
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-top-center aspect-ratio-item-fluid',
                'src', '/images/liferay_logo_tagline.png');
            ie_close('img');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-item-top-right');
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-fluid aspect-ratio-item-top-right',
                'src', '/images/liferay_logo_tagline.png');
            ie_close('img');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-item-right-middle');
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-fluid aspect-ratio-item-right-middle',
                'src', '/images/liferay_logo_tagline.png');
            ie_close('img');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-item-bottom-right');
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-bottom-right aspect-ratio-item-fluid',
                'src', '/images/liferay_logo_tagline.png');
            ie_close('img');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-item-bottom-center');
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-bottom-center aspect-ratio-item-fluid',
                'src', '/images/liferay_logo_tagline.png');
            ie_close('img');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-item-bottom-left');
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-bottom-left aspect-ratio-item-fluid',
                'src', '/images/liferay_logo_tagline.png');
            ie_close('img');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-item-left-middle');
          ie_close('h6');
          ie_open('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9');
            ie_open('img', null, null,
                'alt', 'thumbnail',
                'class', 'aspect-ratio-item-left-middle aspect-ratio-item-fluid',
                'src', '/images/liferay_logo_tagline.png');
            ie_close('img');
          ie_close('div');
        ie_close('div');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'aspect-ratio-background-images');
      ie_open('h3');
        itext('Aspect Ratio Background Images');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-bg-cover');
          ie_close('h6');
          ie_void('div', null, null,
              'class', 'aspect-ratio aspect-ratio-16-to-9 aspect-ratio-bg-cover',
              'style', 'background-image: url(/images/thumbnail_hot_air_ballon.jpg);');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'col-3');
          ie_open('h6');
            itext('aspect-ratio-bg-center');
          ie_close('h6');
          ie_void('div', null, null,
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div class="aspect-ratio aspect-ratio-16-to-9 aspect-ratio-bg-cover" style="background-image: url(/images/thumbnail_hot_air_ballon.jpg);">\n</div>\n\n<div class="aspect-ratio aspect-ratio-16-to-9 aspect-ratio-bg-center" style="background-image: url(/images/liferay_logo_tagline.png);">\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'aspect-ratio-with-other-things');
      ie_open('h3');
        itext('Aspect Ratio with Other Things');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'aspect-ratio-item-center-middle aspect-ratio-item-fluid');
              itext('Some ReallySuperInsanelyJustIncrediblyLongAndTotallyNotPossible Text?');
            ie_close('div');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param799}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'iYgRu.render';
}
...
class iYgRu extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(iYgRu, templates);
...
var _images_aspect_ratioSoy = __webpack_require__(106);

var _images_aspect_ratioSoy2 = _interopRequireDefault(_images_aspect_ratioSoy);
...
var iYgRu = function (_Component) {
  _inherits(iYgRu, _Component);

  function iYgRu() {
    _classCallCheck(this, iYgRu);

    return _possibleConstructorReturn(this, (iYgRu.__proto__ || Object.getPrototypeOf(iYgRu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iYgRu, _images_aspect_ratioSoy2.default);

exports.default = iYgRu;
