var pageComponent =
webpackJsonppageComponent([5,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fGmnk", function() { return fGmnk; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace fGmnk.
 * @public
 */

goog.module('fGmnk.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1601 = function() {
    ie_open('article', null, null,
      ...
      ie_open('p', null, null,
        ...
        itext('Helvetica Neue bold / HELVETICA NEUE BOLD');
      ie_close('p');
      ie_open('p', null, null,
          'style', 'font-size:20px;font-style:italic;font-weight:normal;');
        itext('Helvetica Neue normal italic / HELVETICA NEUE NORMAL ITALIC');
      ie_close('p');
      ie_open('p', null, null,
          'style', 'font-size:20px;font-weight:normal;');
        itext('Helvetica Neue Normal / HELVETICA NEUE NORMAL');
      ie_close('p');
      ie_open('h3');
        itext('Serif');
      ie_close('h3');
      ie_open('p', null, null,
          'class', 'serif',
          'style', 'font-size:32px;font-weight:900;');
        itext('Georgia bold / GEORGIA BOLD');
      ie_close('p');
      ie_open('p', null, null,
          'class', 'serif',
          'style', 'font-size:20px;font-style:italic;font-weight:normal;');
        itext('Georgia normal italic / GEORGIA NORMAL ITALIC');
      ie_close('p');
      ie_open('p', null, null,
          'class', 'serif',
          'style', 'font-size:20px;font-weight:normal;');
        itext('Georgia Normal / GEORGIA NORMAL');
      ie_close('p');
      ie_open('h3');
        itext('Monospace');
      ie_close('h3');
      ie_open('p', null, null,
          'class', 'monospace',
          'style', 'font-size:32px;font-weight:900;');
        itext('Menlo bold / MENLO BOLD');
      ie_close('p');
      ie_open('p', null, null,
          'class', 'monospace',
          'style', 'font-size:20px;font-style:italic;font-weight:normal;');
        itext('Menlo normal italic / MENLO NORMAL ITALIC');
      ie_close('p');
      ie_open('p', null, null,
          'class', 'monospace',
          'style', 'font-size:20px;font-weight:normal;');
        itext('Menlo Normal / MENLO NORMAL');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', '2');
      ie_open('p');
        ie_open('h1');
          itext('h1 Article Heading ');
          ie_open('small');
            itext('Sub text');
          ie_close('small');
        ie_close('h1');
        ie_open('h2');
          itext('h2 Article Heading ');
          ie_open('small');
            itext('Sub text');
          ie_close('small');
        ie_close('h2');
        ie_open('h3');
          itext('h3 Article Heading ');
          ie_open('small');
            itext('Sub text');
          ie_close('small');
        ie_close('h3');
        ie_open('h4');
          itext('h4 Article Heading ');
          ie_open('small');
            itext('Sub text');
          ie_close('small');
        ie_close('h4');
        ie_open('h5');
          itext('h5 Article Heading ');
          ie_open('small');
            itext('Sub text');
          ie_close('small');
        ie_close('h5');
        ie_open('h6');
          itext('h6 Article Heading ');
          ie_open('small');
            itext('Sub text');
          ie_close('small');
        ie_close('h6');
    ...
    ie_open('article', null, null,
        'id', '4');
      ie_open('h3');
        itext('Lead Body Copy');
      ie_close('h3');
      ie_open('p', null, null,
          'class', 'lead');
        itext(' Lead Body Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', '5');
      ie_open('h3');
        itext('Inline Text Elements');
      ie_close('h3');
      ie_open('p');
        ie_open('a', null, null,
            'href', '#1');
          itext('Anchor Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('a');
      ie_close('p');
      ie_open('p');
        ie_open('span');
          itext('Regular Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('span');
      ie_close('p');
      ie_open('p');
        ie_open('mark');
          itext('Marked Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('mark');
      ie_close('p');
      ie_open('p');
        ie_open('del');
          itext('Deleted Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('del');
      ie_close('p');
      ie_open('p');
        ie_open('s');
          itext('Strikethrough Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('s');
      ie_close('p');
      ie_open('p');
        ie_open('ins');
          itext('Inserted Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('ins');
      ie_close('p');
      ie_open('p');
        ie_open('u');
          itext('Underlined Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('u');
      ie_close('p');
      ie_open('p');
        ie_open('small');
          itext('Small Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('small');
      ie_close('p');
      ie_open('p');
        ie_open('strong');
          itext('Bold Text: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('strong');
      ie_close('p');
      ie_open('p');
        ie_open('em');
          itext('Italics: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('em');
      ie_close('p');
      ie_open('p');
        itext('Abbreviation: ');
        ie_open('abbr', null, null,
            'title', 'attribute');
          itext('attr');
        ie_close('abbr');
      ie_close('p');
      ie_open('p');
        itext('LOWERCASED TEXT: ');
        ie_open('span', null, null,
    ...
    ie_open('article', null, null,
        'id', '6');
      ie_open('h3');
        itext('Reference Mark');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Add a reference mark next to some text with ');
          ie_open('code');
            itext('<span class="reference-mark"></span>');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ...
      ie_open('div');
        ...
        ie_void('span', null, null,
            'class', 'glyphicon glyphicon-asterisk reference-mark',
            'id', 'referenceMark2');
        itext(' with glyphicon-asterisk.');
      ie_close('div');
      ie_open('div');
        itext('Reference Mark');
        ie_void('span', null, null,
            'class', 'icon-asterisk reference-mark',
            'id', 'referenceMark3');
        itext(' with icon-asterisk.');
      ie_close('div');
      ie_open('div');
        itext('Reference Mark');
        ie_open('span', null, null,
          ...
          ie_open('svg', null, null,
              'class', 'lexicon-icon');
            ie_void('use', null, null,
                'xlink:href', '/vendor/lexicon/icons.svg#asterisk');
          ie_close('svg');
        ie_close('span');
        itext(' with lexicon-icon-asterisk.');
      ie_close('div');
      ie_open('h4');
        itext('Footnotes');
      ie_close('h4');
      ie_open('div');
        ie_open('a', null, null,
          ...
          itext('[1]');
        ie_close('a');
        itext(' A reference to the text above, respectively.');
      ie_close('div');
      ie_open('div');
        ie_void('a', null, null,
            'class', 'glyphicon glyphicon-asterisk reference-mark',
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Shorten long lines of text with the class ');
          ie_open('code');
            itext('text-truncate');
          ie_close('code');
          itext('.');
      ...
      ie_open('p', null, null,
          'class', 'text-truncate');
        itext('Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish. Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish. Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', '8');
      ie_open('h3');
        itext('Contextual Texts');
      ie_close('h3');
      ie_open('div');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'text-muted');
          itext('text-muted: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('a');
      ie_close('div');
      ie_open('div');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'text-default');
          itext('text-default: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('a');
      ie_close('div');
      ie_open('div');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'text-primary');
          itext('text-primary: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('a');
      ie_close('div');
      ie_open('div');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'text-info');
          itext('text-info: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('a');
      ie_close('div');
      ie_open('div');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'text-success');
          itext('text-success: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('a');
      ie_close('div');
      ie_open('div');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'text-warning');
          itext('text-warning: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('a');
      ie_close('div');
      ie_open('div');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'text-danger');
          itext('text-danger: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('a');
      ie_close('div');
    ie_close('article');
    ie_open('article', null, null,
        'id', '8');
      ie_open('h3');
        itext('Contextual Backgrounds');
      ie_close('h3');
      ie_open('div');
        ie_open('span', null, null,
            'class', 'bg-default');
          itext('bg-default: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('span');
      ie_close('div');
      ie_open('div');
        ie_open('span', null, null,
            'class', 'bg-primary');
          itext('bg-primary: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('span');
      ie_close('div');
      ie_open('div');
        ie_open('span', null, null,
            'class', 'bg-success');
          itext('bg-success: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('span');
      ie_close('div');
      ie_open('div');
        ie_open('span', null, null,
            'class', 'bg-info');
          itext('bg-info: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('span');
      ie_close('div');
      ie_open('div');
        ie_open('span', null, null,
            'class', 'bg-warning');
          itext('bg-warning: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('span');
      ie_close('div');
      ie_open('div');
        ie_open('span', null, null,
            'class', 'bg-danger');
          itext('bg-danger: Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('span');
      ie_close('div');
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('p');
        ie_open('address');
          ...
          ie_open('br');
          ie_close('br');
          itext('1400 Montefino Ave.');
          ie_open('br');
          ie_close('br');
          itext('Diamond Bar, CA 91765');
          ie_open('br');
          ie_close('br');
          ie_open('abbr', null, null,
              'title', 'Phone');
            itext('P:');
          ie_close('abbr');
          itext(' +1-877-LIFERAY (1-877-543-3729)');
        ie_close('address');
      ie_close('p');
      ie_open('p');
        ie_open('address');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('<section>');
        ie_close('code');
        itext(' should be wrapped as inline.');
      ie_close('p');
      ie_open('h3');
        itext('User Input');
      ie_close('h3');
      ie_open('p');
        itext('For example, press ');
        ie_open('kbd');
          ie_open('kbd');
            itext('ctrl');
          ie_close('kbd');
      ...
      ie_open('p');
        ie_open('samp');
          itext('This text is meant to be treated as sample output from a computer program.');
        ie_close('samp');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('p');
        ie_open('small');
          itext('Someone famous in ');
          ie_open('cite', null, null,
              'title', 'Source Title');
            itext('Source Title');
          ie_close('cite');
        ie_close('small');
      ...
      ie_close('blockquote');
      ie_open('h3');
        itext('Blockquote Sizes');
      ie_close('h3');
      ie_open('blockquote', null, null,
          'class', 'blockquote-primary blockquote-xs');
        ie_open('p');
          itext('Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('p');
        ie_open('small');
      ...
      ie_close('blockquote');
      ie_open('blockquote', null, null,
          'class', 'blockquote-primary blockquote-sm');
        ie_open('p');
          itext('Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('p');
        ie_open('small');
      ...
      ie_close('blockquote');
      ie_open('blockquote', null, null,
          'class', 'blockquote-lg blockquote-primary');
        ie_open('p');
          itext('Milk filter lungo as gal\u00E3o roast that crema blue mountain shop turkish.');
        ie_close('p');
        ie_open('small');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1601}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'fGmnk.render';
}
...
class fGmnk extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(fGmnk, templates);
...
var _typographySoy = __webpack_require__(129);

var _typographySoy2 = _interopRequireDefault(_typographySoy);
...
var fGmnk = function (_Component) {
  _inherits(fGmnk, _Component);

  function fGmnk() {
    _classCallCheck(this, fGmnk);

    return _possibleConstructorReturn(this, (fGmnk.__proto__ || Object.getPrototypeOf(fGmnk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fGmnk, _typographySoy2.default);

exports.default = fGmnk;
