var pageComponent =
webpackJsonppageComponent([27,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EzfPp", function() { return EzfPp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace EzfPp.
 * @public
 */

goog.module('EzfPp.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param518 = function() {
    ie_open('article', null, null,
        'id', 'dropdown-action');
      ie_open('h3');
        itext('Dropdown Action');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('A monospaced ');
          ie_open('code');
            itext('dropdown-toggle');
          ie_close('code');
          itext(' for a dropdown containing several actions, add ');
          ie_open('code');
            itext('dropdown-action');
          ie_close('code');
          itext(' to ');
      ...
      ie_open('div', null, null,
        ...
        ie_open('a', null, null,
          ...
          ie_open('svg', null, null,
            ...
            ie_void('use', null, null,
                'xlink:href', '/vendor/lexicon/icons.svg#ellipsis-v');
          ie_close('svg');
        ie_close('a');
        ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
        ie_open('div', null, null,
            'aria-labelledby', '',
            'class', 'dropdown-menu');
          ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('form');
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                  'class', 'input-group input-group-inset input-group-sm');
                ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('a', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_close('svg');
            ie_close('div');
            itext('Ticket Buyer Information');
          ie_close('a');
          ie_open('a', null, null,
              'class', 'dropdown-item',
              'href', '#1');
          ...
          ie_open('a', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_close('svg');
            ie_close('div');
            itext('Seat Assignment');
          ie_close('a');
          ie_open('a', null, null,
              'class', 'active dropdown-item',
              'href', '#1');
            itext('Dinner Preference');
          ie_close('a');
          ie_open('a', null, null,
              'class', 'dropdown-item',
              'href', '#1');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Nest ');
          ie_open('code');
            itext('<div class="inline-scroller"></div>');
          ie_close('code');
          itext(' inside a ');
          ie_open('code');
            itext('.dropdown-menu');
          ie_close('code');
          itext(' list item to create a scrollable dropdown. The maximum height is 200px on screen sizes 768px and above, on screen sizes 767px and below the overflow is handled by ');
          ie_open('code');
            itext('.dropdown-menu');
          ie_close('code');
          itext('.');
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              ...
              'role', 'alert');
            itext('You can customize this menu or see all you have by pressing "more".');
          ie_close('div');
          ie_open('div', null, null,
              'class', 'dropdown-header');
            itext('Folder');
          ...
          ie_open('div', null, null,
              'class', 'dropdown-caption');
            itext('Showing 7 of 203 Structures');
          ie_close('div');
          ie_open('div', null, null,
              'class', 'dropdown-section');
            ie_open('button', null, null,
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'dropdown-wide-full');
      ie_open('h3');
        itext('Dropdown Wide / Full');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use ');
          ...
          ie_open('code');
            itext('.dropdown');
          ie_close('code');
          itext(' to make the dropdown menu big. The default width is 500px. Use ');
          ie_open('code');
            itext('.dropdown-full');
          ie_close('code');
          itext(' to create a dropdown menu as wide as its relative parent. See dropdown examples.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
        ie_open('div', null, null,
            'aria-labelledby', '',
            'class', 'dropdown-wide dropdown-wide-container');
          ie_open('div', null, null,
              'class', 'dropdown-menu');
            ie_open('div', null, null,
                'class', 'row');
              ie_open('div', null, null,
                ...
                ie_open('a', null, null,
                    'class', 'active dropdown-item',
                    'href', '#1');
                  itext('Developing for the Platform');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Mastering Fundamentals');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Styling with Themes');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Managing Content');
                ie_close('a');
              ie_close('div');
              ie_open('div', null, null,
                  'class', 'col-sm-4');
                ...
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Error Messages');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Updates: Service Packs & Fixes');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Install, Upgrade, & Activate');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Regular Drivers');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Hardware Drivers');
                ie_close('a');
                ie_open('div', null, null,
                    'class', 'dropdown-subheader');
                  itext('Security');
                ...
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Security Essentials');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Protecting Your Data');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('Securing Your Browser');
                ie_close('a');
              ie_close('div');
              ie_open('div', null, null,
                  'class', 'col-sm-4');
                ...
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('For Home Users');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('For Small Business');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('For IT Professionals');
                ie_close('a');
                ie_open('a', null, null,
                    'class', 'dropdown-item',
                    'href', '#1');
                  itext('For Developers');
                ie_close('a');
              ie_close('div');
            ie_close('div');
          ie_close('div');
        ...
        ie_open('div', null, null,
          ...
          ie_open('a', null, null,
            ...
            ie_open('svg', null, null,
              ...
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#trash');
            ie_close('svg');
          ie_close('a');
          ie_open('a', null, null,
              'class', 'disabled dropdown-item',
            ...
            ie_open('svg', null, null,
                'aria-hidden', 'true',
                'class', 'lexicon-icon lexicon-icon-download');
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#download');
            ie_close('svg');
          ie_close('a');
          ie_open('a', null, null,
              'class', 'dropdown-item',
            ...
            ie_open('svg', null, null,
              ...
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#info-circle-open');
            ie_close('svg');
          ie_close('a');
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal">\n    <div class="dropdown-subheader">Order by</div>\n    <a class="active dropdown-item" href="#1">\n        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n            <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n        </svg>\n    </a>\n    <a class="disabled dropdown-item" href="#1">\n        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n            <use xlink:href="/vendor/lexicon/icons.svg#download" />\n        </svg>\n    </a>\n    <a class="dropdown-item" href="#1">\n        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n            <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n        </svg>\n    </a>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'dropdown-alignment');
      ie_open('h3');
        itext('Dropdown Alignment');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Align a dropdown menu on the top or bottom side with classes ');
          ie_open('code');
            itext('dropdown-menu');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('dropdown-menu-right');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('dropdown-menu-top');
          ie_close('code');
          itext(', or ');
          ie_open('code');
            itext('dropdown-menu-top-right');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Align a dropdown menu on the left or right side with classes ');
          ie_open('code');
            itext('dropdown-menu-right-side');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('dropdown-menu-left-side');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('dropdown-menu-right-side-bottom');
          ie_close('code');
          itext(', or ');
          ie_open('code');
            itext('dropdown-menu-left-side-bottom');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
        ...
        ie_open('button', null, null,
          ...
          ie_open('svg', null, null,
            ...
            ie_void('use', null, null,
                'xlink:href', '/vendor/lexicon/icons.svg#angle-right');
          ie_close('svg');
        ie_close('button');
        ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('button', null, null,
          ...
          ie_open('svg', null, null,
            ...
            ie_void('use', null, null,
                'xlink:href', '/vendor/lexicon/icons.svg#angle-left');
          ie_close('svg');
          itext('Left Side');
        ie_close('button');
        ie_open('div', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('We\'ve also added the option to center the dropdown to its trigger in the 4 different dropdown-menu positions with classes ');
          ie_open('code');
            itext('dropdown-menu-center');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('dropdown-menu-top-center');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('dropdown-menu-left-side-middle');
          ie_close('code');
          itext(', or ');
          ie_open('code');
            itext('dropdown-menu-right-side-middle');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'dropdowns-in-navbar');
      ie_open('h3');
        itext('Dropdowns in Navbar');
      ie_close('h3');
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'navbar navbar-expand navbar-light',
            'style', 'margin-bottom:566px;');
          ie_open('div', null, null,
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('a', null, null,
                      'class', 'dropdown-item',
                      'href', '#1');
                    itext('Something Outside');
                  ie_close('a');
                ie_close('div');
              ie_close('li');
              ie_open('li', null, null,
                  'class', 'dropdown dropdown-wide nav-item');
                ie_open('a', null, null,
                    'aria-expanded', 'false',
                    'aria-haspopup', 'true',
                    'class', 'dropdown-toggle nav-link',
              ...
              ie_close('li');
              ie_open('li', null, null,
                  'class', 'dropdown dropdown-full nav-item');
                ie_open('a', null, null,
                    'aria-expanded', 'false',
                    'aria-haspopup', 'true',
                    'class', 'dropdown-toggle nav-link',
  ...
  $templateAlias1(soy.$$assignDefaults({content: param518}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'EzfPp.render';
}
...
class EzfPp extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(EzfPp, templates);
...
var _dropdownsSoy = __webpack_require__(100);

var _dropdownsSoy2 = _interopRequireDefault(_dropdownsSoy);
...
var EzfPp = function (_Component) {
  _inherits(EzfPp, _Component);

  function EzfPp() {
    _classCallCheck(this, EzfPp);

    return _possibleConstructorReturn(this, (EzfPp.__proto__ || Object.getPrototypeOf(EzfPp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(EzfPp, _dropdownsSoy2.default);

exports.default = EzfPp;
