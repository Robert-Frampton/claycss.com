var pageComponent =
webpackJsonppageComponent([11,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SzbsX", function() { return SzbsX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace SzbsX.
 * @public
 */

goog.module('SzbsX.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1321 = function() {
    ie_open('article', null, null,
        'id', 'progress-groups');
      ie_open('h3');
        itext('Progress Groups');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Place an addon on either side of a progress component with ');
          ie_open('code');
            itext('progress-group');
          ie_close('code');
          itext(' and ');
          ie_open('code');
            itext('progress-group-addon');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress-group');
        ie_open('div', null, null,
            'class', 'progress');
          ie_void('div', null, null,
              'aria-valuenow', '60',
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('progress-group');
          ie_close('code');
          itext(' stack the addons and progress component.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'progress-group progress-group-stacked');
        ie_open('div', null, null,
            'class', 'progress-group-addon');
          itext('60% Completed');
        ie_close('div');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          itext(', ');
          ie_open('code');
            itext('progress-success');
          ie_close('code');
          itext(', or ');
          ie_open('code');
            itext('progress-warning');
          ie_close('code');
          itext(' to ');
          ie_open('code');
            itext('progress-group');
          ...
          ie_open('code');
            itext('progress');
          ie_close('code');
          itext(' to provide visual feedback for different progress states. Color a block of text or icon by wrapping it with ');
          ie_open('code');
            itext('progress-group-feedback');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
        ...
        itext('Using the variant classes will set the ');
        ie_open('code');
          itext('background-color');
        ie_close('code');
        itext(' on ');
        ie_open('code');
          itext('progress-bar');
        ie_close('code');
        itext(', no need to use Bootstrap 4 background utility classes.');
      ie_close('div');
      ie_open('h6');
        itext('Progress');
      ie_close('h6');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress');
        ie_open('div', null, null,
            'aria-valuenow', '25',
            'aria-valuemin', '0',
            'aria-valuemax', '100',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress progress-success');
        ie_open('div', null, null,
            'aria-valuenow', '25',
            'aria-valuemin', '0',
            'aria-valuemax', '100',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress progress-info');
        ie_open('div', null, null,
            'aria-valuenow', '50',
            'aria-valuemin', '0',
            'aria-valuemax', '100',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress progress-warning');
        ie_open('div', null, null,
            'aria-valuenow', '75',
            'aria-valuemin', '0',
            'aria-valuemax', '100',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress progress-danger');
        ie_open('div', null, null,
            'aria-valuenow', '100',
            'aria-valuemin', '0',
            'aria-valuemax', '100',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress-group progress-success');
        ie_open('div', null, null,
            'class', 'progress');
          ie_void('div', null, null,
              'aria-valuenow', '100',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress-group progress-info');
        ie_open('div', null, null,
            'class', 'progress');
          ie_void('div', null, null,
              'aria-valuenow', '100',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress-group progress-warning');
        ie_open('div', null, null,
            'class', 'progress');
          ie_void('div', null, null,
              'aria-valuenow', '100',
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('svg', null, null,
              ...
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#exclamation-circle');
            ie_close('svg');
          ie_close('div');
        ie_close('div');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress-danger progress-group');
        ie_open('div', null, null,
            'class', 'progress');
          ie_void('div', null, null,
              'aria-valuenow', '100',
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('svg', null, null,
              ...
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#times-circle');
            ie_close('svg');
          ie_close('div');
        ie_close('div');
      ie_close('div');
    ...
    ie_open('article', null, null,
      ...
      ie_open('h3');
        itext('Multiple Progress Bars');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('If you need multiple progress bars, use Bootstrap 4\'s background utilities, ');
          ie_open('code');
            itext('bg-primary');
          ie_close('code');
          itext(', ');
      ...
      ie_open('div', null, null,
          'class', 'clay-site-mb progress');
        ie_open('div', null, null,
            'class', 'bg-info progress-bar progress-bar-striped',
            'style', 'width: 50%');
          itext('50%');
        ie_close('div');
        ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_close('h6');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress progress-lg');
        ie_open('div', null, null,
            'aria-valuenow', '45',
            'aria-valuemin', '0',
            'aria-valuemax', '100',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-mb progress-group progress-lg');
        ie_open('div', null, null,
            'class', 'progress');
          ie_void('div', null, null,
              'aria-valuenow', '60',
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1321}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'SzbsX.render';
}
...
class SzbsX extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(SzbsX, templates);
...
var _progress_barsSoy = __webpack_require__(123);

var _progress_barsSoy2 = _interopRequireDefault(_progress_barsSoy);
...
var SzbsX = function (_Component) {
  _inherits(SzbsX, _Component);

  function SzbsX() {
    _classCallCheck(this, SzbsX);

    return _possibleConstructorReturn(this, (SzbsX.__proto__ || Object.getPrototypeOf(SzbsX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SzbsX, _progress_barsSoy2.default);

exports.default = SzbsX;
