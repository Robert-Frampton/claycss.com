var pageComponent =
webpackJsonppageComponent([6,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gburg", function() { return gburg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from toggle_switch.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace gburg.
 * @public
 */

goog.module('gburg.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1557 = function() {
    ie_open('article', null, null,
        'id', '1');
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('For customizing toggles, see ');
        ie_open('a', null, null,
            'href', '../extending-toggles/');
          itext('extending-toggles');
        ie_close('a');
        itext('.');
      ie_close('div');
      ie_open('h3');
        itext('Toggle Switch with Checkbox');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'form-group');
        ie_open('label', null, null,
    ...
    ie_open('article', null, null,
        'id', '2');
      ie_open('h3');
        itext('Toggle Switch with Radio');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'form-group');
        ie_open('label', null, null,
    ...
    ie_open('article', null, null,
        'id', '3');
      ie_open('h3');
        itext('Toggle Switch with Data Attributes');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use data attributes ');
          ie_open('code');
            itext('data-label-on=""');
          ie_close('code');
          itext(' and ');
          ie_open('code');
            itext('data-label-off=""');
          ie_close('code');
          itext(' on ');
          ie_open('code');
            itext('<span class="toggle-switch-handle"></span>');
          ie_close('code');
          itext(' to display specific text when the switch is on and off.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'form-group');
        ie_open('label', null, null,
          ...
          ie_open('span', null, null,
            ...
            itext('Toggle Switch with data-label-on');
          ie_close('span');
          ie_open('span', null, null,
              'aria-hidden', 'true',
              'class', 'toggle-switch-bar');
      ...
      ie_open('div', null, null,
        ...
        ie_open('label', null, null,
          ...
          ie_open('span', null, null,
              'class', 'toggle-switch-label');
            itext('Toggle Switch with data-label on and data-label-off');
          ie_close('span');
          ie_open('span', null, null,
              'aria-hidden', 'true',
              'class', 'toggle-switch-bar');
            ie_void('span', null, null,
                'class', 'toggle-switch-handle',
                'data-label-off', 'Switch is off.',
                'data-label-on', 'Switch is on.');
          ie_close('span');
        ie_close('label');
      ie_close('div');
    ...
    ie_open('article', null, null,
        'id', '4');
      ie_open('h3');
        itext('Toggle Switch Text');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Add additional text with class ');
          ie_open('code');
            itext('toggle-switch-text');
          ie_close('code');
          itext('.');
    ...
    ie_open('article', null, null,
        'id', '5');
      ie_open('h3');
        itext('Toggle Switches with Icons');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Add an icon to the switch for the on position with ');
          ie_open('code');
            itext('<span class="button-icon button-icon-on icon-volume-up toggle-switch-icon"></span>');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('Add an icon to the switch for the off position with ');
          ie_open('code');
            itext('<span class="button-icon button-icon-off icon-volume-off toggle-switch-icon"></span>');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('Substitute ');
          ie_open('code');
            itext('icon-volume-up');
          ie_close('code');
          itext(' / ');
          ie_open('code');
            itext('icon-volume-down');
          ie_close('code');
          itext(' with any font awesome icon.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'form-group');
        ie_open('label', null, null,
          ...
          ie_open('span', null, null,
            ...
            ie_open('span', null, null,
                ...
                'data-label-on', '');
              ie_open('span', null, null,
                  'class', 'button-icon button-icon-on toggle-switch-icon');
                ie_open('svg', null, null,
                    'class', 'lexicon-icon lexicon-icon-unlock');
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#unlock');
                ie_close('svg');
              ie_close('span');
              ie_open('span', null, null,
                  'class', 'button-icon button-icon-off toggle-switch-icon');
                ie_open('svg', null, null,
                    'class', 'lexicon-icon lexicon-icon-lock');
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#lock');
                ie_close('svg');
              ie_close('span');
            ie_close('span');
          ie_close('span');
            ...
            ie_open('span', null, null,
              ...
              ie_open('span', null, null,
                ...
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#live');
                ie_close('svg');
              ie_close('span');
              ie_open('span', null, null,
                  'class', 'button-icon button-icon-off toggle-switch-icon');
          ...
          ie_open('span', null, null,
            ...
            ie_open('span', null, null,
              ...
              ie_open('span', null, null,
                  'class', 'button-icon button-icon-on toggle-switch-icon');
                ie_open('svg', null, null,
                    'class', 'lexicon-icon lexicon-icon-product-menu-open');
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#product-menu-open');
                ie_close('svg');
              ie_close('span');
              ie_open('span', null, null,
                  'class', 'button-icon button-icon-off toggle-switch-icon');
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#product-menu-closed');
                ie_close('svg');
              ie_close('span');
            ie_close('span');
          ie_close('span');
    ...
    ie_open('article', null, null,
        'id', '6');
      ie_open('h3');
        itext('Toggle Switches with Icons (Alternate)');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Add an icon to the switch for the on position with ');
          ie_open('code');
            itext('<span class="icon-ok toggle-switch-icon toggle-switch-icon-on"></span>');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('Add an icon to the switch for the off position with ');
          ie_open('code');
            itext('<span class="icon-remove toggle-switch-icon toggle-switch-icon-off"></span>');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
        ...
        ie_open('label', null, null,
          ...
          ie_open('span', null, null,
            ...
            ie_open('span', null, null,
                'class', 'toggle-switch-handle');
              ie_open('span', null, null,
                  'class', 'toggle-switch-icon toggle-switch-icon-on');
                ie_open('svg', null, null,
              ...
              ie_close('span');
              ie_open('span', null, null,
                  'class', 'toggle-switch-icon toggle-switch-icon-off');
                ie_open('svg', null, null,
    ...
    ie_open('article', null, null,
        'id', '7');
      ie_open('h3');
        itext('Disabled Toggle Switches');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Disable a toggle-switch by adding the attribute ');
          ie_open('code');
            itext('disabled="disabled"');
          ie_close('code');
          itext(' to ');
          ie_open('code');
            itext('<input type="checkbox">');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1557}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'gburg.render';
}
...
class gburg extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(gburg, templates);
...
var _toggle_switchSoy = __webpack_require__(128);

var _toggle_switchSoy2 = _interopRequireDefault(_toggle_switchSoy);
...
var gburg = function (_Component) {
  _inherits(gburg, _Component);

  function gburg() {
    _classCallCheck(this, gburg);

    return _possibleConstructorReturn(this, (gburg.__proto__ || Object.getPrototypeOf(gburg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gburg, _toggle_switchSoy2.default);

exports.default = gburg;
