var pageComponent =
webpackJsonppageComponent([26,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "urZqE", function() { return urZqE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from form_custom.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace urZqE.
 * @public
 */

goog.module('urZqE.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param562 = function() {
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Nest ');
          ie_open('code');
            itext('<input class="form-file-input" type="file">');
          ie_close('code');
          itext(' inside ');
          ie_open('code');
            itext('form-file');
          ie_close('code');
          itext(' to create a variety of custom file inputs. The element with the ');
          ie_open('code');
            itext('form-file');
          ie_close('code');
          itext(' class should wrap whatever element you want to trigger the operating system\'s file browser.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('Form File needs custom javascript to change the input value to the file selected.');
      ie_close('div');
      ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('input', null, null,
                    ...
                    'data-clay-site-content', '#customFileText1',
                    'data-clay-site-toggle', 'file',
                    'id', 'customFile1',
                    'type', 'file');
                ie_close('input');
                ie_open('button', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('span', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('input', null, null,
                    'class', 'form-file-input',
                    'data-clay-site-content', '#customFileText2',
                    'data-clay-site-toggle', 'file',
                    'id', 'customFile2',
                    'type', 'file');
                ie_close('input');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('input', null, null,
                'class', 'form-file-input',
                'data-clay-site-content', '#customFileText3',
                'data-clay-site-toggle', 'file',
                'id', 'customFile3',
                'type', 'file');
            ie_close('input');
            ie_open('div', null, null,
              ...
              ie_open('span', null, null,
                  ...
                  'id', 'inputGroupAddon02');
                itext('Browse');
              ie_close('span');
              ie_open('input', null, null,
                  'aria-describedby', 'inputGroupAddon02',
                  'class', 'form-control',
                  'id', 'customFileText3',
                  'placeholder', 'Choose file...',
                  'tabindex', '-1',
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('input', null, null,
                  'class', 'form-file-input',
                  'data-clay-site-content', '#customFileText4',
                  'data-clay-site-toggle', 'file',
                  'id', 'customFile4',
                  'type', 'file');
              ie_close('input');
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('label');
            ...
            ie_open('span', null, null,
                'class', 'custom-control-description');
              itext('Toggle this custom radio');
            ie_close('span');
          ie_close('label');
        ie_close('div');
        ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('It\'s recommended to use ');
        ie_open('code');
          itext('select.form-control');
        ie_close('code');
        itext(' instead. This is only here for documentation purposes.');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('code');
          itext('.form-file');
        ie_close('code');
        itext(' instead. This is here only for documentation purposes. To get ');
        ie_open('code');
          itext('custom-file-control');
        ie_close('code');
        itext(' styles to display, you\'ll need to add ');
        ie_open('code');
          itext('lang="en"');
        ie_close('code');
        itext(' to the html element or set the Content-Language HTTP header.');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('label', null, null,
        ...
        ie_close('label');
      ie_close('div');
      $templateAlias2({code: '<label class="custom-file">\n    <input class="custom-file-input" type="file">\n    <span class="custom-file-control"></span>\n</label>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('script');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'urZqE.render';
}
...
class urZqE extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(urZqE, templates);
...
var _form_customSoy = __webpack_require__(101);

var _form_customSoy2 = _interopRequireDefault(_form_customSoy);
...
var urZqE = function (_Component) {
  _inherits(urZqE, _Component);

  function urZqE() {
    _classCallCheck(this, urZqE);

    return _possibleConstructorReturn(this, (urZqE.__proto__ || Object.getPrototypeOf(urZqE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(urZqE, _form_customSoy2.default);

exports.default = urZqE;
