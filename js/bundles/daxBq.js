var pageComponent =
webpackJsonppageComponent([32,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "daxBq", function() { return daxBq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from badges_and_labels.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace daxBq.
 * @public
 */

goog.module('daxBq.incrementaldom');
  ...
  var param213 = function() {
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('badge-lg');
          ie_close('code');
          itext(' to change the badge size.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
        ...
        ie_close('span');
      ie_close('p');
      $templateAlias2({code: '<span class="badge badge-primary badge-sm">Small Badge</span>\n<span class="badge badge-secondary">Normal Badge</span>\n<span class="badge badge-lg badge-success">Large Badge</span>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'badges-with-links');
      ie_open('h3');
        itext('Badges with Links');
      ie_close('h3');
      ie_open('p');
        ie_open('span', null, null,
            'class', 'badge badge-primary badge-sm');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_close('span');
      ie_close('p');
      $templateAlias2({code: '<span class="label label-primary">Primary</span>\n<span class="label label-secondary">Secondary</span>\n<span class="label label-success">Success</span>\n<span class="label label-info">Info</span>\n<span class="label label-warning">Warning</span>\n<span class="label label-danger">Danger</span>\n<span class="label label-light">Light</span>\n<span class="label label-dark">Dark</span>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'label-as-an-anchor-tag');
      ie_open('h3');
        itext('Labels as an Anchor Tag');
      ie_close('h3');
      ie_open('p');
        ie_open('a', null, null,
            'class', 'label label-primary',
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('label-lg');
          ie_close('code');
          itext(' to change the label size.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'label label-lg label-success');
          itext('Large Label');
        ie_close('span');
      ie_close('p');
      $templateAlias2({code: '<span class="label label-primary label-sm">Small Label</span>\n<span class="label label-secondary">Normal Label</span>\n<span class="label label-lg label-success">Large Label</span>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'label-with-links');
      ie_open('h3');
        itext('Label with Links');
      ie_close('h3');
      ie_open('p');
        ie_open('span', null, null,
            'class', 'label label-primary label-sm');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Stickers are monospaced badges/labels.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-success');
          itext('133');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-info');
          itext('133');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-warning');
          itext('133');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-danger');
          itext('133');
        ie_close('span');
        ie_open('span', null, null,
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-dark');
          itext('133');
        ie_close('span');
      ie_close('p');
      $templateAlias2({code: '<span class="sticker sticker-primary">133</span>\n<span class="sticker sticker-secondary">133</span>\n<span class="sticker sticker-success">133</span>\n<span class="sticker sticker-info">133</span>\n<span class="sticker sticker-warning">133</span>\n<span class="sticker sticker-danger">133</span>\n<span class="sticker sticker-light">133</span>\n<span class="sticker sticker-dark">133</span>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'positional-stickers');
      ie_open('h3');
        itext('Positional Stickers');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Place them anywhere relative to your container using positional sticker classes ');
          ie_open('code');
            itext('sticker-top-left');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('sticker-bottom-left');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('sticker-top-right');
          ie_close('code');
          itext(', and ');
          ie_open('code');
            itext('sticker-bottom-right');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_close('img');
            ie_open('span', null, null,
                'class', 'sticker sticker-danger sticker-top-left');
              itext('PDF');
            ie_close('span');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_close('img');
            ie_open('span', null, null,
                'class', 'sticker sticker-bottom-left sticker-danger');
              itext('PDF');
            ie_close('span');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_close('img');
            ie_open('span', null, null,
                'class', 'sticker sticker-danger sticker-top-right');
              itext('PDF');
            ie_close('span');
          ie_close('div');
        ie_close('div');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Stickers come in 3 different sizes, small, regular and large. Create your own custom size by changing the ');
          ie_open('code');
            itext('width');
          ie_close('code');
          itext(', ');
          ...
          ie_open('code');
            itext('font-size');
          ie_close('code');
          itext('. You can also use the sass monospace mixin to change the width and height e.g. ');
          ie_open('code');
            itext('@include monospace(30px);');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
            'class', 'sticker sticker-primary sticker-sm');
          itext('133');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-secondary');
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-lg sticker-success');
          itext('133');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-xl sticker-info');
          itext('133');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-xxl sticker-warning');
          itext('133');
        ie_close('span');
      ie_close('p');
      $templateAlias2({code: '<span class="sticker sticker-primary sticker-sm">133</span>\n<span class="sticker sticker-secondary">133</span>\n<span class="sticker sticker-lg sticker-success">133</span>\n<span class="sticker sticker-xl sticker-info">133</span>\n<span class="sticker sticker-xxl sticker-warning">133</span>', mode: 'xml'}, null, opt_ijData);
      ie_open('p');
        ie_open('span', null, null,
            'class', 'sticker sticker-xxl sticker-warning');
          ie_open('svg', null, null,
              'aria-hidden', 'true',
              'class', 'lexicon-icon lexicon-icon-magic');
            ie_void('use', null, null,
                'xlink:href', '/vendor/lexicon/icons.svg#magic');
          ie_close('svg');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-xl sticker-info');
          ie_open('svg', null, null,
            ...
            ie_void('use', null, null,
                'xlink:href', '/vendor/lexicon/icons.svg#picture');
          ie_close('svg');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-lg sticker-success');
          ie_open('svg', null, null,
              'aria-hidden', 'true',
              'class', 'lexicon-icon lexicon-icon-home');
            ie_void('use', null, null,
        ...
        ie_open('span', null, null,
          ...
          ie_open('svg', null, null,
            ...
            ie_void('use', null, null,
                'xlink:href', '/vendor/lexicon/icons.svg#format');
          ie_close('svg');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-primary sticker-sm');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-primary sticker-lg');
          ie_open('img', null, null,
              'alt', 'thumbnail',
              'class', 'img-fluid',
              'src', '/images/thumbnail_hot_air_ballon.jpg');
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-primary sticker-xl');
          ie_open('img', null, null,
              'alt', 'thumbnail',
              'class', 'img-fluid',
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'sticker sticker-primary sticker-xxl');
          ie_open('img', null, null,
              'alt', 'thumbnail',
              'class', 'img-fluid',
              'src', '../../images/thumbnail_typewriter.jpg');
          ie_close('img');
          ie_open('span', null, null,
              'class', 'sticker-overlay');
            ie_open('svg', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('sticker-outside');
          ie_close('code');
          itext(' in conjunction with sticker positions to position the sticker on the outside corners.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
          ...
          ie_open('button', null, null,
            ...
            itext('Email');
            ie_open('span', null, null,
                'class', 'rounded-circle sticker sticker-danger sticker-outside sticker-top-left');
              itext('133');
            ie_close('span');
          ie_close('button');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('button', null, null,
            ...
            itext('Email');
            ie_open('span', null, null,
                'class', 'rounded-circle sticker sticker-bottom-left sticker-danger sticker-outside');
              itext('133');
            ie_close('span');
          ie_close('button');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('button', null, null,
            ...
            itext('Email');
            ie_open('span', null, null,
                'class', 'rounded-circle sticker sticker-danger sticker-outside sticker-top-right');
              itext('133');
            ie_close('span');
          ie_close('button');
        ie_close('div');
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('span', null, null,
            ...
            ie_close('svg');
            ie_open('span', null, null,
                'class', 'sticker sticker-info sticker-sm rounded-circle sticker-outside sticker-top-left');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-sun');
                ie_void('use', null, null,
                    'xlink:href', '/vendor/lexicon/icons.svg#sun');
              ie_close('svg');
            ie_close('span');
          ie_close('span');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('span', null, null,
            ...
            ie_close('svg');
            ie_open('span', null, null,
                'class', 'sticker sticker-info sticker-sm rounded-circle sticker-outside sticker-bottom-left');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-magic');
                ie_void('use', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('span', null, null,
            ...
            ie_close('svg');
            ie_open('span', null, null,
                'class', 'sticker sticker-info sticker-sm rounded-circle sticker-outside sticker-top-right');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-transform');
                ie_void('use', null, null,
                    'xlink:href', '/vendor/lexicon/icons.svg#transform');
              ie_close('svg');
            ie_close('span');
          ie_close('span');
        ie_close('div');
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'rounded-circle sticker sticker-primary');
          ie_open('img', null, null,
              'alt', 'thumbnail',
              'class', 'img-fluid',
              'src', '/images/thumbnail_coyote.jpg');
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'rounded-circle sticker sticker-primary sticker-lg');
          ie_open('img', null, null,
              'alt', 'thumbnail',
              'class', 'img-fluid',
              'src', '/images/thumbnail_hot_air_ballon.jpg');
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'rounded-circle sticker sticker-primary sticker-xl');
          ie_open('img', null, null,
              'alt', 'thumbnail',
              'class', 'img-fluid',
              'src', '/images/thumbnail_coffee.jpg');
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'rounded-circle sticker sticker-secondary sticker-xxl');
          ie_open('img', null, null,
              'alt', 'thumbnail',
              'class', 'img-fluid',
              'src', '../../images/thumbnail_typewriter.jpg');
      ...
      ie_open('p');
        ...
        ie_close('span');
        ie_open('span', null, null,
            'class', 'rounded-circle sticker sticker-success sticker-xxl');
          itext('TT');
        ie_close('span');
      ie_close('p');
      $templateAlias2({code: '<span class="rounded-circle sticker sticker-secondary sticker-sm">JB</span>\n<span class="rounded-circle sticker sticker-danger">TT</span>\n<span class="rounded-circle sticker sticker-info sticker-lg">SP</span>\n<span class="rounded-circle sticker sticker-primary sticker-xl">WW</span>\n<span class="rounded-circle sticker sticker-success sticker-xxl">TT</span>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'daxBq.render';
}
...
class daxBq extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(daxBq, templates);
...
var _badges_and_labelsSoy = __webpack_require__(95);

var _badges_and_labelsSoy2 = _interopRequireDefault(_badges_and_labelsSoy);
...
var daxBq = function (_Component) {
  _inherits(daxBq, _Component);

  function daxBq() {
    _classCallCheck(this, daxBq);

    return _possibleConstructorReturn(this, (daxBq.__proto__ || Object.getPrototypeOf(daxBq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(daxBq, _badges_and_labelsSoy2.default);

exports.default = daxBq;
