var pageComponent =
webpackJsonppageComponent([24,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tXpLF", function() { return tXpLF; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from loaders.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace tXpLF.
 * @public
 */

goog.module('tXpLF.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param964 = function() {
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('blockquote', null, null,
          ...
          ie_open('p');
            itext('CSS only loading indicators');
          ie_close('p');
        ie_close('blockquote');
      ie_close('div');
    ie_close('div');
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
          'class', 'col-md-3');
        ie_void('div', null, null,
            'class', 'loading-icon loading-icon-sm');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'col-md-3');
        ie_void('div', null, null,
      ...
      ie_open('div', null, null,
          'class', 'col-md-3');
        ie_void('div', null, null,
            'class', 'loading-icon loading-icon-md');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'col-md-3');
        ie_void('div', null, null,
            'class', 'loading-icon loading-icon-lg');
      ie_close('div');
    ie_close('div');
    ie_open('div', null, null,
        'class', 'row row-spacing');
      ie_open('div', null, null,
          'class', 'col-md-12');
        ie_open('h3');
          itext('Linear Spinner');
        ie_close('h3');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'col-md-3');
        ie_void('div', null, null,
            'class', 'loading-icon linear loading-icon-sm');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'col-md-3');
        ie_void('div', null, null,
            'class', 'loading-icon linear');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'col-md-3');
        ie_void('div', null, null,
            'class', 'loading-icon linear loading-icon-md');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'col-md-3');
        ie_void('div', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param964}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'tXpLF.render';
}
...
class tXpLF extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(tXpLF, templates);
...
var _loadersSoy = __webpack_require__(110);

var _loadersSoy2 = _interopRequireDefault(_loadersSoy);
...
var tXpLF = function (_Component) {
  _inherits(tXpLF, _Component);

  function tXpLF() {
    _classCallCheck(this, tXpLF);

    return _possibleConstructorReturn(this, (tXpLF.__proto__ || Object.getPrototypeOf(tXpLF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tXpLF, _loadersSoy2.default);

exports.default = tXpLF;
