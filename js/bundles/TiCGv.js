var pageComponent =
webpackJsonppageComponent([28,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TiCGv", function() { return TiCGv; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace TiCGv.
 * @public
 */

goog.module('TiCGv.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param454 = function() {
    ie_open('article', null, null,
        'id', 'card-type-asset');
      ie_open('h3');
        itext('Card Type Asset');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
            'class', 'col-md-4');
          ie_open('div', null, null,
              'class', 'form-check form-check-card form-check-top-left');
            ie_open('div', null, null,
              ...
              ie_open('label');
                ...
                ie_open('div', null, null,
                    'class', 'card card-type-asset');
                  ie_open('div', null, null,
                      'class', 'aspect-ratio bg-checkered card-item-first');
                    ie_open('img', null, null,
                        'alt', 'thumbnail',
                    ...
                    ie_open('div', null, null,
                      ...
                      ie_open('div', null, null,
                        ...
                        ie_open('div', null, null,
                          ...
                          itext('Aldcott Gage George Polwarth-Kitchener');
                        ie_close('div');
                        ie_open('div', null, null,
                            'class', 'card-subtitle text-truncate',
                            'title', 'thumbnail_dock.jpg');
                          itext('thumbnail_dock.jpg');
                        ie_close('div');
                        ie_open('div');
                          ie_open('span', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('span', null, null,
                  ...
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#camera');
                  ie_close('svg');
                ie_close('span');
              ie_close('div');
              ie_open('span', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'card card-type-asset');
            ie_open('div', null, null,
                'class', 'aspect-ratio card-item-first');
              ie_open('div', null, null,
                  'class', 'aspect-ratio-item-center-middle aspect-ratio-item-fluid');
                ie_open('span', null, null,
                    'class', 'sticker');
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#web-content');
                  ie_close('svg');
                ie_close('span');
              ie_close('div');
              ie_open('span', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('div', null, null,
                    ...
                    itext('deliverable.doc');
                  ie_close('div');
                  ie_open('div', null, null,
                      'class', 'card-subtitle text-truncate',
                      'title', 'Stevie Ray Vaughn');
                    itext('Stevie Ray Vaughn');
                  ie_close('div');
                  ie_open('div');
                    ie_open('span', null, null,
                        'class', 'label label-success');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'card-type-directory');
      ie_open('h3');
        itext('Card Type Directory');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_close('div');
                ie_open('div', null, null,
                    'class', 'flex-col flex-col-expand flex-col-gutters');
                  ie_open('div', null, null,
                      'class', 'card-title text-truncate',
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'horizontal-card-with-flex-col-*');
      ie_open('h3');
        itext('Horizontal Card with flex-col-*');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use ');
          ...
          itext(' with ');
          ie_open('code');
            itext('flex-col-expand');
          ie_close('code');
          itext(' and ');
          ie_open('code');
            itext('flex-col');
          ie_close('code');
          itext(' to create a number of custom horizontal cards. ');
          ie_open('code');
            itext('flex-col-expand');
          ie_close('code');
          itext(' fills the remaining space and ');
          ie_open('code');
            itext('flex-col');
          ie_close('code');
          itext(' is only as wide as its content inside.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_close('div');
                ie_open('div', null, null,
                    'class', 'flex-col flex-col-gutters',
                    'style', 'background-color:antiquewhite;');
                  ie_open('span');
                    itext('Only as wide as this text.');
                  ie_close('span');
                ie_close('div');
              ie_close('div');
            ie_close('div');
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('div', null, null,
                    ...
                    'style', 'background-color:antiquewhite;');
                  ie_open('span');
                    itext('This will split the space in half.');
                  ie_close('span');
                ie_close('div');
              ie_close('div');
            ie_close('div');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'card-row-content-alignment-helpers');
      ie_open('h3');
        itext('Card Row Content Alignment Helpers');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Vertically align content by setting ');
          ie_open('code');
            itext('justify-content');
          ie_close('code');
          itext(' to ');
          ie_open('code');
            itext('flex-start');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Horizontally align content by setting ');
          ie_open('code');
            itext('text-align');
          ie_close('code');
          itext(' to ');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('You can also use the Bootstrap 4\'s helper classes ');
          ie_open('code');
            itext('justify-content-start');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('justify-content-center');
          ie_close('code');
          itext(', or ');
          ie_open('code');
            itext('justify-content-end');
          ie_close('code');
          itext(' on ');
          ie_open('code');
            itext('card-row');
          ie_close('code');
          itext(' to align content in all columns inside the row.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-horizontal-card row');
        ie_open('div', null, null,
            'class', 'col-md-6');
          ie_open('div', null, null,
              'class', 'card card-horizontal');
            ie_open('div', null, null,
                'class', 'card-row');
              ie_open('div', null, null,
                  'class', 'justify-content-start flex-col flex-col-expand');
                itext('top');
              ie_close('div');
              ie_open('div', null, null,
                  'class', 'flex-col flex-col-expand');
              ...
              ie_close('div');
              ie_open('div', null, null,
                  'class', 'justify-content-end flex-col flex-col-expand');
                itext('bottom');
              ie_close('div');
            ie_close('div');
          ie_close('div');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'card-row');
              ie_open('div', null, null,
                  'class', 'flex-col flex-col-expand text-left');
                itext('left');
              ie_close('div');
              ie_open('div', null, null,
                  'class', 'flex-col flex-col-expand');
              ...
              ie_close('div');
              ie_open('div', null, null,
                  'class', 'flex-col flex-col-expand text-right');
                itext('right');
              ie_close('div');
            ie_close('div');
          ie_close('div');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Add gutters to a specific card card column by using the class ');
          ie_open('code');
            itext('flex-col-gutters');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('h4', null, null,
                    'class', 'card-title');
                  itext('So ristretto cappuccino');
                ie_close('h4');
                ie_open('p', null, null,
                    'class', 'card-text');
                  itext('Wings eu, pumpkin spice robusta.');
                ie_close('p');
              ie_close('div');
            ie_close('div');
          ie_close('div');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'card-helper-classes');
      ie_open('h3');
        itext('Card Helper Classes');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use classes ');
          ...
          itext(', ');
          ie_open('code');
            itext('rounded-circle');
          ie_close('code');
          itext(', or ');
          ie_open('code');
            itext('rounded-0');
          ie_close('code');
          itext(' on the card to quickly shape the borders.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-horizontal-card row');
        ie_open('div', null, null,
            'class', 'col-md-4');
          ie_open('div', null, null,
              'class', 'card card-horizontal rounded');
            ie_open('div', null, null,
                'class', 'card-row');
              ie_open('div', null, null,
                  'class', 'flex-col flex-col-expand');
        ...
        ie_open('div', null, null,
            'class', 'col-md-4');
          ie_open('div', null, null,
              'class', 'card card-horizontal rounded-circle');
            ie_open('div', null, null,
                'class', 'card-row');
              ie_open('div', null, null,
                  'class', 'flex-col flex-col-expand',
        ...
        ie_open('div', null, null,
            'class', 'col-md-4');
          ie_open('div', null, null,
              'class', 'card card-horizontal rounded-0');
            ie_open('div', null, null,
                'class', 'card-row');
              ie_open('div', null, null,
                  'class', 'flex-col flex-col-expand');
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div class="card card-horizontal rounded">\n    <div class="card-row">\n        <div class="flex-col flex-col-expand">flex-col-expand</div>\n        <div class="flex-col flex-col-expand">flex-col-expand</div>\n    </div>\n</div>\n<div class="card card-horizontal rounded-circle">\n    <div class="card-row">\n        <div class="flex-col flex-col-expand" style="overflow:hidden;">\n            <img alt="thumbnail" class="card-item-first" src="/images/thumbnail_placeholder.gif">\n        </div>\n        <div class="flex-col flex-col-expand">flex-col-expand</div>\n    </div>\n</div>\n<div class="card card-horizontal rounded-0">\n    <div class="card-row">\n        <div class="flex-col flex-col-expand">flex-col-expand</div>\n        <div class="flex-col flex-col-expand">flex-col-expand</div>\n    </div>\n</div>', mode: 'xml'}, null, opt_ijData);
      ie_open('blockquote');
        ie_open('p');
          itext('Use classes ');
          ie_open('code');
            itext('card-item-first');
          ie_close('code');
          itext(' and ');
          ie_open('code');
            itext('card-item-last');
          ie_close('code');
          itext(' on elements that appear at the beginning or ending of your card. It styles the border-radius to match the card\'s border-radius. These classes work similar to Bootstrap 4\'s ');
          ie_open('code');
            itext('.card-img-top');
          ie_close('code');
          itext(' and ');
          ie_open('code');
            itext('.card-img-bottom');
          ie_close('code');
          itext(' but also covers left and right.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('p', null, null,
                  'class', 'card-text');
                itext('Wings eu, pumpkin spice robusta, kopi-luwak mocha caffeine froth grounds.');
              ie_close('p');
            ie_close('div');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'card card-horizontal card-rounded');
            ie_open('div', null, null,
                'class', 'card-row');
              ie_open('div', null, null,
                  'class', 'flex-col flex-col-expand flex-col-gutters');
                ...
                ie_open('p', null, null,
                    'class', 'card-text');
                  itext('Because you live life on the edge of space.');
                ie_close('p');
              ie_close('div');
              ie_open('div', null, null,
                  'class', 'flex-col');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Use ');
          ie_open('code');
            itext('<div class="card-divider"></div>');
          ie_close('code');
          itext(' to create a horizontal division between content inside a card.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-horizontal-card row');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clickable-checkbox-card');
      ie_open('h3');
        itext('Clickable Checkbox Card');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('label', null, null,
              ...
              ie_open('div', null, null,
                  'class', 'card card-type-asset');
                ie_open('div', null, null,
                    'class', 'aspect-ratio aspect-ratio-16-to-9 bg-checkered card-item-first');
                  ie_open('img', null, null,
                      'alt', 'thumbnail',
                      'class', 'aspect-ratio-item-center-middle aspect-ratio-item-fluid',
                      'src', '/images/thumbnail_coffee.jpg');
                  ie_close('img');
                  ie_open('span', null, null,
                      'class', 'sticker sticker-bottom-left sticker-warning');
                    itext('PNG');
                  ie_close('span');
                ie_close('div');
                ie_open('div', null, null,
        ...
        ie_open('div', null, null,
            'class', 'col-8');
          ie_open('div', null, null,
              'class', 'form-check form-check-card form-check-middle-left');
            ie_open('label', null, null,
                'class', 'form-check-label');
              ie_open('input', null, null,
                  'class', 'form-check-input',
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('label');
                ie_open('input', null, null,
                    'class', 'custom-control-input',
                    'name', 'cardCustomRadios',
                    'type', 'radio',
                    'value', 'cardCustomRadioOption1');
                ie_close('input');
                ie_void('span', null, null,
                    'class', 'custom-control-indicator');
                ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        itext('Requires javascript to add and remove the ');
        ie_open('code');
          itext('active');
        ie_close('code');
        itext(' class when the input is checked/unchecked.');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
            'class', 'col-4');
          ie_open('div', null, null,
              'class', 'active form-check form-check-card form-check-top-left');
            ie_open('label', null, null,
                'class', 'form-check-label');
              ie_open('input', null, null,
                  'checked', '',
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div class="active form-check form-check-card form-check-top-left">\n    <label class="form-check-label">\n        <input checked class="form-check-input" type="checkbox">\n    </label>\n    <div class="card card-type-asset">\n        <div class="aspect-ratio aspect-ratio-16-to-9 bg-checkered card-item-first">\n            <img alt="thumbnail" class="aspect-ratio-item-center-middle aspect-ratio-item-fluid" src="/images/thumbnail_coffee.jpg">\n            <span class="sticker sticker-bottom-left sticker-warning">PNG</span>\n        </div>\n        <div class="card-body">\n            <div class="card-row">\n                <div class="flex-col flex-col-expand">\n                    <div class="card-title text-truncate">Aldcott Gage George Polwarth-Kitchener</div>\n                    <div class="card-subtitle text-truncate" title="thumbnail_dock.jpg">thumbnail_dock.jpg</div>\n                    <div>\n                        <span class="label label-success">Approved</span>\n                    </div>\n                </div>\n                <div class="flex-col">\n                    <div class="dropdown dropdown-action">\n                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" role="button">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                                <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                            </svg>\n                        </a>\n                        <div class="dropdown-menu dropdown-menu-right">\n                            <a class="dropdown-item" href="#1">Download</a>\n                            <a class="dropdown-item" href="#1">Edit</a>\n                            <a class="dropdown-item" href="#1">Move</a>\n                            <a class="dropdown-item" href="#1">Checkout</a>\n                            <a class="dropdown-item" href="#1">Permissions</a>\n                            <a class="dropdown-item" href="#1">Move to Recycle Bin</a>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'radio-card');
      ie_open('h3');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param454}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'TiCGv.render';
}
...
class TiCGv extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(TiCGv, templates);
...
var _cardsSoy = __webpack_require__(99);

var _cardsSoy2 = _interopRequireDefault(_cardsSoy);
...
var TiCGv = function (_Component) {
  _inherits(TiCGv, _Component);

  function TiCGv() {
    _classCallCheck(this, TiCGv);

    return _possibleConstructorReturn(this, (TiCGv.__proto__ || Object.getPrototypeOf(TiCGv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(TiCGv, _cardsSoy2.default);

exports.default = TiCGv;
