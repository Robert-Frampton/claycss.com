var pageComponent =
webpackJsonppageComponent([19,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swnHN", function() { return swnHN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from nav_pills.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace swnHN.
 * @public
 */

goog.module('swnHN.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('.nav');
          ie_close('code');
          itext(' to add background colors and border styles.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'nav nav-pills');
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('.nav-justified');
          ie_close('code');
          itext(' to make nav-pills equal width relative to its parent container.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'nav nav-justified nav-pills');
        ie_open('li', null, null,
            'class', 'nav-item');
          ie_open('a', null, null,
              'class', 'active nav-link',
        ...
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: '<ul class="nav nav-justified nav-pills">\n    <li class="nav-item"><a class="active nav-link" href="#1">Fields</a></li>\n    <li class="nav-item"><a class="nav-link" href="#1">Settings</a></li>\n    <li class="nav-item"><a class="disabled nav-link" href="#1">Documents</a></li>\n    <li class="dropdown nav-item">\n        <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle nav-link" data-toggle="dropdown" href="#1">\n            Configuration\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-caret-bottom">\n                <use xlink:href="/vendor/lexicon/icons.svg#caret-bottom" />\n            </svg>\n        </a>\n        <div class="dropdown-menu">\n            <a class="dropdown-item" href="#1">Setup</a>\n            <a class="dropdown-item" href="#1">Supported Clients</a>\n            <a class="dropdown-item" href="#1">Permissions</a>\n            <a class="dropdown-item" href="#1">Sharing</a>\n            <div class="dropdown-divider" role="separator"></div>\n            <a class="dropdown-item" href="#1">Scope</a>\n        </div>\n    </li>\n</ul>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'vertical-nav-pills');
      ie_open('h3');
        itext('Vertical Nav Pills');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<ul class="flex-column nav nav-pills">\n    <li class="nav-item"><a class="active nav-link" href="#1">Fields</a></li>\n    <li class="nav-item">\n        <a class="nav-link" href="#1">\n            Fields with Badge\n            <span class="badge badge-warning">2</span>\n        </a>\n    </li>\n    <li class="nav-item"><a class="nav-link" href="#1">Settings</a></li>\n    <li class="dropdown nav-item">\n        <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle nav-link" data-toggle="dropdown" href="#1">\n            Configuration\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-caret-bottom">\n                <use xlink:href="/vendor/lexicon/icons.svg#caret-bottom" />\n            </svg>\n        </a>\n        <div class="dropdown-menu">\n            <a class="dropdown-item" href="#1">Setup</a>\n            <a class="dropdown-item" href="#1">Supported Clients</a>\n            <a class="dropdown-item" href="#1">Permissions</a>\n            <a class="dropdown-item" href="#1">Sharing</a>\n            <div class="dropdown-divider" role="separator"></div>\n            <a class="dropdown-item" href="#1">Scope</a>\n        </div>\n    </li>\n</ul>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'vertical-nested-nav-pills');
      ie_open('h3');
        itext('Vertical Nested Nav Pills');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
            'class', 'col-md-4');
          ie_open('ul', null, null,
              'class', 'flex-column nav nav-nested nav-pills');
            ie_open('li', null, null,
                'class', 'nav-item');
              ie_open('a', null, null,
                  'aria-expanded', 'true',
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1114}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'swnHN.render';
}
...
class swnHN extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(swnHN, templates);
...
var _nav_pillsSoy = __webpack_require__(115);

var _nav_pillsSoy2 = _interopRequireDefault(_nav_pillsSoy);
...
var swnHN = function (_Component) {
  _inherits(swnHN, _Component);

  function swnHN() {
    _classCallCheck(this, swnHN);

    return _possibleConstructorReturn(this, (swnHN.__proto__ || Object.getPrototypeOf(swnHN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(swnHN, _nav_pillsSoy2.default);

exports.default = swnHN;
