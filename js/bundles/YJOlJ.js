var pageComponent =
webpackJsonppageComponent([2,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "YJOlJ", function() { return YJOlJ; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace YJOlJ.
 * @public
 */

goog.module('YJOlJ.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1441 = function() {
    ie_open('p');
      ie_open('time');
        itext('September 30th, 2017');
      ie_close('time');
    ie_close('p');
    ie_open('h2');
      itext('Clay site release');
    ie_close('h2');
    ie_open('p');
      itext('Clay launches its documentation site to provide developer envolved in the CSS system process. This guideline is created to let you understand the boundaries of this pattern library a help using the interactions patterns created by Liferay.');
    ie_close('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1441}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'YJOlJ.render';
}
...
class YJOlJ extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(YJOlJ, templates);
...
var _indexSoy = __webpack_require__(125);
...
var YJOlJ = function (_Component) {
  _inherits(YJOlJ, _Component);

  function YJOlJ() {
    _classCallCheck(this, YJOlJ);

    return _possibleConstructorReturn(this, (YJOlJ.__proto__ || Object.getPrototypeOf(YJOlJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YJOlJ, _indexSoy2.default);

exports.default = YJOlJ;
