var pageComponent =
webpackJsonppageComponent([22,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JVlgg", function() { return JVlgg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace JVlgg.
 * @public
 */

goog.module('JVlgg.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param763 = function() {
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
        ...
        var iconList777 = opt_data.page.icons;
        var iconListLen777 = iconList777.length;
        for (var iconIndex777 = 0; iconIndex777 < iconListLen777; iconIndex777++) {
          var iconData777 = iconList777[iconIndex777];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + iconData777);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + iconData777);
            ie_close('svg');
            ie_open('span');
              var dyn7 = iconData777;
              if (typeof dyn7 == 'function') dyn7(); else if (dyn7 != null) itext(dyn7);
            ie_close('span');
          ie_close('li');
        }
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
          'class', 'lexicon-icon-list list-unstyled');
        var flagList789 = opt_data.page.flags;
        var flagListLen789 = flagList789.length;
        for (var flagIndex789 = 0; flagIndex789 < flagListLen789; flagIndex789++) {
          var flagData789 = flagList789[flagIndex789];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + flagData789);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + flagData789);
            ie_close('svg');
            ie_open('span');
              var dyn8 = opt_data.page.flagData[flagData789];
              if (typeof dyn8 == 'function') dyn8(); else if (dyn8 != null) itext(dyn8);
              itext(' (');
              var dyn9 = flagData789;
              if (typeof dyn9 == 'function') dyn9(); else if (dyn9 != null) itext(dyn9);
              itext(')');
            ie_close('span');
          ie_close('li');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param763}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'JVlgg.render';
}
...
class JVlgg extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(JVlgg, templates);
...
var JVlgg = function (_Component) {
  _inherits(JVlgg, _Component);

  function JVlgg() {
    _classCallCheck(this, JVlgg);

    return _possibleConstructorReturn(this, (JVlgg.__proto__ || Object.getPrototypeOf(JVlgg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JVlgg, _iconsLexiconSoy2.default);

exports.default = JVlgg;
