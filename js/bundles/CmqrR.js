var pageComponent =
webpackJsonppageComponent([10,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CmqrR", function() { return CmqrR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace CmqrR.
 * @public
 */

goog.module('CmqrR.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1370 = function() {
    ie_open('article', null, null,
        'id', 'sidebar');
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('Documentation for the Sidebar CSS component, for the Sidenav javascript component see ');
        ie_open('a', null, null,
            'href', '../sidenav');
          itext('Sidenav');
        ie_close('a');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('An opinionated container to display related content.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'col-md-6');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            itext('Sidebar Footer');
          ie_close('div');
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div class="sidebar">\n    <div class="sidebar-header">\n        Sidebar Header\n    </div>\n    <div class="sidebar-body">\n        Sidebar Body\n    </div>\n    <div class="sidebar-footer">\n        Sidebar Footer\n    </div>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'sidebar-light');
      ie_open('h3');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Add classes ');
          ie_open('code');
            itext('sidebar-light sidebar-light-bg');
          ie_close('code');
          itext(' to ');
          ie_open('code');
            itext('sidebar');
          ie_close('code');
          itext(' to apply a light theme.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'col-md-6');
        ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('h4', null, null,
                    'class', 'sidebar-title');
                  ie_open('a', null, null,
                      'class', 'sidebar-link text-truncate',
                      'href', '#1');
                    itext('Image1.jpg');
                  ie_close('a');
                ie_close('h4');
              ...
              ie_open('div', null, null,
                ...
                ie_open('ul', null, null,
                  ...
                  ie_open('li', null, null,
                      'class', 'nav-item');
                    ie_open('a', null, null,
                        'class', 'nav-link nav-link-monospaced sidebar-link',
                        'href', '#1');
                      ie_open('svg', null, null,
                          'aria-hidden', 'true',
          ...
          ie_open('div', null, null,
              'class', 'sidebar-body');
            ie_open('nav', null, null,
                'class', 'navbar navigation-bar navbar-collapse-absolute navbar-transparent navbar-expand-md navbar-underline');
              ie_open('div', null, null,
                ...
                ie_open('button', null, null,
                    ...
                    'data-target', '#sidebarLightCollapse00',
                    'data-toggle', 'collapse',
                    'type', 'button');
                  ie_open('span', null, null,
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                ...
                ie_open('div', null, null,
                    'class', 'flex-col flex-col-expand');
                  ie_open('div', null, null,
                      'class', 'h5 sidebar-title');
                    itext('Version 1.2');
                  ie_close('div');
                  ie_open('div', null, null,
                      'class', 'sidebar-caption');
                    itext('By Helen, on 8/31/17 9:15am');
                  ie_close('div');
                  ie_open('div', null, null,
                      'class', 'sidebar-caption');
                    itext('No Change Log');
              ...
              ie_open('li', null, null,
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('div', null, null,
                      'class', 'sidebar-caption');
                    itext('By Helen, on 8/31/17 8:00am');
                  ie_close('div');
                  ie_open('div', null, null,
                      'class', 'sidebar-caption');
                    itext('No Change Log');
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('div', null, null,
                    ...
                    ie_open('a', null, null,
                        ...
                        'data-toggle', 'dropdown',
                        'href', '#1',
                        'id', 'sidebarLightListDropdownId02');
                      ie_open('svg', null, null,
                          'aria-hidden', 'true',
                          'class', 'lexicon-icon lexicon-icon-ellipsis-v');
                        ie_void('use', null, null,
                    ...
                    ie_close('a');
                    ie_open('div', null, null,
                        'aria-labelledBy', 'sidebarLightListDropdownId02',
                        'class', 'dropdown-menu');
                      ie_open('a', null, null,
                          'class', 'dropdown-item',
                          'href', '#1');
              ...
              ie_open('li', null, null,
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('div', null, null,
                      'class', 'sidebar-caption');
                    itext('By Helen, on 8/31/17 7:47am');
                  ie_close('div');
                  ie_open('div', null, null,
                      'class', 'sidebar-caption');
                    itext('No Change Log');
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('div', null, null,
                    ...
                    ie_open('a', null, null,
                        ...
                        'data-toggle', 'dropdown',
                        'href', '#1',
                        'id', 'sidebarLightListDropdownId03');
                      ie_open('svg', null, null,
                          'aria-hidden', 'true',
                          'class', 'lexicon-icon lexicon-icon-ellipsis-v');
                        ie_void('use', null, null,
                    ...
                    ie_close('a');
                    ie_open('div', null, null,
                        'aria-labelledBy', 'sidebarLightListDropdownId03',
                        'class', 'dropdown-menu');
                      ie_open('a', null, null,
                          'class', 'dropdown-item',
                          'href', '#1');
            ...
            ie_open('div', null, null,
              ...
              ie_close('div');
            ie_close('div');
            ie_open('dl', null, null,
                'class', 'sidebar-dl sidebar-section');
              ie_open('dt', null, null,
                  'class', 'sidebar-dt');
                itext('Url');
              ie_close('dt');
              ie_open('dd', null, null,
                  'class', 'sidebar-dd');
                ie_open('a', null, null,
                    'class', 'sidebar-link',
                    'href', '#1');
                  itext('http://localhost:8080/documents/20140/');
                ie_close('a');
              ie_close('dd');
              ie_open('dt', null, null,
                  'class', 'sidebar-dt');
              ...
              ie_open('dd', null, null,
                ...
                ie_open('a', null, null,
                    'class', 'sidebar-link',
                    'href', '#1');
                  itext('http://localhost:8080/webdav/guest/');
                ie_close('a');
              ie_close('dd');
              ie_open('dt', null, null,
                  'class', 'sidebar-dt');
              ...
              ie_open('dd', null, null,
                  'class', 'sidebar-dd');
                itext('A picture of a person using a ruler and exacto knife to cut construction paper.');
              ie_close('dd');
              ie_open('dt', null, null,
                  'class', 'sidebar-dt');
                itext('Size');
              ...
              ie_open('dd', null, null,
                  'class', 'sidebar-dd');
                ie_open('span', null, null,
                    'class', 'label label-lg label-secondary');
                  itext('Tag One');
                ie_close('span');
                ie_open('span', null, null,
                    'class', 'label label-lg label-secondary');
                ...
                ie_open('ul', null, null,
                  ...
                  ie_open('li', null, null,
                    ...
                    ie_open('div', null, null,
                        'class', 'flex-col');
                      ie_open('span', null, null,
                          'class', 'sticker sticker-secondary sticker-sm');
                        ie_open('svg', null, null,
                            'aria-hidden', 'true',
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'CmqrR.render';
}
...
class CmqrR extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(CmqrR, templates);
...
var _sidebarSoy = __webpack_require__(124);
...
var CmqrR = function (_Component) {
  _inherits(CmqrR, _Component);

  function CmqrR() {
    _classCallCheck(this, CmqrR);

    return _possibleConstructorReturn(this, (CmqrR.__proto__ || Object.getPrototypeOf(CmqrR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CmqrR, _sidebarSoy2.default);

exports.default = CmqrR;
