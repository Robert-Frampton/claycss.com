var pageComponent =
webpackJsonppageComponent([30,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "yJagA", function() { return yJagA; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace yJagA.
 * @public
 */

goog.module('yJagA.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param806 = function() {
    ie_open('article', null, null,
        'id', '1');
      ie_open('div', null, null,
          'class', 'alert alert-warning clay-site-grid-width');
        ie_open('span', null, null,
            'class', 'clay-site-grid-width-sm');
          itext('container-fluid-max-sm: 540px');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-grid-width-md');
          itext('container-fluid-max-md: 720px');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-grid-width-lg');
          itext('container-fluid-max-lg: 960px');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-grid-width-xl');
          itext('container-fluid-max-xl: 1140px');
        ie_close('span');
        ie_open('span', null, null,
            'class', 'clay-site-grid-width-xxl');
          itext('container-fluid-max-xxl: 1280px');
        ie_close('span');
      ie_close('div');
      ie_open('h3');
        itext('Container Fluid');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use classes ');
          ie_open('code');
            itext('container-fluid-max-sm');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('container-fluid-max-md');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('container-fluid-max-lg');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('container-fluid-max-xl');
          ie_close('code');
          itext(', and ');
          ie_open('code');
            itext('container-fluid-max-xxl');
          ie_close('code');
          itext(' in conjunction with ');
          ie_open('code');
            itext('container-fluid');
          ie_close('code');
          itext(' to create containers that expand to 100% width, but don\'t expand beyond a set width e.g 1280px.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-container-fluid-switcher');
        ie_open('button', null, null,
            'class', 'btn btn-info',
            'data-container-classes', 'container-fluid container-fluid-max-sm content',
        ...
        ie_open('button', null, null,
            'class', 'btn btn-info',
            'data-container-classes', 'container-fluid container-fluid-max-md content',
            'onclick', 'clickBtn(this);',
            'type', 'button');
          itext('container-fluid-max-md (720px)');
        ie_close('button');
        ie_open('button', null, null,
            'class', 'btn btn-info',
            'data-container-classes', 'container-fluid container-fluid-max-lg content',
            'onclick', 'clickBtn(this);',
            'type', 'button');
          itext('container-fluid-max-lg (960px)');
        ie_close('button');
        ie_open('button', null, null,
            'class', 'btn btn-info',
            'data-container-classes', 'container-fluid container-fluid-max-xl content',
            'onclick', 'clickBtn(this);',
            'type', 'button');
          itext('container-fluid-max-xl (1140px)');
        ie_close('button');
        ie_open('button', null, null,
            'class', 'btn btn-info',
            'data-container-classes', 'container-fluid container-fluid-max-xxl content',
            'onclick', 'clickBtn(this);',
            'type', 'button');
          itext('container-fluid-max-xxl (1280px)');
        ie_close('button');
        ie_open('button', null, null,
            'class', 'btn btn-info',
            'data-container-classes', 'content',
            'onclick', 'clickBtn(this);',
            'type', 'button');
          itext('reset');
        ie_close('button');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param806}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'yJagA.render';
}
...
class yJagA extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(yJagA, templates);
...
var _gridSoy = __webpack_require__(104);

var _gridSoy2 = _interopRequireDefault(_gridSoy);
...
var yJagA = function (_Component) {
  _inherits(yJagA, _Component);

  function yJagA() {
    _classCallCheck(this, yJagA);

    return _possibleConstructorReturn(this, (yJagA.__proto__ || Object.getPrototypeOf(yJagA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yJagA, _gridSoy2.default);

exports.default = yJagA;
