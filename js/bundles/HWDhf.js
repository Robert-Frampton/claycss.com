var pageComponent =
webpackJsonppageComponent([29,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HWDhf", function() { return HWDhf; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace HWDhf.
 * @public
 */

goog.module('HWDhf.incrementaldom');
  ...
  var param380 = function() {
    ie_open('article', null, null,
      ...
      ie_open('button', null, null,
        ...
        itext('Unstyled');
      ie_close('button');
      $templateAlias2({code: '<button class="btn btn-primary" type="button">Primary</button>\n<button class="btn btn-secondary" type="button">Secondary</button>\n<button class="btn btn-info" type="button">Info</button>\n<button class="btn btn-success" type="button">Success</button>\n<button class="btn btn-warning" type="button">Warning</button>\n<button class="btn btn-danger" type="button">Danger</button>\n<button class="btn btn-light" type="button">Light</button>\n<button class="btn btn-dark" type="button">Dark</button>\n<button class="btn btn-link" type="button">Link</button>\n<button class="btn btn-unstyled" type="button">Unstyled</button>', mode: 'xml'}, null, opt_ijData);
      ie_open('h3');
        itext('Focus');
      ie_close('h3');
      ie_open('button', null, null,
      ...
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-secondary focus',
          'type', 'button');
        itext('Secondary');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-info focus',
          'type', 'button');
        itext('Info');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-success focus',
          'type', 'button');
        itext('Success');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-warning focus',
          'type', 'button');
        itext('Warning');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-danger focus',
          'type', 'button');
        itext('Danger');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-light focus',
          'type', 'button');
        itext('Light');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-dark focus',
          'type', 'button');
        itext('Dark');
      ie_close('button');
      ie_open('button', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('button', null, null,
        ...
        itext('Dark');
      ie_close('button');
      $templateAlias2({code: '<button class="btn btn-outline-primary" type="button">Primary</button>\n<button class="btn btn-outline-secondary" type="button">Secondary</button>\n<button class="btn btn-outline-info" type="button">Info</button>\n<button class="btn btn-outline-success" type="button">Success</button>\n<button class="btn btn-outline-warning" type="button">Warning</button>\n<button class="btn btn-outline-danger" type="button">Danger</button>\n<button class="btn btn-outline-light" type="button">Light</button>\n<button class="btn btn-outline-dark" type="button">Dark</button>', mode: 'xml'}, null, opt_ijData);
      ie_open('h3');
        itext('Focus');
      ie_close('h3');
      ie_open('button', null, null,
          'class', 'btn btn-outline-primary focus',
          'type', 'button');
        itext('Primary');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-outline-secondary focus',
          'type', 'button');
        itext('Secondary');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-outline-info focus',
          'type', 'button');
        itext('Info');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-outline-success focus',
          'type', 'button');
        itext('Success');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-outline-warning focus',
          'type', 'button');
        itext('Warning');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-outline-danger focus',
          'type', 'button');
        itext('Danger');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-outline-light focus',
          'type', 'button');
        itext('Light');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-outline-dark focus',
          'type', 'button');
        itext('Dark');
      ie_close('button');
      ie_open('h3');
      ...
      ie_close('button');
      ie_open('button', null, null,
          'class', 'active btn btn-outline-warning',
          'type', 'button');
        itext('Warning');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'active btn btn-outline-danger',
          'type', 'button');
        itext('Danger');
      ie_close('button');
      ie_open('button', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-monospaced btn-info',
          'type', 'button');
        itext('C');
      ie_close('button');
      ie_open('button', null, null,
      ...
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-monospaced btn-warning',
          'type', 'button');
        itext('E');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-monospaced btn-danger',
          'type', 'button');
        itext('F');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-monospaced btn-light',
          'type', 'button');
        itext('G');
      ie_close('button');
      ie_open('button', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('button', null, null,
        ...
        itext('Large');
      ie_close('button');
      $templateAlias2({code: '<button class="btn btn-secondary btn-sm" type="button">Small</button>\n<button class="btn btn-secondary" type="button">Default</button>\n<button class="btn btn-secondary btn-lg" type="button">Large</button>', mode: 'xml'}, null, opt_ijData);
      ie_open('button', null, null,
        ...
        ie_open('svg', null, null,
          ...
          ie_void('use', null, null,
              'xlink:href', '/vendor/lexicon/icons.svg#blogs');
        ie_close('svg');
      ie_close('button');
      ie_open('button', null, null,
          'class', 'btn btn-monospaced btn-secondary',
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'HWDhf.render';
}
...
class HWDhf extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(HWDhf, templates);
...
var _buttonsSoy = __webpack_require__(98);
...
var HWDhf = function (_Component) {
  _inherits(HWDhf, _Component);

  function HWDhf() {
    _classCallCheck(this, HWDhf);

    return _possibleConstructorReturn(this, (HWDhf.__proto__ || Object.getPrototypeOf(HWDhf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HWDhf, _buttonsSoy2.default);

exports.default = HWDhf;
