var pageComponent =
webpackJsonppageComponent([23,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IcCPS", function() { return IcCPS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from form_elements_validation.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace IcCPS.
 * @public
 */

goog.module('IcCPS.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param719 = function() {
    ie_open('article', null, null,
        'id', 'input-validation-states-non-html5');
      ie_open('h3');
        itext('Input Validation States (Non HTML5)');
      ie_close('h3');
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            itext('This is a form-feedback-item.');
          ie_close('div');
          ie_open('div', null, null,
              'class', 'form-feedback-indicator');
            itext('This is a form-feedback-indicator.');
          ie_close('div');
          ie_open('div', null, null,
              'class', 'form-text');
            itext('This is form-text.');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'custom-checkbox-and-radio-validation-states');
      ie_open('h3');
        itext('Custom Checkbox and Radio Validation States');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('label');
                  ...
                  ie_open('span', null, null,
                    ...
                    itext('Custom Checkbox with Success');
                    ie_open('svg', null, null,
                        'aria-hidden', 'true',
                        'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                      ie_void('use', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('label');
                  ...
                  ie_open('span', null, null,
                      'class', 'custom-control-description');
                    itext('Custom Checkbox with Warning');
                    ie_open('svg', null, null,
                        'aria-hidden', 'true',
                        'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                      ie_void('use', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('label');
                  ...
                  ie_open('span', null, null,
                      'class', 'custom-control-description');
                    itext('Custom Checkbox with Error');
                    ie_open('svg', null, null,
                        'aria-hidden', 'true',
                        'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                      ie_void('use', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('label');
                  ie_open('input', null, null,
                      'class', 'custom-control-input',
                      'id', 'validationRadioCustom1',
                      'name', 'validationRadioCustom',
                      'type', 'radio');
                  ie_close('input');
                  ie_void('span', null, null,
                      'class', 'custom-control-indicator');
                  ie_open('span', null, null,
                      'class', 'custom-control-description');
                    itext('Custom Radio with Success');
                  ie_close('span');
                ie_close('label');
              ie_close('div');
            ie_close('div');
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('label');
                  ...
                  ie_open('span', null, null,
                      'class', 'custom-control-description');
                    itext('Custom Radio with Warning');
                  ie_close('span');
                ie_close('label');
              ie_close('div');
            ie_close('div');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'select-element-validation-states');
      ie_open('h3');
        itext('Select Element Validation States');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'selectElementSuccess');
              itext('Select Element with Success');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                ie_void('use', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'selectElementWarning');
              itext('Select Box with Warning');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                ie_void('use', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'selectElementError');
              itext('Select Box with Error');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                ie_void('use', null, null,
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'multiple-select-element-validation-states');
      ie_open('h3');
        itext('Multiple Select Element Validation States');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'multipleSelectElementSuccess');
              itext('Multiple Select Element with Success');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                ie_void('use', null, null,
            ...
            ie_open('select', null, null,
                'class', 'form-control',
                'id', 'multipleSelectElementSuccess',
                'multiple', '');
              ie_open('option');
                itext('Sample 1');
              ie_close('option');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'multipleSelectElementWarning');
              itext('Multiple Select Element with Warning');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                ie_void('use', null, null,
            ...
            ie_open('select', null, null,
                'class', 'form-control',
                'id', 'multipleSelectElementWarning',
                'multiple', '');
              ie_open('option');
                itext('Sample 1');
              ie_close('option');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'multipleSelectElementError');
              itext('Multiple Select Element with Error');
              ie_open('svg', null, null,
                  'aria-hidden', 'true',
                  'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
                ie_void('use', null, null,
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'readonly-validation-states');
      ie_open('h3');
        itext('Readonly Validation States');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('label', null, null,
                'for', 'readonlySuccess');
              itext('Text Input (Read Only) with Success');
            ie_close('label');
            ie_open('input', null, null,
                'class', 'form-control',
                'id', 'readonlySuccess',
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('label', null, null,
                'for', 'readonlyWarning');
              itext('Text Input (Read Only) with Warning');
            ie_close('label');
            ie_open('input', null, null,
                'class', 'form-control',
                'id', 'readonlyWarning',
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('label', null, null,
                'for', 'readonlyError');
              itext('Text Input (Read Only) with Error');
            ie_close('label');
            ie_open('input', null, null,
                'class', 'form-control',
                'id', 'readonlyError',
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'readonlyTextareaSuccess');
              itext('Textarea (Read Only) with Success');
            ie_close('label');
            ie_open('textarea', null, null,
                'class', 'form-control',
                'id', 'readonlyTextareaSuccess',
                'placeholder', 'Placeholder',
                'readonly', '');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'readonlyTextareaWarning');
              itext('Textarea (Read Only) with Warning');
            ie_close('label');
            ie_open('textarea', null, null,
                'class', 'form-control',
                'id', 'readonlyTextareaWarning',
                'placeholder', 'Placeholder',
                'readonly', '');
              itext('Plunger pot, extra siphon latte, as americano aromatic roast cultivar cup cup frappuccino. To go, strong, half and half foam single origin, cultivar affogato black grounds shop ut plunger pot. Con panna aroma, pumpkin spice to go, wings, aromatic single shot, aged single shot to go extraction java. Percolator americano at cultivar grinder est java percolator plunger pot shop con panna.');
            ie_close('textarea');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'form-group');
            ie_open('label', null, null,
                'for', 'readonlyTextareaError');
              itext('Textarea (Read Only) with Error');
            ie_close('label');
            ie_open('textarea', null, null,
                'class', 'form-control',
                'id', 'readonlyTextareaError',
                'placeholder', 'Placeholder',
                'readonly', '');
              itext('Plunger pot, extra siphon latte, as americano aromatic roast cultivar cup cup frappuccino. To go, strong, half and half foam single origin, cultivar affogato black grounds shop ut plunger pot. Con panna aroma, pumpkin spice to go, wings, aromatic single shot, aged single shot to go extraction java. Percolator americano at cultivar grinder est java percolator plunger pot shop con panna.');
            ie_close('textarea');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'input-validation-states-html5');
      ie_open('h3');
        itext('Input Validation States (HTML5)');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          ie_open('a', null, null,
              'href', 'https://getbootstrap.com/docs/4.0/components/forms/#validation');
            itext('https://getbootstrap.com/docs/4.0/components/forms/#validation');
          ie_close('a');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('This component has limited styling options (valid and invalid) and requires very specific markup structure. Use the non HTML5 validation pattern if you require more freedom with your markup and styling options.');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#exclamation-full');
                ie_close('svg');
                itext('Please enter first name.');
              ie_close('div');
            ie_close('div');
            ie_open('div', null, null,
                'class', 'form-inline-group');
              ie_open('label', null, null,
                  'for', 'formValidationLastName');
                itext('Last Name');
                ie_open('svg', null, null,
                    'aria-hidden', 'true',
                    'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
              ...
              ie_open('div', null, null,
                ...
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#exclamation-full');
                ie_close('svg');
                itext('Please enter city.');
              ie_close('div');
            ie_close('div');
            ie_open('div', null, null,
                'class', 'form-inline-group');
              ie_open('label', null, null,
                  'for', 'formValidationState');
                itext('State');
                ie_open('svg', null, null,
                    'aria-hidden', 'true',
                    'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
              ...
              ie_open('div', null, null,
                ...
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#exclamation-full');
                ie_close('svg');
                itext('Please enter state.');
              ie_close('div');
            ie_close('div');
            ie_open('div', null, null,
                'class', 'form-inline-group');
              ie_open('label', null, null,
                  'for', 'formValidationZipCode');
                itext('Zip Code');
                ie_open('svg', null, null,
                    'aria-hidden', 'true',
                    'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
            ...
            ie_open('div', null, null,
              ...
              ie_open('svg', null, null,
                ...
                ie_void('use', null, null,
                    'xlink:href', '/vendor/lexicon/icons.svg#exclamation-full');
              ie_close('svg');
              itext('Use atleast 6 characters.');
            ie_close('div');
          ie_close('div');
          ie_open('div', null, null,
              'class', 'form-group form-inline form-inline-autofit');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'IcCPS.render';
}
...
class IcCPS extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(IcCPS, templates);
...
var _form_elements_validationSoy = __webpack_require__(104);

var _form_elements_validationSoy2 = _interopRequireDefault(_form_elements_validationSoy);
...
var IcCPS = function (_Component) {
  _inherits(IcCPS, _Component);

  function IcCPS() {
    _classCallCheck(this, IcCPS);

    return _possibleConstructorReturn(this, (IcCPS.__proto__ || Object.getPrototypeOf(IcCPS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IcCPS, _form_elements_validationSoy2.default);

exports.default = IcCPS;
