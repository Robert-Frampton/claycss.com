...
function $header(opt_data, opt_ignored, opt_ijData) {
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('h2', null, null,
                'class', 'h3');
              itext('A Web Implementation of Lexicon Experience Language');
            ie_close('h2');
            ie_open('a', null, null,
  ...
  $linkblocks(opt_data, null, opt_ijData);
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('div', null, null,
                    'class', 'card-body pl-md-0 pt-5');
                  ie_open('h2', null, null,
                      'class', 'font-weight-bold');
                    itext('Component Library');
                  ie_close('h2');
                  ie_open('p');
  ...
  ie_open('section', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
            'class', 'col-md-4 ml-auto wow zoomIn',
 ...
 * @suppress {checkTypes}
 */
function $linkblocks(opt_data, opt_ignored, opt_ijData) {
  ie_open('section', null, null,
      'class', 'link-blocks text-center');
    ie_open('div', null, null,
        'class', 'container-fluid container-fluid-max-lg');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
            'class', 'body ml-auto col-md-9 mr-auto');
          ie_open('h2', null, null,
              'class', 'font-weight-bold');
            itext('A web implementation of Lexicon');
          ie_close('h2');
          ie_open('p', null, null,
              'class', 'py-5');
            itext('There\'s always been a distinction between the experience language Lexicon Experience Language, and the web implementation Lexicon. As you can see, naming them like this didn\'t help with the distinction. So Lexicon, the web implementation, has been renamed to Clay.');
          ie_close('p');
        ie_close('div');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'row');
        ie_open('div', null, null,
            'class', 'col-md-5 ml-auto mb-4');
          ie_open('div', null, null,
              'class', 'card h-100 wow fadeInUp');
            ie_open('div', null, null,
                'class', 'card-body');
              ie_open('img', null, null,
                  'class', 'mx-auto',
              ...
              ie_close('img');
              ie_open('p');
                itext('Visit the current Lexicon ');
                itext('Experience Language site');
              ie_close('p');
              ie_open('a', null, null,
                  'class', 'mb-3',
                  'target', '_blank',
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_close('img');
              ie_open('p');
                itext('Visit the previous version of ');
                itext('Clay at Lexicon CSS project site');
              ie_close('p');
              ie_open('a', null, null,
                  'class', 'mb-3',
                  'target', '_blank',
...
if (goog.DEBUG) {
  $linkblocks.soyTemplateName = 'pageIndex.linkblocks';
}
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_close('img');
          ie_void('div', null, null,
              'class', 'clearfix d-lg-none d-xl-none');
          ie_open('span');
            itext('Brought to you by ');
            ie_open('a', null, null,
                'href', 'http://www.liferay.com',
...
exports.linkblocks.params = [];
exports.linkblocks.types = {};
exports.footer.params = [];
exports.footer.types = {};
templates = exports;
return exports;
