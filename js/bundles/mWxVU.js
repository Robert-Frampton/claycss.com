var pageComponent =
webpackJsonppageComponent([23,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mWxVU", function() { return mWxVU; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from management-bar.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace mWxVU.
 * @public
 */

goog.module('mWxVU.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param973 = function() {
    ie_open('article', null, null,
        'id', 'navbar-management-bar');
      ie_open('h3');
        itext('Navbar Management Bar');
      ie_close('h3');
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'management-bar navbar navbar-expand-md');
          ie_open('div', null, null,
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                    'aria-expanded', 'false',
                    'class', 'dropdown-toggle nav-link navbar-breakpoint-down-d-none',
                    'data-toggle', 'dropdown',
                    'href', '#1',
                    'role', 'button');
                  ie_open('span', null, null,
                      'class', 'navbar-text-truncate');
                    itext('Filter and Order');
                  ie_close('span');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('a', null, null,
                      'class', 'dropdown-item',
                      'href', '#1');
                    itext('Filter Action 1');
                  ie_close('a');
                  ie_open('a', null, null,
                      'class', 'dropdown-item',
                      'href', '#1');
                    itext('Filter Action 2');
                  ie_close('a');
                  ie_open('a', null, null,
                      'class', 'dropdown-item',
                      'href', '#1');
                    itext('Filter Action 3');
                  ie_close('a');
                ie_close('div');
              ie_close('li');
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                  ...
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#order-arrow');
                  ie_close('svg');
                ie_close('a');
              ie_close('li');
            ie_close('ul');
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('form', null, null,
                    'role', 'search');
                  ie_open('div', null, null,
                      'class', 'input-group input-group-inset');
                    ie_open('div', null, null,
                    ...
                    ie_open('span', null, null,
                      ...
                      ie_open('button', null, null,
                          'class', 'btn btn-unstyled clay-site-close-overlay-sm-down navbar-breakpoint-d-none',
                          'type', 'button');
                        ie_open('svg', null, null,
                            'aria-hidden', 'true',
                      ...
                      ie_close('button');
                      ie_open('button', null, null,
                          'class', 'btn btn-unstyled navbar-breakpoint-d-block',
                          'type', 'button');
                        ie_open('svg', null, null,
                            'aria-hidden', 'true',
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                    'class', 'clay-site-open-overlay-sm-down nav-link nav-link-monospaced',
                    'href', '#1');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
                      'class', 'lexicon-icon lexicon-icon-search');
              ...
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                  ...
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#list');
                  ie_close('svg');
                ie_close('a');
                ie_open('div', null, null,
                  ...
                  ie_open('a', null, null,
                    ...
                    ie_open('span', null, null,
                      ...
                      ie_open('svg', null, null,
                        ...
                        ie_void('use', null, null,
                            'xlink:href', '/vendor/lexicon/icons.svg#table');
                      ie_close('svg');
                    ie_close('span');
                    itext('Table View');
                  ie_close('a');
                  ie_open('a', null, null,
                    ...
                    ie_open('span', null, null,
                      ...
                      ie_open('svg', null, null,
                        ...
                        ie_void('use', null, null,
                            'xlink:href', '/vendor/lexicon/icons.svg#cards2');
                      ie_close('svg');
                    ie_close('span');
                    itext('Card View');
                  ie_close('a');
      ...
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'management-bar navbar navbar-expand-md navbar-light');
          ie_open('div', null, null,
              'class', 'container-fluid container-fluid-max-xl');
            ie_open('ul', null, null,
                'class', 'navbar-nav');
              ...
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                    'aria-expanded', 'false',
                    'class', 'nav-link nav-link-monospaced dropdown-toggle navbar-breakpoint-d-none',
                    'data-toggle', 'dropdown',
                    'href', '#1',
                    'role', 'button');
                  ie_open('svg', null, null,
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                  'class', 'nav-item navbar-breakpoint-d-none');
                ie_open('a', null, null,
                    'class', 'nav-link nav-link-monospaced clay-site-open-overlay-sm-down',
                    'href', '#1');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
                      'class', 'lexicon-icon lexicon-icon-search');
      ...
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'management-bar navbar navbar-dark navbar-expand-md');
          ie_open('div', null, null,
              'class', 'container-fluid container-fluid-max-xl');
            ie_open('ul', null, null,
                'class', 'navbar-nav');
      ...
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'management-bar navbar navbar-expand-md navbar-primary');
          ie_open('div', null, null,
              'class', 'container-fluid container-fluid-max-xl');
            ie_open('ul', null, null,
                'class', 'navbar-nav');
              ...
              ie_open('li', null, null,
                ...
                ie_open('button', null, null,
                  ...
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#paste');
                  ie_close('svg');
                ie_close('button');
              ie_close('li');
              ie_open('li', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-overlay-up');
          ie_close('code');
          itext(' overlays the navbar at all screen widths.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-overlay-lg-down');
          ie_close('code');
          itext(': 1199px and below');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-overlay-md-down');
          ie_close('code');
          itext(': 991px and below');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-overlay-sm-down');
          ie_close('code');
          itext(': 767px and below');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('navbar-overlay-xs-down');
          ie_close('code');
          itext(': 575px and below');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('nav', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                  ...
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
                      'class', 'lexicon-icon lexicon-icon-import-export');
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#import-export');
                  ie_close('svg');
                ie_close('a');
              ie_close('li');
            ie_close('ul');
            ...
            ie_open('ul', null, null,
              ...
              ie_open('li', null, null,
                  'class', 'nav-item');
                ie_open('a', null, null,
                    'class', 'clay-site-open-overlay-sm-down nav-link nav-link-monospaced navbar-breakpoint-d-none',
                    'href', '#1');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
                      'class', 'lexicon-icon lexicon-icon-search');
              ...
              ie_open('li', null, null,
                  'class', 'nav-item');
                ie_open('a', null, null,
                    'class', 'nav-link nav-link-monospaced navbar-breakpoint-down-d-none',
                    'href', '#1');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
                      'class', 'lexicon-icon lexicon-icon-view');
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#view');
                  ie_close('svg');
                ie_close('a');
              ie_close('li');
              ie_open('li', null, null,
            ...
            ie_close('ul');
            ie_open('div', null, null,
                'class', 'navbar-overlay navbar-overlay-up');
              ie_open('div', null, null,
                  'class', 'container-fluid container-fluid-max-xl');
                ie_open('ul', null, null,
                    'class', 'navbar-nav');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param973}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'mWxVU.render';
}
...
class mWxVU extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(mWxVU, templates);
...
var _managementBarSoy = __webpack_require__(111);

var _managementBarSoy2 = _interopRequireDefault(_managementBarSoy);
...
var mWxVU = function (_Component) {
  _inherits(mWxVU, _Component);

  function mWxVU() {
    _classCallCheck(this, mWxVU);

    return _possibleConstructorReturn(this, (mWxVU.__proto__ || Object.getPrototypeOf(mWxVU)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mWxVU, _managementBarSoy2.default);

exports.default = mWxVU;
