var pageComponent =
webpackJsonppageComponent([21,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VDkqd", function() { return VDkqd; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from multi_step_nav.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace VDkqd.
 * @public
 */

goog.module('VDkqd.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1041 = function() {
    ie_open('article', null, null,
        'id', 'multi-step-nav');
      ie_open('h3');
        itext('Multi Step Nav');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Multi Step Progress Bar replacement for Clay V2.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('ol', null, null,
            'class', 'multi-step-nav');
          ie_open('li', null, null,
              'class', 'complete multi-step-item multi-step-item-expand');
            ie_void('div', null, null,
                'class', 'multi-step-divider');
            ie_open('div', null, null,
                'class', 'multi-step-indicator');
              ie_void('div', null, null,
          ...
          ie_close('li');
          ie_open('li', null, null,
              'class', 'active multi-step-item multi-step-item-expand');
            ie_void('div', null, null,
                'class', 'multi-step-divider');
            ie_open('div', null, null,
                'class', 'multi-step-indicator');
          ...
          ie_close('li');
          ie_open('li', null, null,
              'class', 'multi-step-item multi-step-item-expand');
            ie_void('div', null, null,
                'class', 'multi-step-divider');
            ie_open('div', null, null,
                'class', 'multi-step-indicator');
              ie_open('div', null, null,
                  'class', 'dropdown multi-step-icon');
                ie_open('a', null, null,
                    'aria-expanded', 'false',
                    'aria-haspopup', 'true',
                    'class', 'dropdown-toggle multi-step-link',
                  ...
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#ellipsis-h');
                  ie_close('svg');
                ie_close('a');
                ie_open('div', null, null,
                    'class', 'dropdown-menu');
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('button', null, null,
                    'aria-expanded', 'false',
                    'aria-haspopup', 'true',
                    'class', 'btn btn-link dropdown-toggle multi-step-link',
                    'data-toggle', 'dropdown',
                    'type', 'button');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('button', null, null,
                    'aria-expanded', 'false',
                    'aria-haspopup', 'true',
                    'class', 'btn btn-unstyled dropdown-toggle multi-step-link',
                    'data-toggle', 'dropdown',
                    'type', 'button');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_close('ol');
      ie_close('div');
      $templateAlias2({code: '<ol class="multi-step-nav multi-step-nav-collapse-sm multi-step-indicator-label-bottom">\n    <li class="complete multi-step-item multi-step-item-expand">\n        <div class="multi-step-title">Ticket Buyer Information</div>\n        <div class="multi-step-divider"></div>\n        <div class="multi-step-indicator">\n            <div class="multi-step-indicator-label">Step 01</div>\n            <div class="multi-step-icon" data-multi-step-icon="1"></div>\n        </div>\n    </li>\n    <li class="complete multi-step-item multi-step-item-expand">\n        <div class="multi-step-title">Attendee Information</div>\n        <div class="multi-step-divider"></div>\n        <div class="multi-step-indicator">\n            <div class="multi-step-indicator-label">Step 02</div>\n            <div class="multi-step-icon" data-multi-step-icon="2"></div>\n        </div>\n    </li>\n    <li class="complete multi-step-item multi-step-item-expand">\n        <div class="multi-step-title">Seat Assignment</div>\n        <div class="multi-step-divider"></div>\n        <div class="multi-step-indicator">\n            <div class="multi-step-indicator-label">Step 03</div>\n            <div class="multi-step-icon" data-multi-step-icon="3"></div>\n        </div>\n    </li>\n    <li class="active multi-step-item multi-step-item-expand">\n        <div class="multi-step-title">Dinner Preference</div>\n        <div class="multi-step-divider"></div>\n        <div class="multi-step-indicator">\n            <div class="multi-step-indicator-label">Step 04</div>\n            <div class="multi-step-icon" data-multi-step-icon="4"></div>\n        </div>\n    </li>\n    <li class="multi-step-item multi-step-item-expand">\n        <div class="multi-step-divider"></div>\n        <div class="multi-step-indicator">\n            <div class="dropdown multi-step-icon">\n                <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle multi-step-link" data-toggle="dropdown" href="#1">\n                    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-h">\n                        <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-h"></use>\n                    </svg>\n                </a>\n                <div class="dropdown-menu">\n                    <a class="dropdown-item" href="#1">Step 5</a>\n                    <a class="dropdown-item" href="#1">Step 6</a>\n                    <a class="dropdown-item" href="#1">Step 7</a>\n                    <a class="dropdown-item" href="#1">Step 8</a>\n                </div>\n            </div>\n        </div>\n    </li>\n    <li class="multi-step-item multi-step-item-expand">\n        <div class="multi-step-title">Payment Information</div>\n        <div class="multi-step-divider"></div>\n        <div class="multi-step-indicator">\n            <div class="multi-step-indicator-label">Step 09</div>\n            <div class="multi-step-icon" data-multi-step-icon="9"></div>\n        </div>\n    </li>\n    <li class="multi-step-item">\n        <div class="multi-step-divider"></div>\n        <div class="multi-step-indicator">\n            <div class="multi-step-indicator-label">Step 10</div>\n            <div class="multi-step-icon" data-multi-step-icon="Fin"></div>\n        </div>\n    </li>\n</ol>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'multi-step-nav-simplified');
      ie_open('h3');
        itext('Multi Step Nav Simplified');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('See ');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1041}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'VDkqd.render';
}
...
class VDkqd extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(VDkqd, templates);
...
var _multi_step_navSoy = __webpack_require__(113);

var _multi_step_navSoy2 = _interopRequireDefault(_multi_step_navSoy);
...
var VDkqd = function (_Component) {
  _inherits(VDkqd, _Component);

  function VDkqd() {
    _classCallCheck(this, VDkqd);

    return _possibleConstructorReturn(this, (VDkqd.__proto__ || Object.getPrototypeOf(VDkqd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VDkqd, _multi_step_navSoy2.default);

exports.default = VDkqd;
