var pageComponent =
webpackJsonppageComponent([12,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bXhId", function() { return bXhId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from popovers.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace bXhId.
 * @public
 */

goog.module('bXhId.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1302 = function() {
    ie_open('article', null, null,
      ...
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-popover-display');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'popover-body');
              itext('Viennese flavour cup eu, percolator froth ristretto mazagran caffeine. White roast seasonal, mocha trifecta, dripper caffeine spoon acerbic to go macchiato strong.');
            ie_close('div');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'popover-header');
              itext('Popover bottom');
            ie_close('div');
            ie_open('div', null, null,
                'class', 'popover-body');
              ie_open('p');
                itext('Single shot, caf\u00E9 au lait aromatic body robusta body cream mocha viennese steamed aged. Irish roast, aromatic seasonal, caramelization grinder french press coffee cortado lungo skinny.');
              ie_close('p');
              ie_open('p');
                itext('Viennese flavour cup eu, percolator froth ristretto mazagran caffeine. White roast seasonal, mocha trifecta, dripper caffeine spoon acerbic to go macchiato strong.');
              ie_close('p');
    ...
    ie_open('article', null, null,
      ...
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-tooltip-display');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'tooltip-inner');
            ie_open('div');
              itext('Tooltip on the right');
            ie_close('div');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'tooltip bs-tooltip-left',
            'role', 'tooltip');
          ie_void('div', null, null,
              'class', 'arrow');
          ie_open('div', null, null,
              'class', 'tooltip-inner');
            ie_open('div');
              itext('Tooltip on the left');
            ie_close('div');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'tooltip bs-tooltip-bottom',
            'role', 'tooltip');
          ie_void('div', null, null,
              'class', 'arrow');
          ie_open('div', null, null,
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'bXhId.render';
}
...
class bXhId extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(bXhId, templates);
...
var _popoversSoy = __webpack_require__(122);

var _popoversSoy2 = _interopRequireDefault(_popoversSoy);
...
var bXhId = function (_Component) {
  _inherits(bXhId, _Component);

  function bXhId() {
    _classCallCheck(this, bXhId);

    return _possibleConstructorReturn(this, (bXhId.__proto__ || Object.getPrototypeOf(bXhId)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bXhId, _popoversSoy2.default);

exports.default = bXhId;
