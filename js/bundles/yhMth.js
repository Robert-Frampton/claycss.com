var pageComponent =
webpackJsonppageComponent([5,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "yhMth", function() { return yhMth; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from tables.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace yhMth.
 * @public
 */

goog.module('yhMth.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1298 = function() {
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('A table styled like a list. The active state can be invoked by adding class ');
          ie_open('code');
            itext('table-active');
          ie_close('code');
          itext(' to the ');
      ...
      ie_open('table', null, null,
          'class', 'show-dropdown-action-on-active table table-autofit table-list table-responsive-lg');
        ie_open('thead');
          ie_open('tr');
            ie_void('th');
            ie_open('th');
        ...
        ie_open('tbody');
          ...
          ie_open('tr');
            ...
            ie_open('td');
              ie_open('div', null, null,
                ...
                ie_open('div', null, null,
                    'aria-labelledby', '',
                    'class', 'dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled');
                  ie_open('a', null, null,
                      'class', 'dropdown-item',
                      'href', '#1');
                    ie_open('svg', null, null,
          ...
          ie_open('tr', null, null,
            ...
            ie_open('td', null, null,
              ...
              ie_open('span', null, null,
                  'class', 'text-truncate',
                  'title', 'Frappuccino medium americano');
                itext('Frappuccino medium americano');
              ie_close('span');
            ie_close('td');
            ie_open('td');
              itext('--');
          ...
          ie_open('tr');
            ...
            ie_open('td', null, null,
              ...
              ie_open('span', null, null,
                  'class', 'text-truncate',
                  'title', 'Cultivar extra');
                itext('Cultivar extra');
              ie_close('span');
            ie_close('td');
            ie_open('td');
              itext('--');
    ...
    ie_open('article', null, null,
      ...
      ie_open('table', null, null,
        ...
        ie_open('tbody');
          ...
          ie_open('tr');
            ...
            ie_open('td', null, null,
              ...
              ie_open('span', null, null,
                  'class', 'text-truncate',
                  'title', 'Pumpkin spice and, java sit whipped grinder steamed.');
                itext('Pumpkin spice and, java sit whipped grinder steamed.');
              ie_close('span');
            ie_close('td');
            ie_open('td');
              ie_open('a', null, null,
        ...
        ie_close('tbody');
      ie_close('table');
      $templateAlias2({code: '<table class="show-dropdown-action-on-active table table-autofit table-list table-responsive-sm table-striped">\n    <thead>\n        <tr>\n            <th></th>\n            <th class="table-cell-content">\n                <span class="text-truncate" title="Description">Description</span>\n            </th>\n            <th>Format</th>\n            <th>Label</th>\n            <th>Label</th>\n            <th></th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr>\n            <td>\n                <div class="custom-control custom-checkbox">\n                    <label>\n                        <input class="custom-control-input" type="checkbox">\n                        <span class="custom-control-indicator"></span>\n                    </label>\n                </div>\n            </td>\n            <td class="table-cell-content">\n                <span class="text-truncate" title="Wings eu, pumpkin spice robusta, kopi-luwak mocha caffeine froth grounds.">Wings eu, pumpkin spice robusta, kopi-luwak mocha caffeine froth grounds.</span>\n            </td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td>\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" id="dropdownAction1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled">\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n                                <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n                                <use xlink:href="/vendor/lexicon/icons.svg#download" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n                                <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n                            </svg>\n                        </a>\n                    </div>\n                </div>\n            </td>\n        </tr>\n        <tr>\n            <td>\n                <div class="custom-control custom-checkbox">\n                    <label>\n                        <input class="custom-control-input" type="checkbox">\n                        <span class="custom-control-indicator"></span>\n                    </label>\n                </div>\n            </td>\n            <td class="table-cell-content">\n                <span class="text-truncate" title="Pumpkin spice and, java sit whipped grinder steamed.">Pumpkin spice and, java sit whipped grinder steamed.</span>\n            </td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td>\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" id="dropdownAction1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled">\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n                                <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n                                <use xlink:href="/vendor/lexicon/icons.svg#download" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n                                <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n                            </svg>\n                        </a>\n                    </div>\n                </div>\n            </td>\n        </tr>\n        <tr>\n            <td>\n                <div class="custom-control custom-checkbox">\n                    <label>\n                        <input class="custom-control-input" type="checkbox">\n                        <span class="custom-control-indicator"></span>\n                    </label>\n                </div>\n            </td>\n            <td class="table-cell-content">\n                <span class="text-truncate" title="Frappuccino medium americano">Frappuccino medium americano</span>\n            </td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td>\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" id="dropdownAction1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled">\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n                                <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n                                <use xlink:href="/vendor/lexicon/icons.svg#download" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n                                <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n                            </svg>\n                        </a>\n                    </div>\n                </div>\n            </td>\n        </tr>\n        <tr>\n            <td>\n                <div class="custom-control custom-checkbox">\n                    <label>\n                        <input class="custom-control-input" type="checkbox">\n                        <span class="custom-control-indicator"></span>\n                    </label>\n                </div>\n            </td>\n            <td class="table-cell-content">\n                <span class="text-truncate" title="Cultivar extra">Cultivar extra</span>\n            </td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td>\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" id="dropdownAction1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled">\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n                                <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n                                <use xlink:href="/vendor/lexicon/icons.svg#download" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n                                <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n                            </svg>\n                        </a>\n                    </div>\n                </div>\n            </td>\n        </tr>\n    </tbody>\n</table>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'table-list-with-table-hover');
      ie_open('h3');
        itext('Table List with Table Hover');
      ie_close('h3');
      ie_open('table', null, null,
          'class', 'show-dropdown-action-on-active table table-autofit table-hover table-list table-responsive-sm');
        ie_open('thead');
          ie_open('tr');
            ie_void('th');
            ie_open('th', null, null,
        ...
        ie_close('tbody');
      ie_close('table');
      $templateAlias2({code: '<table class="show-dropdown-action-on-active table table-autofit table-hover table-list table-responsive-sm">\n    <thead>\n        <tr>\n            <th></th>\n            <th class="table-cell-content">\n                <span class="text-truncate" title="Description">Description</span>\n            </th>\n            <th>Format</th>\n            <th>Label</th>\n            <th>Label</th>\n            <th></th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr>\n            <td>\n                <div class="custom-control custom-checkbox">\n                    <label>\n                        <input class="custom-control-input" type="checkbox">\n                        <span class="custom-control-indicator"></span>\n                    </label>\n                </div>\n            </td>\n            <td class="table-cell-content">\n                <span class="text-truncate" title="Wings eu, pumpkin spice robusta, kopi-luwak mocha caffeine froth grounds.">Wings eu, pumpkin spice robusta, kopi-luwak mocha caffeine froth grounds.</span>\n            </td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td>\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" id="dropdownAction1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled">\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n                                <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n                                <use xlink:href="/vendor/lexicon/icons.svg#download" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n                                <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n                            </svg>\n                        </a>\n                    </div>\n                </div>\n            </td>\n        </tr>\n        <tr class="table-active">\n            <td>\n                <div class="custom-control custom-checkbox">\n                    <label>\n                        <input checked class="custom-control-input" type="checkbox">\n                        <span class="custom-control-indicator"></span>\n                    </label>\n                </div>\n            </td>\n            <td class="table-cell-content">\n                <span class="text-truncate" title="Pumpkin spice and, java sit whipped grinder steamed.">Pumpkin spice and, java sit whipped grinder steamed.</span>\n            </td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td>\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" id="dropdownAction1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled">\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n                                <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n                                <use xlink:href="/vendor/lexicon/icons.svg#download" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n                                <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n                            </svg>\n                        </a>\n                    </div>\n                </div>\n            </td>\n        </tr>\n    </tbody>\n</table>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'table-list-with-table-bordered');
      ie_open('h3');
        itext('Table List with Table Bordered');
      ie_close('h3');
      ie_open('table', null, null,
          'class', 'show-dropdown-action-on-active table table-autofit table-bordered table-list table-responsive-sm');
        ie_open('thead');
          ie_open('tr');
            ie_void('th');
            ie_open('th', null, null,
        ...
        ie_close('tbody');
      ie_close('table');
      $templateAlias2({code: '<table class="show-dropdown-action-on-active table table-autofit table-bordered table-list table-responsive-sm">\n    <thead>\n        <tr>\n            <th></th>\n            <th class="table-cell-content">\n                <span class="text-truncate" title="Description">Description</span>\n            </th>\n            <th>Format</th>\n            <th>Label</th>\n            <th>Label</th>\n            <th></th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr>\n            <td>\n                <div class="custom-control custom-checkbox">\n                    <label>\n                        <input class="custom-control-input" type="checkbox">\n                        <span class="custom-control-indicator"></span>\n                    </label>\n                </div>\n            </td>\n            <td class="table-cell-content">\n                <span class="text-truncate" title="Wings eu, pumpkin spice robusta, kopi-luwak mocha caffeine froth grounds.">Wings eu, pumpkin spice robusta, kopi-luwak mocha caffeine froth grounds.</span>\n            </td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td>\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" id="dropdownAction1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled">\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n                                <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n                                <use xlink:href="/vendor/lexicon/icons.svg#download" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n                                <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n                            </svg>\n                        </a>\n                    </div>\n                </div>\n            </td>\n        </tr>\n        <tr class="table-active">\n            <td>\n                <div class="custom-control custom-checkbox">\n                    <label>\n                        <input checked class="custom-control-input" type="checkbox">\n                        <span class="custom-control-indicator"></span>\n                    </label>\n                </div>\n            </td>\n            <td class="table-cell-content">\n                <span class="text-truncate" title="Pumpkin spice and, java sit whipped grinder steamed.">Pumpkin spice and, java sit whipped grinder steamed.</span>\n            </td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td><a href="#1">jpg</a></td>\n            <td>\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" id="dropdownAction1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div aria-labelledby="" class="dropdown-menu dropdown-menu-horizontal dropdown-menu-left-side-middle dropdown-menu-unstyled">\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-trash">\n                                <use xlink:href="/vendor/lexicon/icons.svg#trash" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-download">\n                                <use xlink:href="/vendor/lexicon/icons.svg#download" />\n                            </svg>\n                        </a>\n                        <a class="dropdown-item" href="#1">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-info-circle-open">\n                                <use xlink:href="/vendor/lexicon/icons.svg#info-circle-open" />\n                            </svg>\n                        </a>\n                    </div>\n                </div>\n            </td>\n        </tr>\n    </tbody>\n</table>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'table-helpers');
      ie_open('h3');
      ...
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('table-autofit');
          ie_close('code');
          itext(' constrains table columns to be only as wide as its content, but must be used with ');
          ie_open('code');
            itext('table-cell-content');
          ie_close('code');
          itext('. ');
          ie_open('code');
            itext('table-cell-content');
          ie_close('code');
          itext(' will fill the remaining space.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('table', null, null,
          'class', 'table table-autofit table-responsive');
        ie_open('thead');
          ie_open('tr');
            ie_void('th');
            ie_open('th');
      ...
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('table-heading-nowrap');
          ie_close('code');
          itext(' keeps headings on one line.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('table', null, null,
          'class', 'table table-autofit table-heading-nowrap table-responsive');
        ie_open('thead');
          ie_open('tr');
            ie_void('th');
            ie_open('th');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('We have added some classes to help vertically align contents inside a table. The classes ');
          ie_open('code');
            itext('table-valign-bottom');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('table-valign-middle');
          ie_close('code');
          itext(', and ');
          ie_open('code');
            itext('table-valign-top');
          ie_close('code');
          itext(' on ');
          ie_open('code');
            itext('<table>');
          ie_close('code');
          itext(' will vertically align table cell contents on the bottom, middle, and top, respectively.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('The classes ');
          ie_open('code');
            itext('thead-valign-bottom');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('thead-valign-middle');
          ie_close('code');
          itext(', and ');
          ie_open('code');
            itext('thead-valign-top');
          ie_close('code');
          itext(' on ');
          ie_open('code');
            itext('<table>');
          ie_close('code');
          itext(' will vertically align the contents inside the table head.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('The classes ');
          ie_open('code');
            itext('tbody-valign-bottom');
          ie_close('code');
          itext(', ');
          ie_open('code');
            itext('tbody-valign-middle');
          ie_close('code');
          itext(', and ');
          ie_open('code');
            itext('tbody-valign-top');
          ie_close('code');
          itext(' on ');
          ie_open('code');
            itext('<table>');
          ie_close('code');
          itext(' will vertically align the contents inside the table body.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div');
        ie_open('a', null, null,
            'class', 'btn btn-secondary table-vertical-align-button',
            'href', '#',
      ...
      ie_close('div');
      ie_open('table', null, null,
          'class', 'show-dropdown-action-on-active table table-autofit table-heading-nowrap table-list table-responsive-xl',
          'id', 'verticalAlignTableListDemo');
        ie_open('thead');
          ie_open('tr');
            ie_void('th');
            ie_open('th');
      ...
      ie_open('table', null, null,
        ...
        ie_open('thead');
          ie_open('tr');
            ...
            ie_close('th');
            ie_open('th');
              itext('Purchasing Power Parity');
            ie_close('th');
            ie_open('th');
              itext('Official Exchange Rate');
            ie_close('th');
            ie_open('th');
              itext('Real Growth Rate');
            ie_close('th');
            ie_open('th');
              itext('Household Consumption');
            ie_close('th');
            ie_open('th');
              itext('Government Consumption');
            ie_close('th');
            ie_open('th');
              itext('Fixed Capital Investment');
            ie_close('th');
            ie_open('th');
              itext('Inventories Investment');
            ie_close('th');
            ie_open('th');
              itext('Exports');
            ie_close('th');
        ...
        ie_open('tbody');
          ...
          ie_open('tr');
            ie_open('td');
              ie_open('a', null, null,
                  'href', '#1');
                itext('Congo, Democratic Republic of the');
              ie_close('a');
            ie_close('td');
            ie_open('td');
              itext('$29.39 billion');
          ...
          ie_open('tr');
            ...
            ie_close('td');
            ie_open('td');
              itext('$1.389 trillion');
            ie_close('td');
            ie_open('td');
              itext('$1.356 trillion');
            ie_close('td');
            ie_open('td');
              itext('-1.3%');
            ie_close('td');
        ...
        ie_close('tbody');
      ie_close('table');
      $templateAlias2({code: '', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'table-striped');
      ie_open('h3');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1298}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'yhMth.render';
}
...
class yhMth extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(yhMth, templates);
...
var _tablesSoy = __webpack_require__(122);

var _tablesSoy2 = _interopRequireDefault(_tablesSoy);
...
var yhMth = function (_Component) {
  _inherits(yhMth, _Component);

  function yhMth() {
    _classCallCheck(this, yhMth);

    return _possibleConstructorReturn(this, (yhMth.__proto__ || Object.getPrototypeOf(yhMth)).apply(this, arguments));
  }
...
_metalSoy2.default.register(yhMth, _tablesSoy2.default);

exports.default = yhMth;
