var pageComponent =
webpackJsonppageComponent([16,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JksOt", function() { return JksOt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace JksOt.
 * @public
 */

goog.module('JksOt.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param989 = function() {
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('nav-nested');
          ie_close('code');
          itext(' to the outermost nav to use padding to indent each nested nav.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('Also collapsible when used with (http://getbootstrap.com/javascript/#collapse)[Bootstrap Collapse Plugin].');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
                ...
                ie_open('ul', null, null,
                  ...
                  ie_open('li', null, null,
                    ...
                    ie_open('a', null, null,
                        'class', 'nav-link',
                        'href', '#1');
                      itext('Default User Associations');
                    ie_close('a');
                  ie_close('li');
                  ie_open('li', null, null,
                      'class', 'nav-item');
      ...
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('nav-nested-margins');
          ie_close('code');
          itext(' uses margins instead of padding to indent.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('nav-unstyled');
          ie_close('code');
          itext(' to your nav to remove spacing around ');
          ie_open('code');
            itext('nav-link');
          ie_close('code');
          itext(' and ');
      ...
      ie_open('ul', null, null,
        ...
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: '<ul class="nav nav-unstyled">\n    <li class="nav-item"><a class="active nav-link" href="#1">Details</a></li>\n    <li class="nav-item"><a class="nav-link" href="#1">Catagorization</a></li>\n    <li class="nav-item"><a class="disabled nav-link" href="#1">Documents and Media</a></li>\n    <li class="nav-item"><a class="nav-link" href="#1">Site Template</a></li>\n</ul>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'how-to-use-nav-helper-classes');
      ie_open('h3');
        itext('How to use Nav Helper Classes');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Dropdown toggle with anchor: ');
          ie_open('code');
            itext('dropdown-toggle nav-link');
          ie_close('code');
          itext('Dropdown toggle with button: ');
          ie_open('code');
            itext('btn btn-unstyled dropdown-toggle nav-link');
          ie_close('code');
          itext('An anchor in Nav Item styled like btn: ');
          ie_open('code');
            itext('btn btn-primary nav-btn nav-btn-monospaced');
          ie_close('code');
          itext('A button in Nav Item styled like nav-link: ');
          ie_open('code');
            itext('btn btn-unstyled nav-link');
          ie_close('code');
          itext('A button in Nav Item: ');
          ie_open('code');
            itext('btn btn-primary nav-btn');
          ie_close('code');
          itext('A monospaced anchor in Nav Item: ');
          ie_open('code');
            itext('nav-link nav-link-monospaced');
          ie_close('code');
          itext('A monospaced button in Nav Item: ');
          ie_open('code');
            itext('btn btn-primary nav-btn nav-btn-monospaced');
          ie_close('code');
        ie_close('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param989}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'JksOt.render';
}
...
class JksOt extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(JksOt, templates);
...
var _navSoy = __webpack_require__(111);

var _navSoy2 = _interopRequireDefault(_navSoy);
...
var JksOt = function (_Component) {
  _inherits(JksOt, _Component);

  function JksOt() {
    _classCallCheck(this, JksOt);

    return _possibleConstructorReturn(this, (JksOt.__proto__ || Object.getPrototypeOf(JksOt)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JksOt, _navSoy2.default);

exports.default = JksOt;
