var pageComponent =
webpackJsonppageComponent([17,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DxAdX", function() { return DxAdX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from nav_underline.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace DxAdX.
 * @public
 */

goog.module('DxAdX.incrementaldom');
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
            ...
            'role', 'tabpanel');
          itext('Cultivar single shot brewed, coffee steamed to go wings to go cortado. Grinder, siphon coffee acerbic espresso cinnamon crema breve.');
        ie_close('div');
        ie_open('div', null, null,
            ...
            'role', 'tabpanel');
          itext('Skinny extraction, id trifecta qui trifecta grinder. Barista robusta arabica breve ut skinny milk beans macchiato carajillo espresso. Cultivar single shot brewed, coffee steamed to go wings to go cortado. Grinder, siphon coffee acerbic espresso cinnamon crema breve.');
        ie_close('div');
        ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
        ...
        ie_open('li', null, null,
            'class', 'nav-item');
          ie_open('button', null, null,
              'aria-controls', 'buttonNavUnderlineFields',
              'aria-expanded', 'true',
              'class', 'active btn btn-unstyled nav-link',
              'data-target', '#buttonNavUnderlineFields',
              'data-toggle', 'tab',
              'id', 'buttonNavUnderlineFieldsTab',
              'role', 'tab',
              'type', 'button');
            itext('Fields');
          ie_close('button');
        ...
        ie_open('li', null, null,
            'class', 'nav-item');
          ie_open('button', null, null,
              'aria-controls', 'buttonNavUnderlineSettings',
              'class', 'btn btn-unstyled nav-link',
              'data-target', '#buttonNavUnderlineSettings',
              'data-toggle', 'tab',
              'id', 'buttonNavUnderlineSettingsTab',
              'role', 'tab',
              'type', 'button');
            itext('Settings');
          ie_close('button');
        ...
        ie_open('li', null, null,
            'class', 'nav-item');
          ie_open('button', null, null,
              'aria-controls', 'buttonNavUnderlineDocuments',
              'class', 'btn btn-unstyled disabled nav-link',
              'data-target', '#buttonNavUnderlineDocuments',
              'id', 'buttonNavUnderlineDocumentsTab',
              'role', 'tab',
              'type', 'button');
            itext('Documents');
          ie_close('button');
        ...
        ie_open('li', null, null,
          ...
          ie_open('div', null, null,
              'class', 'dropdown-menu dropdown-menu-indicator-end');
            ie_open('button', null, null,
                'aria-controls', 'buttonNavUnderlineSetup',
                'class', 'dropdown-item',
                'data-target', '#buttonNavUnderlineSetup',
                'data-toggle', 'tab',
                'id', 'buttonNavUnderlineSetupTab',
                'role', 'tab',
                'type', 'button');
              itext('Setup');
              ie_void('span', null, null,
            ...
            ie_close('button');
            ie_open('button', null, null,
                'aria-controls', 'buttonNavUnderlineSupportedClients',
                'class', 'dropdown-item',
                'data-target', '#buttonNavUnderlineSupportedClients',
                'data-toggle', 'tab',
                'id', 'buttonNavUnderlineSupportedClientsTab',
                'role', 'tab',
                'type', 'button');
              itext('Supported Clients');
              ie_void('span', null, null,
      ...
      ie_open('div', null, null,
          'class', 'tab-content');
        ie_open('div', null, null,
            'aria-labelledby', 'buttonNavUnderlineFieldsTab',
            'class', 'active fade show tab-pane',
            'id', 'buttonNavUnderlineFields',
            'role', 'tabpanel');
          itext('Single origin, extra id beans, eu to go, skinny americano ut aftertaste sugar. At americano, viennese variety iced grounds, grinder froth and pumpkin spice aromatic. Cultivar aged lungo, grounds caf\u00E9 au lait, skinny, blue mountain, in variety sugar shop roast. Wings, blue mountain affogato organic cappuccino java plunger pot. Single shot variety pumpkin spice seasonal skinny barista carajillo robust cream.');
        ie_close('div');
        ie_open('div', null, null,
            'aria-labelledby', 'buttonNavUnderlineSettingsTab',
            'class', 'fade tab-pane',
            'id', 'buttonNavUnderlineSettings',
            'role', 'tabpanel');
          itext('Iced, crema, coffee id kopi-luwak coffee variety. Skinny extraction, id trifecta qui trifecta grinder. Barista robusta arabica breve ut skinny milk beans macchiato carajillo espresso. Cultivar single shot brewed, coffee steamed to go wings to go cortado. Grinder, siphon coffee acerbic espresso cinnamon crema breve.');
        ie_close('div');
        ie_open('div', null, null,
        ...
        ie_close('div');
        ie_open('div', null, null,
            'aria-labelledby', 'buttonNavUnderlineSetupTab',
            'class', 'fade tab-pane',
            'id', 'buttonNavUnderlineSetup',
            'role', 'tabpanel');
          itext('Skinny extraction, id trifecta qui trifecta grinder. Barista robusta arabica breve ut skinny milk beans macchiato carajillo espresso. Cultivar single shot brewed, coffee steamed to go wings to go cortado. Grinder, siphon coffee acerbic espresso cinnamon crema breve.');
        ie_close('div');
        ie_open('div', null, null,
            'aria-labelledby', 'buttonNavUnderlineSupportedClientsTab',
            'class', 'fade tab-pane',
            'id', 'buttonNavUnderlineSupportedClients',
            'role', 'tabpanel');
          itext('At americano, viennese variety iced grounds, grinder froth and pumpkin spice aromatic. Cultivar aged lungo, grounds caf\u00E9 au lait, skinny, blue mountain, in variety sugar shop roast. Wings, blue mountain affogato organic cappuccino java plunger pot. Single shot variety pumpkin spice seasonal skinny barista carajillo robust cream.');
        ie_close('div');
      ie_close('div');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'DxAdX.render';
}
...
class DxAdX extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(DxAdX, templates);
...
var _nav_underlineSoy = __webpack_require__(117);

var _nav_underlineSoy2 = _interopRequireDefault(_nav_underlineSoy);
...
var DxAdX = function (_Component) {
  _inherits(DxAdX, _Component);

  function DxAdX() {
    _classCallCheck(this, DxAdX);

    return _possibleConstructorReturn(this, (DxAdX.__proto__ || Object.getPrototypeOf(DxAdX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DxAdX, _nav_underlineSoy2.default);

exports.default = DxAdX;
