var pageComponent =
webpackJsonppageComponent([7,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MUDGl", function() { return MUDGl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace MUDGl.
 * @public
 */

goog.module('MUDGl.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1503 = function() {
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Place ');
          ie_open('code');
            itext('timeline-increment');
          ie_close('code');
          itext(' inside whatever element you want it to be aligned to. The element must be positioned relative. For the example below, we place it inside the ');
          ie_open('code');
            itext('panel-heading');
          ie_close('code');
          itext(' element. This vertically centers the icon and label relative to the panel-heading.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('The icon can be any size as long as it is wrapped inside ');
          ie_open('code');
            itext('timeline-increment');
          ie_close('code');
          itext('. For larger icons, the spacing between the content and increment (');
          ie_open('a', null, null,
              'href', '#timeline-spacing');
            itext('Timeline Spacing');
          ie_close('a');
          itext(') must be adjusted to accomodate it.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'timeline');
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('a', null, null,
                ...
                ie_open('span', null, null,
                    'class', 'panel-title');
                  itext('Single Collapsible Panel');
                ie_close('span');
                ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('a', null, null,
                  ...
                  'aria-expanded', 'false',
                  'class', 'collapsed panel-header panel-header-link',
                  'data-parent', '#accordion002',
                  'data-toggle', 'collapse',
                  'href', '#panelCollapse002',
                  'id', 'heading002',
                  'role', 'tab');
                ie_open('span', null, null,
                    'class', 'panel-title');
    ...
    ie_open('article', null, null,
        'id', 'timeline-right');
      ie_open('h3');
        itext('Timeline Right');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Align increments to the right with ');
          ie_open('code');
            itext('timeline-right');
          ie_close('code');
          itext('.');
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#radio-button');
                ie_close('svg');
              ie_close('div');
            ie_close('div');
          ie_close('div');
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#remove-role');
                ie_close('svg');
              ie_close('div');
            ie_close('div');
          ie_close('div');
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#repository');
                ie_close('svg');
              ie_close('div');
            ie_close('div');
          ie_close('div');
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('timeline-center');
          ie_close('code');
          itext(' to center your timeline, it displays items on the right by default. To display items on the left, add class ');
          ie_open('code');
            itext('timeline-item-reverse');
          ie_close('code');
          itext(' to a timeline item.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('ul', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('a', null, null,
                  ...
                  'aria-expanded', 'false',
                  'class', 'collapsed panel-header panel-header-link',
                  'data-parent', '#accordionTimelineCenter0',
                  'data-toggle', 'collapse',
        ...
        ie_close('li');
        ie_open('li', null, null,
            'class', 'timeline-item timeline-item-reverse');
          ie_open('div', null, null,
              'class', 'panel panel-secondary');
            ie_open('div', null, null,
                'class', 'panel-body');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Alternate every other timeline item on the left with class ');
          ie_open('code');
            itext('timeline-even');
          ie_close('code');
          itext('.');
      ...
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'timeline timeline-center timeline-even');
        ie_open('li', null, null,
            'class', 'timeline-item');
          ie_open('div', null, null,
              'class', 'panel panel-secondary');
        ...
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: '<ul class="timeline timeline-center timeline-even">\n    <li class="timeline-item">\n        <div class="panel panel-secondary">\n            <div class="panel-body">\n                Panel Text #1\n                <div class="timeline-increment">\n                    <div class="sticker sticker-danger">\n                        <span>LR</span>\n                    </div>\n                </div>\n                <div class="timeline-item-label">1 hour ago</div>\n            </div>\n        </div>\n    </li>\n    <li class="timeline-item">\n        <div class="panel panel-secondary">\n            <div class="panel-body">\n                Panel Text #2\n                <div class="timeline-increment">\n                    <div class="sticker sticker-danger">\n                        <span>LR</span>\n                    </div>\n                </div>\n                <div class="timeline-item-label">1 hour ago</div>\n            </div>\n        </div>\n    </li>\n    <li class="timeline-item">\n        <div class="panel panel-secondary">\n            <div class="panel-body">\n                Panel Text #3\n                <div class="timeline-increment">\n                    <div class="sticker sticker-danger">\n                        <span>LR</span>\n                    </div>\n                </div>\n                <div class="timeline-item-label">1 hour ago</div>\n            </div>\n        </div>\n    </li>\n</ul>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'timeline-odd');
      ie_open('h3');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Alternate every other timeline item on the right with class ');
          ie_open('code');
            itext('timeline-odd');
          ie_close('code');
          itext('.');
      ...
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'timeline timeline-center timeline-odd');
        ie_open('li', null, null,
            'class', 'timeline-item');
          ie_open('div', null, null,
              'class', 'panel panel-secondary');
        ...
        ie_close('li');
      ie_close('ul');
      $templateAlias2({code: '<ul class="timeline timeline-center timeline-odd">\n    <li class="timeline-item">\n        <div class="panel panel-secondary">\n            <div class="panel-body">\n                Panel Text #1\n                <div class="timeline-increment">\n                    <div class="sticker sticker-danger">\n                        <span>LR</span>\n                    </div>\n                </div>\n                <div class="timeline-item-label">1 hour ago</div>\n            </div>\n        </div>\n    </li>\n    <li class="timeline-item">\n        <div class="panel panel-secondary">\n            <div class="panel-body">\n                Panel Text #2\n                <div class="timeline-increment">\n                    <div class="sticker sticker-danger">\n                        <span>LR</span>\n                    </div>\n                </div>\n                <div class="timeline-item-label">1 hour ago</div>\n            </div>\n        </div>\n    </li>\n    <li class="timeline-item">\n        <div class="panel panel-secondary">\n            <div class="panel-body">\n                Panel Text #3\n                <div class="timeline-increment">\n                    <div class="sticker sticker-danger">\n                        <span>LR</span>\n                    </div>\n                </div>\n                <div class="timeline-item-label">1 hour ago</div>\n            </div>\n        </div>\n    </li>\n</ul>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'timeline-right-xs-only');
      ie_open('h3');
        itext('Timeline Right XS Only');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Align timeline to the right at screen widths 767px and below with ');
          ie_open('code');
            itext('timeline-right-xs-only');
          ie_close('code');
          itext('.');
      ...
      ie_close('blockquote');
      ie_open('ul', null, null,
          'class', 'timeline timeline-center timeline-even timeline-right-xs-only');
        ie_open('li', null, null,
            'class', 'timeline-item');
          ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Adjust the spacing around the timeline with ');
          ie_open('code');
            itext('@include timeline-spacing($outer-spacing, $inner-spacing, $item-padding-y)');
          ie_close('code');
          itext('. The last argument is not required and has a default value of 10px.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
      ...
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('$inner-spacing');
          ie_close('code');
          itext(' sets the space between the ');
          ie_open('code');
            itext('.timeline-item:before');
          ie_close('code');
          itext(' pseudo element and ');
          ie_open('code');
            itext('.panel');
          ie_close('code');
          itext(' element and is used to calculate the space between the ');
          ie_open('code');
            itext('.timeline-item:before');
          ie_close('code');
          itext(' pseudo element and ');
          ie_open('code');
            itext('.timeline-item-label');
          ie_close('code');
          itext('.');
        ie_close('p');
      ie_close('blockquote');
      $templateAlias2({code: '.timeline-spacing-xl {\n    @include timeline-spacing(25px, 50px);\n}', mode: 'css'}, null, opt_ijData);
      ie_open('ul', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('a', null, null,
                  ...
                  'aria-expanded', 'false',
                  'class', 'collapsed panel-header panel-header-link',
                  'data-parent', '#accordionTimelineSpacing0',
                  'data-toggle', 'collapse',
                ...
                ie_open('div', null, null,
                    'class', 'timeline-increment');
                  ie_open('div', null, null,
                      'class', 'sticker sticker-danger sticker-xl');
                    ie_open('span');
                      itext('LR');
                    ie_close('span');
                  ie_close('div');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1503}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'MUDGl.render';
}
...
class MUDGl extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(MUDGl, templates);
...
var _timelinesSoy = __webpack_require__(127);

var _timelinesSoy2 = _interopRequireDefault(_timelinesSoy);
...
var MUDGl = function (_Component) {
  _inherits(MUDGl, _Component);

  function MUDGl() {
    _classCallCheck(this, MUDGl);

    return _possibleConstructorReturn(this, (MUDGl.__proto__ || Object.getPrototypeOf(MUDGl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MUDGl, _timelinesSoy2.default);

exports.default = MUDGl;
