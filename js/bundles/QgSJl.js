var pageComponent =
webpackJsonppageComponent([41,42,43],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QgSJl", function() { return QgSJl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace QgSJl.
 * @public
 */

goog.module('QgSJl.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param227 = function() {
    ie_open('article', null, null,
        'id', 'alerts-with-embedded-links');
      ie_open('h3');
        itext('Alerts with Embedded Links');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use ');
          ie_open('code');
            itext('.lead');
          ie_close('code');
          itext(' inside of an alert to make the beginning of your message stand out.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('.alert-link');
          ie_close('code');
          itext(' to style a link inside your alert.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
        ...
        ie_open('svg', null, null,
          ...
          ie_void('use', null, null,
              'xlink:href', '/vendor/lexicon/icons.svg#info-circle');
        ie_close('svg');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Primary:');
        ie_close('strong');
        itext(' This is a ');
        ...
        itext('. ');
        ie_open('button', null, null,
            'class', 'alert-link btn btn-unstyled');
          itext('Button as link');
        ie_close('button');
        itext('.');
      ie_close('div');
      ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('svg', null, null,
          ...
          ie_void('use', null, null,
              'xlink:href', '/vendor/lexicon/icons.svg#check-circle');
        ie_close('svg');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Success:');
        ie_close('strong');
        itext(' You just read the ');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'alert-link');
          itext('alert message');
      ...
      ie_open('div', null, null,
        ...
        ie_open('svg', null, null,
          ...
          ie_void('use', null, null,
              'xlink:href', '/vendor/lexicon/icons.svg#question-circle-full');
        ie_close('svg');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Warning:');
        ie_close('strong');
        itext(' This alert is a ');
        ie_open('a', null, null,
            'href', '#1',
            'class', 'alert-link');
          itext('warning message');
        ie_close('a');
        itext('.');
      ie_close('div');
      ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('strong', null, null,
          ...
          itext('Success:');
        ie_close('strong');
        itext(' You just read the alert message successfully.');
      ie_close('div');
      ie_open('div', null, null,
        ...
        ie_open('strong', null, null,
          ...
          itext('Info:');
        ie_close('strong');
        itext(' This alert needs your attention.');
      ie_close('div');
      ie_open('div', null, null,
        ...
        ie_open('strong', null, null,
          ...
          itext('Warning:');
        ie_close('strong');
        itext(' This alert is a warning message.');
      ie_close('div');
      ie_open('div', null, null,
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-dark',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
    ...
    ie_open('article', null, null,
      ...
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'alert alert-fluid alert-primary',
          'role', 'alert');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Primary');
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-fluid alert-secondary',
          'role', 'alert');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Secondary');
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-fluid alert-success',
          'role', 'alert');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Success');
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-fluid alert-warning',
          'role', 'alert');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Warning');
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-danger alert-fluid',
          'role', 'alert');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Danger');
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-fluid alert-light',
          'role', 'alert');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Light');
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dark alert-fluid',
          'role', 'alert');
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Dark');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Alternate alert style for notifications');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-notification alert-success',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
        ...
        ie_open('strong', null, null,
          ...
          itext('Success:');
        ie_close('strong');
        itext(' This is a success message.');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-notification alert-info',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
        ...
        ie_open('strong', null, null,
          ...
          itext('Info:');
        ie_close('strong');
        itext(' This is an info message.');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-notification alert-warning',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
        ...
        ie_open('strong', null, null,
          ...
          itext('Warning:');
        ie_close('strong');
        itext(' This is a warning message.');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-notification alert-danger',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
        ...
        ie_open('strong', null, null,
          ...
          itext('Danger:');
        ie_close('strong');
        itext(' This is a danger message.');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-notification alert-primary',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
        ...
        ie_open('strong', null, null,
            'class', 'lead');
          itext('Meeting Rescheduled:');
        ie_close('strong');
        ie_open('p');
          itext('The UX Team has rescheduled to the following date: 2014 - 12 - 17.');
        ie_close('p');
        ie_open('p');
          itext('Please complete the attendance form to confirm your attendance: ');
          ie_open('a', null, null,
              'class', 'alert-link',
              'href', '#1');
            itext('More Info');
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-notification alert-secondary',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-notification alert-light',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
        ...
        ie_close('strong');
        ie_open('p');
          itext('Due to inactivity, your session has expired. Please save any data you may have entered before refreshing the page. ');
          ie_open('a', null, null,
              'class', 'alert-link',
              'href', '#1');
            itext('Log in');
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-notification alert-dark',
          'role', 'alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'QgSJl.render';
}
...
class QgSJl extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(QgSJl, templates);
...
var _alertsSoy = __webpack_require__(93);

var _alertsSoy2 = _interopRequireDefault(_alertsSoy);
...
var QgSJl = function (_Component) {
  _inherits(QgSJl, _Component);

  function QgSJl() {
    _classCallCheck(this, QgSJl);

    return _possibleConstructorReturn(this, (QgSJl.__proto__ || Object.getPrototypeOf(QgSJl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QgSJl, _alertsSoy2.default);

exports.default = QgSJl;
