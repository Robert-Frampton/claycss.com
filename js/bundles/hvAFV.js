var pageComponent =
webpackJsonppageComponent([18,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hvAFV", function() { return hvAFV; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from modals.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace hvAFV.
 * @public
 */

goog.module('hvAFV.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param901 = function() {
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('300px wide modal window, expands full width of screen at 575px and below.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('button', null, null,
          'class', 'btn btn-info',
          'data-target', '#lexSmallModal',
          'data-toggle', 'modal');
        itext('Small Modal');
      ie_close('button');
      ie_open('div', null, null,
          'aria-labelledby', 'lexSmallModalLabel',
          'class', 'fade modal',
          'id', 'lexSmallModal',
          'role', 'dialog',
          'tabindex', '-1');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'modal-header');
              ie_open('button', null, null,
                  'class', 'btn btn-secondary d-md-none modal-primary-action-button',
                  'type', 'button');
                ie_open('svg', null, null,
                    'aria-hidden', 'true',
                    'class', 'lexicon-icon lexicon-icon-check');
                  ie_void('use', null, null,
                      'xlink:href', 'vendor/lexicon/icons.svg#check');
                ie_close('svg');
              ie_close('button');
              ie_open('h4', null, null,
                  'class', 'modal-title',
                  'id', 'lexSmallModalLabel');
                itext('Modal Title');
              ie_close('h4');
              ie_open('button', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('500px wide modal window, expands full width of screen at 575px and below.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('button', null, null,
          'class', 'btn btn-info',
          'data-target', '#lexDefaultModal',
          'data-toggle', 'modal');
        itext('Default Modal');
      ie_close('button');
      ie_open('div', null, null,
          'aria-labelledby', 'lexDefaultModalLabel',
          'class', 'fade modal',
          'id', 'lexDefaultModal',
          'role', 'dialog',
          'tabindex', '-1');
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<button class="btn btn-info" data-target="#lexDefaultModal" data-toggle="modal">Default Modal</button>\n<div aria-labelledby="lexDefaultModalLabel" class="fade modal" id="lexDefaultModal" role="dialog" tabindex="-1">\n    <div class="modal-dialog">\n        <div class="modal-content">\n            <div class="modal-header">\n                <button class="btn btn-secondary d-md-none modal-primary-action-button" type="button">\n                    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-check">\n                        <use xlink:href="vendor/lexicon/icons.svg#check" />\n                    </svg>\n                </button>\n\n                <h4 class="modal-title" id="lexSmallModalLabel">Modal Title</h4>\n\n                <button aria-labelledby="Close" class="btn btn-secondary close" data-dismiss="modal" role="button" type="button">\n                    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-times">\n                        <use xlink:href="vendor/lexicon/icons.svg#times" />\n                    </svg>\n                </button>\n            </div>\n\n            <div class="modal-body">\n                <h4>Modal Body</h4>\n            </div>\n\n            <div class="modal-footer">\n                <button class="btn btn-primary" type="button">Primary</button>\n                <button class="btn btn-link close-modal" data-dismiss="modal" type="button">Close</button>\n            </div>\n        </div>\n    </div>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'large-modal');
      ie_open('h3');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('800px wide modal in window sizes greater than 992px. 500px wide modal in window sizes between 576px and 991px. Full width of screen at 575px and below.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('button', null, null,
          'class', 'btn btn-info',
          'data-target', '#lexLargeModal',
          'data-toggle', 'modal');
        itext('Large Modal');
      ie_close('button');
      ie_open('div', null, null,
          'aria-labelledby', 'lexLargeModalLabel',
          'class', 'fade modal',
          'id', 'lexLargeModal',
          'role', 'dialog',
          'tabindex', '-1');
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<button class="btn btn-info" data-target="#lexLargeModal" data-toggle="modal">Large Modal</button>\n<div aria-labelledby="lexLargeModalLabel" class="fade modal" id="lexLargeModal" role="dialog" tabindex="-1">\n    <div class="modal-dialog modal-lg">\n        <div class="modal-content">\n            <div class="modal-header">\n                <button class="btn btn-secondary d-md-none modal-primary-action-button" type="button">\n                    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-check">\n                        <use xlink:href="vendor/lexicon/icons.svg#check" />\n                    </svg>\n                </button>\n\n                <h4 class="modal-title" id="lexLargeModalLabel">Modal Title</h4>\n\n                <button aria-labelledby="Close" class="btn btn-secondary close" data-dismiss="modal" role="button" type="button">\n                    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-times">\n                        <use xlink:href="vendor/lexicon/icons.svg#times" />\n                    </svg>\n                </button>\n            </div>\n\n            <div class="modal-body">\n                <h4><a href="#1">Modal Body</h4>\n            </div>\n\n            <div class="modal-footer">\n                <button class="btn btn-primary" type="button">Primary</button>\n                <button class="btn btn-secondary" type="button">Alt</button>\n                <button class="btn btn-link close-modal" data-dismiss="modal" type="button">Close</button>\n            </div>\n        </div>\n    </div>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'inline-scroller');
      ie_open('h3');
        itext('Inline Scroller');
      ie_close('h3');
      ie_open('p');
        ie_open('code');
          itext('inline-scroller');
        ie_close('code');
        itext(' is a helper class that sizes modal-body to a fixed height and scrolls any overflowing content. Add it to modal-body when you want modal-body to be a fixed height. It defaults to height 125px.');
      ie_close('p');
      ie_open('button', null, null,
          'class', 'btn btn-info',
          'data-target', '#claySmallModalInlineScroller',
          'data-toggle', 'modal');
        itext('Small Modal Inline Scroller');
      ie_close('button');
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_close('div');
            ie_open('div', null, null,
                'class', 'modal-body inline-scroller');
              ie_open('h4');
                itext('Modal Body');
              ie_close('h4');
              ie_open('div');
                ie_open('p');
                  ie_open('a', null, null,
                    ...
                    itext('Crema coffee');
                  ie_close('a');
                  itext(' a turkish decaffeinated espresso dripper cortado lungo con panna. Coffee, roast cup blue mountain beans single origin eu shop grounds caffeine a robusta. Sweet macchiato spoon, mug foam ut est ristretto.');
                ie_close('p');
                ie_open('p');
                  itext('Irish coffee, at as cultivar robusta fair trade. Variety, caramelization, sweet, steamed, breve sit, whipped spoon at in caffeine. So latte, half and half, instant caf\u00E9 au lait whipped extra at percolator.');
                ie_close('p');
                ie_open('p');
                  itext('Skinny extraction, viennese arabica aromatic robust kopi-luwak. Carajillo chicory dark espresso qui iced sugar. To go, at caf\u00E9 au lait chicory, qui, fair trade irish, beans seasonal extraction cappuccino kopi-luwak.');
                ie_close('p');
                ie_open('p');
                  itext('Crema coffee a turkish decaffeinated espresso dripper cortado lungo con panna. Coffee, roast cup blue mountain beans single origin eu shop grounds caffeine a robusta. Sweet macchiato spoon, mug foam ut est ristretto.');
                ie_close('p');
                ie_open('p');
                  itext('Irish coffee, at as cultivar robusta fair trade. Variety, caramelization, sweet, steamed, breve sit, whipped spoon at in caffeine. So latte, half and half, instant caf\u00E9 au lait whipped extra at percolator.');
                ie_close('p');
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
          'aria-labelledby', 'lexLargeModalLabel',
          'class', 'fade modal',
          'id', 'lexFullScreenModal',
          'role', 'dialog',
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-dialog modal-full-screen');
          ie_open('div', null, null,
              'class', 'modal-content');
            ie_open('div', null, null,
                'class', 'modal-header');
              ...
              ie_open('h4', null, null,
                  'class', 'modal-title');
                itext('Add Picture to Documents and Media Library in Liferay Seven');
              ie_close('h4');
              ie_open('button', null, null,
                  'aria-labelledby', 'Close',
                  'class', 'btn btn-secondary close',
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('modal-dialog');
          ie_close('code');
          itext(' to stretch to fit the browser window at screen widths 767px and below.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('button', null, null,
          'class', 'btn btn-info',
          'data-target', '#lexModalFullScreenSmDown',
          'data-toggle', 'modal');
        itext('Modal Full Screen Sm Down');
      ie_close('button');
      ie_open('div', null, null,
          'aria-labelledby', 'lexModalFullScreenSmDownLabel',
          'class', 'fade modal',
          'id', 'lexModalFullScreenSmDown',
          'role', 'dialog',
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-dialog modal-full-screen-sm-down');
          ie_open('div', null, null,
              'class', 'modal-content');
            ie_open('div', null, null,
                'class', 'modal-header');
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<button class="btn btn-info" data-target="#lexModalFullScreenSmDown" data-toggle="modal">Modal Full Screen Sm Down</button>\n<div aria-labelledby="lexModalFullScreenSmDownLabel" class="fade modal" id="lexModalFullScreenSmDown" role="dialog" tabindex="-1">\n    <div class="modal-dialog modal-full-screen-sm-down">\n        <div class="modal-content">\n            <div class="modal-header">\n                <button class="btn btn-secondary d-md-none modal-primary-action-button" type="button">\n                    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-check">\n                        <use xlink:href="vendor/lexicon/icons.svg#check" />\n                    </svg>\n                </button>\n\n                <h4 class="modal-title">Modal Title</h4>\n\n                <button aria-labelledby="Close" class="btn btn-secondary close" data-dismiss="modal" role="button" type="button">\n                    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-times">\n                        <use xlink:href="vendor/lexicon/icons.svg#times" />\n                    </svg>\n                </button>\n            </div>\n\n            <div class="modal-body">\n                <h4>Modal Body</h4>\n                <div>\n                    <p>\n                        Crema coffee a turkish decaffeinated espresso dripper cortado lungo con panna. Coffee, roast cup blue mountain beans single origin eu shop grounds caffeine a robusta. Sweet macchiato spoon, mug foam ut est ristretto.\n                    </p>\n\n                    <p>\n                        Irish coffee, at as cultivar robusta fair trade. Variety, caramelization, sweet, steamed, breve sit, whipped spoon at in caffeine. So latte, half and half, instant caf\u00E9 au lait whipped extra at percolator.\n                    </p>\n\n                    <p>\n                        Skinny extraction, viennese arabica aromatic robust kopi-luwak. Carajillo chicory dark espresso qui iced sugar. To go, at caf\u00E9 au lait chicory, qui, fair trade irish, beans seasonal extraction cappuccino kopi-luwak.\n                    </p>\n\n                    <p>\n                        Crema coffee a turkish decaffeinated espresso dripper cortado lungo con panna. Coffee, roast cup blue mountain beans single origin eu shop grounds caffeine a robusta. Sweet macchiato spoon, mug foam ut est ristretto.\n                    </p>\n\n                    <p>\n                        Irish coffee, at as cultivar robusta fair trade. Variety, caramelization, sweet, steamed, breve sit, whipped spoon at in caffeine. So latte, half and half, instant caf\u00E9 au lait whipped extra at percolator.\n                    </p>\n                </div>\n            </div>\n\n            <div class="modal-footer">\n                <button class="btn btn-primary" type="button">Add</button>\n\n                <button class="btn btn-link close-modal" data-dismiss="modal" type="button">Cancel</button>\n            </div>\n        </div>\n    </div>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'modal-body-iframe');
      ie_open('h3');
        itext('Modal Body Iframe');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('modal-body-iframe`` is a');
          ie_close('code');
          itext('modal-body` helper class that sizes and styles an iframe nested inside modal-body. Add it to modal-body when you want the iframe to be the same width and height as modal-body.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('In mobile safari (iOS 8.3), any content inside an iframe that triggers a browser reflow will cause the iframe to scroll to the top.');
      ie_close('div');
      ie_open('button', null, null,
          'class', 'btn btn-info',
          'data-target', '#lexFullScreenModalIframe',
          'data-toggle', 'modal');
        itext('Full Screen Modal Iframe');
      ie_close('button');
      ie_open('div', null, null,
          'aria-labelledby', 'lexFullScreenModalIframeLabel',
          'class', 'fade modal',
          'id', 'lexFullScreenModalIframe',
          'role', 'dialog',
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-dialog modal-full-screen');
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('h4', null, null,
                  'class', 'modal-title',
                  'id', 'lexFullScreenModalIframeLabel');
                itext('Add Picture to Documents and Media Library in Liferay Seven');
              ie_close('h4');
              ie_open('button', null, null,
                  'aria-labelledby', 'Close',
            ...
            ie_open('div', null, null,
              ...
              ie_void('iframe', null, null,
                  'src', '/docs/components/alerts.html');
            ie_close('div');
            ie_open('div', null, null,
                'class', 'modal-footer');
              ie_open('button', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('modal-warning');
        ie_close('code');
        itext(' are helper classes that style a modal based on that state, add it to modal-dialog.');
      ie_close('p');
      ie_open('button', null, null,
          'class', 'btn btn-secondary',
          'data-target', '#clayModalInverse',
          'data-toggle', 'modal');
        itext('Modal Inverse');
      ie_close('button');
      ie_open('div', null, null,
          'aria-labelledby', 'clayModalInverseLabel',
          'class', 'fade modal',
          'id', 'clayModalInverse',
          'role', 'dialog',
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-dialog modal-full-screen-sm-down modal-inverse');
          ie_open('div', null, null,
              'class', 'modal-content');
            ie_open('div', null, null,
                'class', 'modal-header');
      ...
      ie_open('div', null, null,
          ...
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-danger modal-dialog modal-full-screen-sm-down');
          ie_open('div', null, null,
              'class', 'modal-content');
            ie_open('div', null, null,
                'class', 'modal-header');
      ...
      ie_open('div', null, null,
          ...
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-info modal-dialog modal-full-screen-sm-down');
          ie_open('div', null, null,
              'class', 'modal-content');
            ie_open('div', null, null,
                'class', 'modal-header');
      ...
      ie_open('div', null, null,
          ...
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-success modal-dialog modal-full-screen-sm-down');
          ie_open('div', null, null,
              'class', 'modal-content');
            ie_open('div', null, null,
                'class', 'modal-header');
      ...
      ie_open('div', null, null,
          ...
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-warning modal-dialog modal-full-screen-sm-down');
          ie_open('div', null, null,
              'class', 'modal-content');
            ie_open('div', null, null,
                'class', 'modal-header');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param901}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'hvAFV.render';
}
...
class hvAFV extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(hvAFV, templates);
...
var _modalsSoy = __webpack_require__(109);

var _modalsSoy2 = _interopRequireDefault(_modalsSoy);
...
var hvAFV = function (_Component) {
  _inherits(hvAFV, _Component);

  function hvAFV() {
    _classCallCheck(this, hvAFV);

    return _possibleConstructorReturn(this, (hvAFV.__proto__ || Object.getPrototypeOf(hvAFV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(hvAFV, _modalsSoy2.default);

exports.default = hvAFV;
