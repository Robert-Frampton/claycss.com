var pageComponent =
webpackJsonppageComponent([24,36,37],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HYJRG", function() { return HYJRG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from form_elements_input_groups.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace HYJRG.
 * @public
 */

goog.module('HYJRG.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param675 = function() {
    ie_open('article', null, null,
      ...
      ie_open('h3');
        itext('Input Group Addon');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Append or prepend different things to your form elements with input-group.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'input-group-addon-constrain');
      ie_open('h3');
        itext('Input Group Addon Constrain');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('span', null, null,
                'class', 'input-group-addon input-group-constrain',
                'id', 'inputGroupConstrain01');
              ie_open('span', null, null,
                  'class', 'input-group-constrain-text');
                itext('https://web.liferay.com/community/forums/-/message_boards/category/72632049');
              ie_close('span');
            ie_close('span');
            ie_open('input', null, null,
                'aria-describedby', 'inputGroupConstrain01',
                'aria-label', 'Change Default URL',
                'class', 'form-control',
                'placeholder', 'Change Default URL',
                'type', 'text');
            ie_close('input');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_close('span');
            ie_open('input', null, null,
                'aria-describedby', 'inputGroupConstrain02',
                'aria-label', 'Change Default URL second one',
                'class', 'form-control',
                'placeholder', 'Change Default URL',
                'type', 'text');
            ie_close('input');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_close('span');
            ie_open('input', null, null,
                'aria-describedby', 'inputGroupConstrain03',
                'aria-label', 'Change Default URL third one',
                'class', 'form-control',
                'placeholder', 'Change Default URL',
                'type', 'text');
            ie_close('input');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'input-group-secondary');
      ie_open('h3');
        itext('Input Group Secondary');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Different skin for Input Group');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
          ...
          ie_close('label');
          ie_open('div', null, null,
              'class', 'input-group input-group-secondary');
            ie_open('span', null, null,
                'class', 'input-group-addon');
              ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('label', null, null,
              'for', '');
            itext('Custom Checkbox and Custom Control Description');
          ie_close('label');
          ie_open('div', null, null,
              'class', 'input-group input-group-secondary');
            ie_open('span', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('label', null, null,
              'for', '');
            itext('Form Check and Form Check Description');
          ie_close('label');
          ie_open('div', null, null,
              'class', 'input-group input-group-secondary');
            ie_open('input', null, null,
            ...
            ie_open('span', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('label', null, null,
                    'class', 'form-check-label');
                  ie_open('input', null, null,
                      'aria-label', 'Checkbox for previous text input',
        ...
        ie_open('div', null, null,
          ...
          ie_open('label', null, null,
              'for', '');
            itext('Form Check with Radio Button');
          ie_close('label');
          ie_open('div', null, null,
              'class', 'input-group input-group-secondary');
            ie_open('input', null, null,
            ...
            ie_open('span', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('label', null, null,
                    'class', 'form-check-label');
                  ie_open('input', null, null,
                      'aria-label', 'Radio button for previous text input',
                      'class', 'form-check-input',
                      'type', 'radio',
                      'value', '');
                  ie_close('input');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'input-group-transparent');
      ie_open('h3');
        itext('Input Group Transparent');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Another skin for Input Group');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'input-group-sizes');
      ie_open('h3');
        itext('Input Group Sizes');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-form-container');
        ie_open('div', null, null,
        ...
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'inputGroupTransparentLg');
            itext('Label Input Group Lg');
            ie_open('svg', null, null,
                'aria-hidden', 'true',
                'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
              ie_void('use', null, null,
          ...
          ie_close('label');
          ie_open('div', null, null,
              'class', 'input-group input-group-transparent input-group-lg');
            ie_open('span', null, null,
                'class', 'input-group-addon');
              itext('$');
            ie_close('span');
        ...
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'inputGroupTransparentNormal');
            itext('Label');
            ie_open('svg', null, null,
                'aria-hidden', 'true',
                'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
          ...
          ie_open('div', null, null,
            ...
            ie_open('input', null, null,
                'aria-label', 'Amount',
                'class', 'form-control',
                'id', 'inputGroupTransparentNormal',
                'placeholder', 'Some placeholder text...',
                'type', 'text');
            ie_close('input');
            ie_open('span', null, null,
        ...
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'inputGroupTransparentSm');
            itext('Label Input Group Sm');
            ie_open('svg', null, null,
                'aria-hidden', 'true',
                'class', 'lexicon-icon lexicon-icon-asterisk reference-mark');
              ie_void('use', null, null,
          ...
          ie_close('label');
          ie_open('div', null, null,
              'class', 'input-group input-group-transparent input-group-sm');
            ie_open('span', null, null,
                'class', 'input-group-addon');
              itext('$');
            ie_close('span');
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div class="input-group input-group-lg">\n    <span class="input-group-addon">$</span>\n    <input aria-label="Amount (to the nearest dollar)" class="form-control" type="text">\n    <span class="input-group-addon">.00</span>\n</div>\n\n<div class="input-group">\n    <span class="input-group-addon">$</span>\n    <input aria-label="Amount (to the nearest dollar)" class="form-control" type="text">\n    <span class="input-group-addon">.00</span>\n</div>\n\n<div class="input-group input-group-sm">\n    <span class="input-group-addon">$</span>\n    <input aria-label="Amount (to the neareset dollar)" class="form-control" type="text">\n    <span class="input-group-addon">.00</span>\n</div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'input-group-inset');
      ie_open('h3');
        itext('Input Group Inset');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Add class ');
          ...
          ie_open('code');
            itext('input-group');
          ie_close('code');
          itext(' to place a button or other stuff inside the input.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          ie_open('code');
            itext('input-group-inset');
          ie_close('code');
          itext(' gets aligned right by default, add ');
          ie_open('code');
            itext('input-group-inset-left');
          ie_close('code');
          itext(' to ');
          ie_open('code');
            itext('input-group');
          ie_close('code');
          itext(' to align inset content on the left. This helps keep the tab order logical so the input is always focused first and not the button.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-warning');
        itext('You will need to adjust ');
        ie_open('code');
          itext('padding-left');
        ie_close('code');
        itext(', ');
        ...
        itext(', or both on ');
        ie_open('code');
          itext('.input-group-input .form-control');
        ie_close('code');
        itext(' depending on what is inside ');
        ie_open('code');
          itext('.input-group-inset');
        ie_close('code');
        itext('.');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'form-group');
              ie_open('div', null, null,
                  'class', 'input-group input-group-inset input-group-inset-left');
                ie_open('div', null, null,
                    'class', 'input-group-input');
                  ie_open('input', null, null,
                      'aria-label', 'Search for',
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'HYJRG.render';
}
...
class HYJRG extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(HYJRG, templates);
...
var _form_elements_input_groupsSoy = __webpack_require__(103);

var _form_elements_input_groupsSoy2 = _interopRequireDefault(_form_elements_input_groupsSoy);
...
var HYJRG = function (_Component) {
  _inherits(HYJRG, _Component);

  function HYJRG() {
    _classCallCheck(this, HYJRG);

    return _possibleConstructorReturn(this, (HYJRG.__proto__ || Object.getPrototypeOf(HYJRG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HYJRG, _form_elements_input_groupsSoy2.default);

exports.default = HYJRG;
